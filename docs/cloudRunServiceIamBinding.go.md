...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/cloudrunserviceiambinding"
...
&cloudrunserviceiambinding.CloudRunServiceIamBindingConfig {
	...
	Role: *string,
	Service: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.cloudRunServiceIamBinding.CloudRunServiceIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
