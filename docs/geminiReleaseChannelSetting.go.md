...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/geminireleasechannelsetting"
...
&geminireleasechannelsetting.GeminiReleaseChannelSettingConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.geminiReleaseChannelSetting.GeminiReleaseChannelSettingTimeouts,
}
```
