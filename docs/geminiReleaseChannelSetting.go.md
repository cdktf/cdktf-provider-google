...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/geminireleasechannelsetting"
...
&geminireleasechannelsetting.GeminiReleaseChannelSettingConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.geminiReleaseChannelSetting.GeminiReleaseChannelSettingTimeouts,
}
```
