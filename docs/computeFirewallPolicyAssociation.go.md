...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computefirewallpolicyassociation"
...
&computefirewallpolicyassociation.ComputeFirewallPolicyAssociationConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeFirewallPolicyAssociation.ComputeFirewallPolicyAssociationTimeouts,
}
```
