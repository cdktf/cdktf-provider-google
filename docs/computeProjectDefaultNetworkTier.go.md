...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computeprojectdefaultnetworktier"
...
&computeprojectdefaultnetworktier.ComputeProjectDefaultNetworkTierConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeProjectDefaultNetworkTier.ComputeProjectDefaultNetworkTierTimeouts,
}
```
