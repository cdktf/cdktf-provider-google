...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeprojectdefaultnetworktier"
...
&computeprojectdefaultnetworktier.ComputeProjectDefaultNetworkTierConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeProjectDefaultNetworkTier.ComputeProjectDefaultNetworkTierTimeouts,
}
```
