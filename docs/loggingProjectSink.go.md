...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/loggingprojectsink"
...
| <code><a href="#@cdktf/provider-google.loggingProjectSink.LoggingProjectSink.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&loggingprojectsink.LoggingProjectSinkConfig {
	...
	Destination: *string,
	Name: *string,
	BigqueryOptions: github.com/cdktf/cdktf-provider-google-go/google/v14.loggingProjectSink.LoggingProjectSinkBigqueryOptions,
...
| <code><a href="#@cdktf/provider-google.loggingProjectSink.LoggingProjectSinkConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
