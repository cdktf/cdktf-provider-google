...
Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy google_kms_ekm_connection_iam_policy}.
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google.kmsEkmConnectionIamPolicy.KmsEkmConnectionIamPolicyConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#name KmsEkmConnectionIamPolicy#name}. |
| <code><a href="#@cdktf/provider-google.kmsEkmConnectionIamPolicy.KmsEkmConnectionIamPolicyConfig.property.policyData">policyData</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#policy_data KmsEkmConnectionIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google.kmsEkmConnectionIamPolicy.KmsEkmConnectionIamPolicyConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#id KmsEkmConnectionIamPolicy#id}. |
| <code><a href="#@cdktf/provider-google.kmsEkmConnectionIamPolicy.KmsEkmConnectionIamPolicyConfig.property.location">location</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#location KmsEkmConnectionIamPolicy#location}. |
| <code><a href="#@cdktf/provider-google.kmsEkmConnectionIamPolicy.KmsEkmConnectionIamPolicyConfig.property.project">project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#project KmsEkmConnectionIamPolicy#project}. |
