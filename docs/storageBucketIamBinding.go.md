...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/storagebucketiambinding"
...
&storagebucketiambinding.StorageBucketIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.storageBucketIamBinding.StorageBucketIamBindingCondition,
	Id: *string,
}
```
