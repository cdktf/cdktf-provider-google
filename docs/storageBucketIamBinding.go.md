...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/storagebucketiambinding"
...
&storagebucketiambinding.StorageBucketIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.storageBucketIamBinding.StorageBucketIamBindingCondition,
	Id: *string,
}
```
