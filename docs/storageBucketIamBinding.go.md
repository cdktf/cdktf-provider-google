...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/storagebucketiambinding"
...
| <code><a href="#@cdktf/provider-google.storageBucketIamBinding.StorageBucketIamBinding.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&storagebucketiambinding.StorageBucketIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.storageBucketIamBinding.StorageBucketIamBindingCondition,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.storageBucketIamBinding.StorageBucketIamBindingConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
