...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/pubsublitereservation"
...
&pubsublitereservation.PubsubLiteReservationConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.pubsubLiteReservation.PubsubLiteReservationTimeouts,
}
```
