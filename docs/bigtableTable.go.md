...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/bigtabletable"
...
&bigtabletable.BigtableTableConfig {
	...
	Project: *string,
	SplitKeys: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.bigtableTable.BigtableTableTimeouts,
}
```
