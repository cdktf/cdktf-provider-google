...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/bigtabletable"
...
&bigtabletable.BigtableTableConfig {
	...
	InstanceName: *string,
	Name: *string,
	AutomatedBackupPolicy: github.com/cdktf/cdktf-provider-google-go/google/v15.bigtableTable.BigtableTableAutomatedBackupPolicy,
	...
	Project: *string,
	SplitKeys: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.bigtableTable.BigtableTableTimeouts,
}
```
