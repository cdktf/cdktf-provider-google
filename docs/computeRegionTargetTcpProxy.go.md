...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeregiontargettcpproxy"
...
&computeregiontargettcpproxy.ComputeRegionTargetTcpProxyConfig {
	...
	ProxyHeader: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeRegionTargetTcpProxy.ComputeRegionTargetTcpProxyTimeouts,
}
```
