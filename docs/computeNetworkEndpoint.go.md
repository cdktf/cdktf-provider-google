...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computenetworkendpoint"
...
&computenetworkendpoint.ComputeNetworkEndpointConfig {
	...
	Port: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeNetworkEndpoint.ComputeNetworkEndpointTimeouts,
	Zone: *string,
}
```
