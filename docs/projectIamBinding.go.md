...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/projectiambinding"
...
| <code><a href="#@cdktf/provider-google.projectIamBinding.ProjectIamBinding.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&projectiambinding.ProjectIamBindingConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v16.projectIamBinding.ProjectIamBindingCondition,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.projectIamBinding.ProjectIamBindingConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
