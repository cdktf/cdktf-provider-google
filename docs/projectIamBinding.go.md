...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/projectiambinding"
...
&projectiambinding.ProjectIamBindingConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.projectIamBinding.ProjectIamBindingCondition,
	Id: *string,
}
```
