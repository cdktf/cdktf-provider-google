...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/projectiambinding"
...
&projectiambinding.ProjectIamBindingConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.projectIamBinding.ProjectIamBindingCondition,
	Id: *string,
}
```
