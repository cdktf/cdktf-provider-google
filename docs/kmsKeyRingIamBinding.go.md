...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/kmskeyringiambinding"
...
&kmskeyringiambinding.KmsKeyRingIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.kmsKeyRingIamBinding.KmsKeyRingIamBindingCondition,
	Id: *string,
}
```
