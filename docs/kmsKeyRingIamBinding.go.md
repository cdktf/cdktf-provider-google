...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/kmskeyringiambinding"
...
&kmskeyringiambinding.KmsKeyRingIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.kmsKeyRingIamBinding.KmsKeyRingIamBindingCondition,
	Id: *string,
}
```
