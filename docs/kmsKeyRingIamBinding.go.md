...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/kmskeyringiambinding"
...
&kmskeyringiambinding.KmsKeyRingIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.kmsKeyRingIamBinding.KmsKeyRingIamBindingCondition,
	Id: *string,
}
```
