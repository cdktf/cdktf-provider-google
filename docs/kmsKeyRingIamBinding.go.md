...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/kmskeyringiambinding"
...
&kmskeyringiambinding.KmsKeyRingIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.kmsKeyRingIamBinding.KmsKeyRingIamBindingCondition,
	Id: *string,
}
```
