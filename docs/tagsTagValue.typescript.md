...
| <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValue.property.timeoutsInput">timeoutsInput</a></code> | <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeouts">TagsTagValueTimeouts</a> \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly timeoutsInput: TagsTagValueTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeouts">TagsTagValueTimeouts</a> | cdktf.IResolvable
...
| <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#id TagsTagValue#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeouts.property.create">create</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#create TagsTagValue#create}. |
| <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeouts.property.delete">delete</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#delete TagsTagValue#delete}. |
| <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeouts.property.update">update</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#update TagsTagValue#update}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#create TagsTagValue#create}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#delete TagsTagValue#delete}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.64.0/docs/resources/tags_tag_value#update TagsTagValue#update}.
...
| <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code><a href="#@cdktf/provider-google.tagsTagValue.TagsTagValueTimeouts">TagsTagValueTimeouts</a> \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly internalValue: TagsTagValueTimeouts | IResolvable;
```
