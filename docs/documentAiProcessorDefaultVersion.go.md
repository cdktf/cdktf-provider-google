...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/documentaiprocessordefaultversion"
...
| <code><a href="#@cdktf/provider-google.documentAiProcessorDefaultVersion.DocumentAiProcessorDefaultVersion.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&documentaiprocessordefaultversion.DocumentAiProcessorDefaultVersionConfig {
	...
	Version: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.documentAiProcessorDefaultVersion.DocumentAiProcessorDefaultVersionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.documentAiProcessorDefaultVersion.DocumentAiProcessorDefaultVersionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
