...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/computevpngateway"
...
| <code><a href="#@cdktf/provider-google.computeVpnGateway.ComputeVpnGateway.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&computevpngateway.ComputeVpnGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.computeVpnGateway.ComputeVpnGatewayTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.computeVpnGateway.ComputeVpnGatewayConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
