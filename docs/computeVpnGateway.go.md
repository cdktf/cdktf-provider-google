...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computevpngateway"
...
&computevpngateway.ComputeVpnGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeVpnGateway.ComputeVpnGatewayTimeouts,
}
```
