...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/dialogflowcxversion"
...
| <code><a href="#@cdktf/provider-google.dialogflowCxVersion.DialogflowCxVersion.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dialogflowcxversion.DialogflowCxVersionConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.dialogflowCxVersion.DialogflowCxVersionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.dialogflowCxVersion.DialogflowCxVersionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
