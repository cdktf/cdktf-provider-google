...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/dialogflowcxversion"
...
&dialogflowcxversion.DialogflowCxVersionConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.dialogflowCxVersion.DialogflowCxVersionTimeouts,
}
```
