...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/dialogflowcxversion"
...
&dialogflowcxversion.DialogflowCxVersionConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dialogflowCxVersion.DialogflowCxVersionTimeouts,
}
```
