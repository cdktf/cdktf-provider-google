...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/iaptunneliambinding"
...
| <code><a href="#@cdktf/provider-google.iapTunnelIamBinding.IapTunnelIamBinding.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&iaptunneliambinding.IapTunnelIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.iapTunnelIamBinding.IapTunnelIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.iapTunnelIamBinding.IapTunnelIamBindingConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
