...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/gameservicesrealm"
...
&gameservicesrealm.GameServicesRealmConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.gameServicesRealm.GameServicesRealmTimeouts,
}
```
