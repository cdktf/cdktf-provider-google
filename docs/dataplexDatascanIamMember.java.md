...
Refer to the Terraform Registory for docs: [`google_dataplex_datascan_iam_member`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/resources/dataplex_datascan_iam_member).
