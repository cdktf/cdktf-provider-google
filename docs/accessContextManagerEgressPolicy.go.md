...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/accesscontextmanageregresspolicy"
...
&accesscontextmanageregresspolicy.AccessContextManagerEgressPolicyConfig {
	...
	Resource: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.accessContextManagerEgressPolicy.AccessContextManagerEgressPolicyTimeouts,
}
```
