...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/accesscontextmanageregresspolicy"
...
&accesscontextmanageregresspolicy.AccessContextManagerEgressPolicyConfig {
	...
	Resource: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.accessContextManagerEgressPolicy.AccessContextManagerEgressPolicyTimeouts,
}
```
