...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/kmssecretciphertext"
...
&kmssecretciphertext.KmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.kmsSecretCiphertext.KmsSecretCiphertextTimeouts,
}
```
