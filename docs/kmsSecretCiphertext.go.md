...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/kmssecretciphertext"
...
&kmssecretciphertext.KmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.kmsSecretCiphertext.KmsSecretCiphertextTimeouts,
}
```
