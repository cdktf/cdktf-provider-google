...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/kmssecretciphertext"
...
&kmssecretciphertext.KmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.kmsSecretCiphertext.KmsSecretCiphertextTimeouts,
}
```
