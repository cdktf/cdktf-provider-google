...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/kmssecretciphertext"
...
&kmssecretciphertext.KmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.kmsSecretCiphertext.KmsSecretCiphertextTimeouts,
}
```
