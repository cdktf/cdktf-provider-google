...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/logginglogview"
...
&logginglogview.LoggingLogViewConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.loggingLogView.LoggingLogViewTimeouts,
}
```
