...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/logginglogview"
...
&logginglogview.LoggingLogViewConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.loggingLogView.LoggingLogViewTimeouts,
}
```
