...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigqueryconnectioniambinding"
...
&bigqueryconnectioniambinding.BigqueryConnectionIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.bigqueryConnectionIamBinding.BigqueryConnectionIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
