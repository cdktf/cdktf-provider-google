...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/healthcareconsentstore"
...
&healthcareconsentstore.HealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.healthcareConsentStore.HealthcareConsentStoreTimeouts,
}
```
