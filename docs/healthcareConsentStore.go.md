...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/healthcareconsentstore"
...
&healthcareconsentstore.HealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.healthcareConsentStore.HealthcareConsentStoreTimeouts,
}
```
