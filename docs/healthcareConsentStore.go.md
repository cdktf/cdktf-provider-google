...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/healthcareconsentstore"
...
&healthcareconsentstore.HealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.healthcareConsentStore.HealthcareConsentStoreTimeouts,
}
```
