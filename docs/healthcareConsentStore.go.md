...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/healthcareconsentstore"
...
&healthcareconsentstore.HealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.healthcareConsentStore.HealthcareConsentStoreTimeouts,
}
```
