...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/healthcareconsentstore"
...
&healthcareconsentstore.HealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.healthcareConsentStore.HealthcareConsentStoreTimeouts,
}
```
