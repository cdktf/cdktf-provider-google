...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/healthcareconsentstore"
...
&healthcareconsentstore.HealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.healthcareConsentStore.HealthcareConsentStoreTimeouts,
}
```
