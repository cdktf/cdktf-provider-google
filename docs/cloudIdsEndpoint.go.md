...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
