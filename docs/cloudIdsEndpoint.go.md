...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
