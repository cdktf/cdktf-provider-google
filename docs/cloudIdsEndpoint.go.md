...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
