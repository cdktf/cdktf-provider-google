...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
