...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
