...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
