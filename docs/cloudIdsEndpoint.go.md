...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/cloudidsendpoint"
...
&cloudidsendpoint.CloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.cloudIdsEndpoint.CloudIdsEndpointTimeouts,
}
```
