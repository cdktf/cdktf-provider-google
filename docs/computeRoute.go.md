...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeroute"
...
&computeroute.ComputeRouteConfig {
	...
	Project: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeRoute.ComputeRouteTimeouts,
}
```
