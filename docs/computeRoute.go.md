...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeroute"
...
&computeroute.ComputeRouteConfig {
	...
	Project: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeRoute.ComputeRouteTimeouts,
}
```
