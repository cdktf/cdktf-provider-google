...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/gameservicesgameserverdeploymentrollout"
...
&gameservicesgameserverdeploymentrollout.GameServicesGameServerDeploymentRolloutConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.gameServicesGameServerDeploymentRollout.GameServicesGameServerDeploymentRolloutTimeouts,
}
```
...
&gameservicesgameserverdeploymentrollout.GameServicesGameServerDeploymentRolloutGameServerConfigOverrides {
	...
	RealmsSelector: github.com/cdktf/cdktf-provider-google-go/google/v5.gameServicesGameServerDeploymentRollout.GameServicesGameServerDeploymentRolloutGameServerConfigOverridesRealmsSelector,
}
```
