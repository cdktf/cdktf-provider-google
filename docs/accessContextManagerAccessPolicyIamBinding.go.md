...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/accesscontextmanageraccesspolicyiambinding"
...
&accesscontextmanageraccesspolicyiambinding.AccessContextManagerAccessPolicyIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.accessContextManagerAccessPolicyIamBinding.AccessContextManagerAccessPolicyIamBindingCondition,
	Id: *string,
}
```
