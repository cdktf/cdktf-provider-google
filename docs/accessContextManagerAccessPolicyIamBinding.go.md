...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/accesscontextmanageraccesspolicyiambinding"
...
&accesscontextmanageraccesspolicyiambinding.AccessContextManagerAccessPolicyIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.accessContextManagerAccessPolicyIamBinding.AccessContextManagerAccessPolicyIamBindingCondition,
	Id: *string,
}
```
