...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/secretmanagersecretiammember"
...
&secretmanagersecretiammember.SecretManagerSecretIamMemberConfig {
	...
	Role: *string,
	SecretId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.secretManagerSecretIamMember.SecretManagerSecretIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
