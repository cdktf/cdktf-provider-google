...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/storagebucketaccesscontrol"
...
&storagebucketaccesscontrol.StorageBucketAccessControlConfig {
	...
	Id: *string,
	Role: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.storageBucketAccessControl.StorageBucketAccessControlTimeouts,
}
```
