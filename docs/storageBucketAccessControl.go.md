...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/storagebucketaccesscontrol"
...
&storagebucketaccesscontrol.StorageBucketAccessControlConfig {
	...
	Id: *string,
	Role: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.storageBucketAccessControl.StorageBucketAccessControlTimeouts,
}
```
