...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/tagstagvalueiammember"
...
&tagstagvalueiammember.TagsTagValueIamMemberConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.tagsTagValueIamMember.TagsTagValueIamMemberCondition,
	Id: *string,
}
```
