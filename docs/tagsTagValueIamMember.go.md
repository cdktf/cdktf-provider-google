...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/tagstagvalueiammember"
...
&tagstagvalueiammember.TagsTagValueIamMemberConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.tagsTagValueIamMember.TagsTagValueIamMemberCondition,
	Id: *string,
}
```
