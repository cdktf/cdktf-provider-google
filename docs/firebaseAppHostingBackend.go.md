...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/firebaseapphostingbackend"
...
&firebaseapphostingbackend.FirebaseAppHostingBackendConfig {
	...
	Codebase: github.com/cdktf/cdktf-provider-google-go/google.firebaseAppHostingBackend.FirebaseAppHostingBackendCodebase,
	DisplayName: *string,
	Environment: *string,
	Id: *string,
	Labels: *map[string]*string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.firebaseAppHostingBackend.FirebaseAppHostingBackendTimeouts,
}
```
