...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/gkehubscope"
...
&gkehubscope.GkeHubScopeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.gkeHubScope.GkeHubScopeTimeouts,
}
```
