...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/gkehubscope"
...
&gkehubscope.GkeHubScopeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.gkeHubScope.GkeHubScopeTimeouts,
}
```
