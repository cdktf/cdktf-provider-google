...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/gkehubscope"
...
&gkehubscope.GkeHubScopeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.gkeHubScope.GkeHubScopeTimeouts,
}
```
