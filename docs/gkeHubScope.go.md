...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/gkehubscope"
...
&gkehubscope.GkeHubScopeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.gkeHubScope.GkeHubScopeTimeouts,
}
```
