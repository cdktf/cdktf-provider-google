...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/projectiamcustomrole"
...
| <code><a href="#@cdktf/provider-google.projectIamCustomRole.ProjectIamCustomRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.84.0/docs/resources/project_iam_custom_role#id ProjectIamCustomRole#id}. |
