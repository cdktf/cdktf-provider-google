...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/iamworkloadidentitypool"
...
&iamworkloadidentitypool.IamWorkloadIdentityPoolConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.iamWorkloadIdentityPool.IamWorkloadIdentityPoolTimeouts,
}
```
