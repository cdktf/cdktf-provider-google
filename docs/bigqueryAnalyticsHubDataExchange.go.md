...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/bigqueryanalyticshubdataexchange"
...
&bigqueryanalyticshubdataexchange.BigqueryAnalyticsHubDataExchangeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.bigqueryAnalyticsHubDataExchange.BigqueryAnalyticsHubDataExchangeTimeouts,
}
```
