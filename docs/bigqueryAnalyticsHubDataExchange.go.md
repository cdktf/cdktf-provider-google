...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigqueryanalyticshubdataexchange"
...
&bigqueryanalyticshubdataexchange.BigqueryAnalyticsHubDataExchangeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.bigqueryAnalyticsHubDataExchange.BigqueryAnalyticsHubDataExchangeTimeouts,
}
```
