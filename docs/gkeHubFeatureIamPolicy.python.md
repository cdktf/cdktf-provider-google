...
| <code><a href="#@cdktf/provider-google.gkeHubFeatureIamPolicy.GkeHubFeatureIamPolicy.Initializer.parameter.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/gke_hub_feature_iam_policy#name GkeHubFeatureIamPolicy#name}. |
| <code><a href="#@cdktf/provider-google.gkeHubFeatureIamPolicy.GkeHubFeatureIamPolicy.Initializer.parameter.policyData">policy_data</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/gke_hub_feature_iam_policy#policy_data GkeHubFeatureIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google.gkeHubFeatureIamPolicy.GkeHubFeatureIamPolicy.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/gke_hub_feature_iam_policy#id GkeHubFeatureIamPolicy#id}. |
...
| <code><a href="#@cdktf/provider-google.gkeHubFeatureIamPolicy.GkeHubFeatureIamPolicyConfig.property.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/gke_hub_feature_iam_policy#name GkeHubFeatureIamPolicy#name}. |
...
| <code><a href="#@cdktf/provider-google.gkeHubFeatureIamPolicy.GkeHubFeatureIamPolicyConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/gke_hub_feature_iam_policy#id GkeHubFeatureIamPolicy#id}. |
