...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.17.0/docs/resources/iap_tunnel_iam_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google.iapTunnelIamPolicy.IapTunnelIamPolicyConfig.property.policyData">policyData</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.17.0/docs/resources/iap_tunnel_iam_policy#policy_data IapTunnelIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google.iapTunnelIamPolicy.IapTunnelIamPolicyConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.17.0/docs/resources/iap_tunnel_iam_policy#id IapTunnelIamPolicy#id}. |
| <code><a href="#@cdktf/provider-google.iapTunnelIamPolicy.IapTunnelIamPolicyConfig.property.project">project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.17.0/docs/resources/iap_tunnel_iam_policy#project IapTunnelIamPolicy#project}. |
