...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigtabletableiammember"
...
&bigtabletableiammember.BigtableTableIamMemberConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.bigtableTableIamMember.BigtableTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
