...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/bigtabletableiammember"
...
&bigtabletableiammember.BigtableTableIamMemberConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.bigtableTableIamMember.BigtableTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
