...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/bigtabletableiammember"
...
&bigtabletableiammember.BigtableTableIamMemberConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.bigtableTableIamMember.BigtableTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
