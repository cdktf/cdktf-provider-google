...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/bigtabletableiammember"
...
| <code><a href="#@cdktf/provider-google.bigtableTableIamMember.BigtableTableIamMember.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&bigtabletableiammember.BigtableTableIamMemberConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v16.bigtableTableIamMember.BigtableTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.bigtableTableIamMember.BigtableTableIamMemberConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
