...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/bigtabletableiammember"
...
&bigtabletableiammember.BigtableTableIamMemberConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.bigtableTableIamMember.BigtableTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
