...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computesharedvpchostproject"
...
&computesharedvpchostproject.ComputeSharedVpcHostProjectConfig {
	...
	Project: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeSharedVpcHostProject.ComputeSharedVpcHostProjectTimeouts,
}
```
