...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computesharedvpchostproject"
...
&computesharedvpchostproject.ComputeSharedVpcHostProjectConfig {
	...
	Project: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeSharedVpcHostProject.ComputeSharedVpcHostProjectTimeouts,
}
```
