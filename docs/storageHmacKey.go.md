...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/storagehmackey"
...
&storagehmackey.StorageHmacKeyConfig {
	...
	Project: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.storageHmacKey.StorageHmacKeyTimeouts,
}
```
