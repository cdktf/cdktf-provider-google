...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/storagehmackey"
...
&storagehmackey.StorageHmacKeyConfig {
	...
	Project: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.storageHmacKey.StorageHmacKeyTimeouts,
}
```
