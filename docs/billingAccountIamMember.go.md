...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/billingaccountiammember"
...
&billingaccountiammember.BillingAccountIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.billingAccountIamMember.BillingAccountIamMemberCondition,
	Id: *string,
}
```
