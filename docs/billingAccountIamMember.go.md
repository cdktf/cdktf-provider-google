...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/billingaccountiammember"
...
&billingaccountiammember.BillingAccountIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.billingAccountIamMember.BillingAccountIamMemberCondition,
	Id: *string,
}
```
