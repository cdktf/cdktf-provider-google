...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/containerazureclient"
...
&containerazureclient.ContainerAzureClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.containerAzureClient.ContainerAzureClientTimeouts,
}
```
