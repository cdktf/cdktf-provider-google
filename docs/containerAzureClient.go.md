...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/containerazureclient"
...
&containerazureclient.ContainerAzureClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.containerAzureClient.ContainerAzureClientTimeouts,
}
```
