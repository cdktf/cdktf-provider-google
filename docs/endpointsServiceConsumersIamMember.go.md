...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/endpointsserviceconsumersiammember"
...
&endpointsserviceconsumersiammember.EndpointsServiceConsumersIamMemberConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.endpointsServiceConsumersIamMember.EndpointsServiceConsumersIamMemberCondition,
	Id: *string,
}
```
