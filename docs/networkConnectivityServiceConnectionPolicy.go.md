...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/networkconnectivityserviceconnectionpolicy"
...
&networkconnectivityserviceconnectionpolicy.NetworkConnectivityServiceConnectionPolicyConfig {
	...
	Project: *string,
	PscConfig: github.com/cdktf/cdktf-provider-google-go/google/v16.networkConnectivityServiceConnectionPolicy.NetworkConnectivityServiceConnectionPolicyPscConfig,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.networkConnectivityServiceConnectionPolicy.NetworkConnectivityServiceConnectionPolicyTimeouts,
}
```
...
```go
func ResetAllowedGoogleProducersResourceHierarchyLevel()
```
...
```go
func ResetProducerInstanceLocation()
```
...
```go
func AllowedGoogleProducersResourceHierarchyLevelInput() *[]*string
```
...
```go
func ProducerInstanceLocationInput() *string
```
...
```go
func AllowedGoogleProducersResourceHierarchyLevel() *[]*string
```
...
```go
func ProducerInstanceLocation() *string
```
