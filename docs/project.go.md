...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/project"
...
&project.ProjectConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.project.ProjectTimeouts,
}
```
