...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/project"
...
&project.ProjectConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.project.ProjectTimeouts,
}
```
