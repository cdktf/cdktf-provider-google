...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/project"
...
&project.ProjectConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.project.ProjectTimeouts,
}
```
