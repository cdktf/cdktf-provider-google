...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/project"
...
&project.ProjectConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.project.ProjectTimeouts,
}
```
