...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/project"
...
&project.ProjectConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.project.ProjectTimeouts,
}
```
