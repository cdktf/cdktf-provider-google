...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/migrationcentergroup"
...
&migrationcentergroup.MigrationCenterGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.migrationCenterGroup.MigrationCenterGroupTimeouts,
}
```
