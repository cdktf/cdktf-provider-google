...
Refer to the Terraform Registory for docs: [`data_google_monitoring_notification_channel`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/data-sources/monitoring_notification_channel).
