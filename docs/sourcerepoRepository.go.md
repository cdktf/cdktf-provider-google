...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/sourcereporepository"
...
&sourcereporepository.SourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.sourcerepoRepository.SourcerepoRepositoryTimeouts,
}
```
