...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/sourcereporepository"
...
| <code><a href="#@cdktf/provider-google.sourcerepoRepository.SourcerepoRepository.property.createIgnoreAlreadyExistsInput">CreateIgnoreAlreadyExistsInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.sourcerepoRepository.SourcerepoRepository.property.createIgnoreAlreadyExists">CreateIgnoreAlreadyExists</a></code> | <code>interface{}</code> | *No description.* |
...
&sourcereporepository.SourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.sourcerepoRepository.SourcerepoRepositoryTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.sourcerepoRepository.SourcerepoRepositoryConfig.property.createIgnoreAlreadyExists">CreateIgnoreAlreadyExists</a></code> | <code>interface{}</code> | If set to true, skip repository creation if a repository with the same name already exists. |
