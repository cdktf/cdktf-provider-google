...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/sourcereporepository"
...
&sourcereporepository.SourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.sourcerepoRepository.SourcerepoRepositoryTimeouts,
}
```
