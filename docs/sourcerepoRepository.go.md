...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/sourcereporepository"
...
&sourcereporepository.SourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.sourcerepoRepository.SourcerepoRepositoryTimeouts,
}
```
