...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.apigeeInstance.ApigeeInstanceTimeouts,
}
```
