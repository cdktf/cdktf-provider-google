...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.apigeeInstance.ApigeeInstanceTimeouts,
}
```
