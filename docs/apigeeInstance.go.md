...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.apigeeInstance.ApigeeInstanceTimeouts,
}
```
