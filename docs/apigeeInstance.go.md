...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.apigeeInstance.ApigeeInstanceTimeouts,
}
```
