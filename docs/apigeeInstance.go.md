...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.apigeeInstance.ApigeeInstanceTimeouts,
}
```
