...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.apigeeInstance.ApigeeInstanceTimeouts,
}
```
