...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/apigeeinstance"
...
&apigeeinstance.ApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.apigeeInstance.ApigeeInstanceTimeouts,
}
```
