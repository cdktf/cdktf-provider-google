...
| <code><a href="#@cdktf/provider-google.loggingFolderSettings.LoggingFolderSettingsConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/logging_folder_settings#id LoggingFolderSettings#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.loggingFolderSettings.LoggingFolderSettingsTimeouts.property.create">create</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/logging_folder_settings#create LoggingFolderSettings#create}. |
| <code><a href="#@cdktf/provider-google.loggingFolderSettings.LoggingFolderSettingsTimeouts.property.delete">delete</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/logging_folder_settings#delete LoggingFolderSettings#delete}. |
| <code><a href="#@cdktf/provider-google.loggingFolderSettings.LoggingFolderSettingsTimeouts.property.update">update</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/logging_folder_settings#update LoggingFolderSettings#update}. |
