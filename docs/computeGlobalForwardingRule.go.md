...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeglobalforwardingrule"
...
&computeglobalforwardingrule.ComputeGlobalForwardingRuleConfig {
	...
	PortRange: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeGlobalForwardingRule.ComputeGlobalForwardingRuleTimeouts,
}
```
