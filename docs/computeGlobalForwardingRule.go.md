...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/computeglobalforwardingrule"
...
```go
func ResetExternalManagedBackendBucketMigrationState()
```
...
```go
func ResetExternalManagedBackendBucketMigrationTestingPercentage()
```
...
| <code><a href="#@cdktf/provider-google.computeGlobalForwardingRule.ComputeGlobalForwardingRule.property.forwardingRuleId">ForwardingRuleId</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeGlobalForwardingRule.ComputeGlobalForwardingRule.property.externalManagedBackendBucketMigrationTestingPercentageInput">ExternalManagedBackendBucketMigrationTestingPercentageInput</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeGlobalForwardingRule.ComputeGlobalForwardingRule.property.externalManagedBackendBucketMigrationTestingPercentage">ExternalManagedBackendBucketMigrationTestingPercentage</a></code> | <code>*f64</code> | *No description.* |
...
```go
func ExternalManagedBackendBucketMigrationStateInput() *string
```
...
```go
func ExternalManagedBackendBucketMigrationTestingPercentageInput() *f64
```
...
```go
func ExternalManagedBackendBucketMigrationState() *string
```
...
```go
func ExternalManagedBackendBucketMigrationTestingPercentage() *f64
```
...
&computeglobalforwardingrule.ComputeGlobalForwardingRuleConfig {
	...
	ExternalManagedBackendBucketMigrationTestingPercentage: *f64,
	Id: *string,
	IpAddress: *string,
	IpProtocol: *string,
	IpVersion: *string,
	...
	PortRange: *string,
	Project: *string,
	ServiceDirectoryRegistrations: github.com/cdktf/cdktf-provider-google-go/google/v16.computeGlobalForwardingRule.ComputeGlobalForwardingRuleServiceDirectoryRegistrations,
	SourceIpRanges: *[]*string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.computeGlobalForwardingRule.ComputeGlobalForwardingRuleTimeouts,
}
```
