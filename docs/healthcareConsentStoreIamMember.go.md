...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/healthcareconsentstoreiammember"
...
&healthcareconsentstoreiammember.HealthcareConsentStoreIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.healthcareConsentStoreIamMember.HealthcareConsentStoreIamMemberCondition,
	Id: *string,
}
```
