...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/healthcareconsentstoreiammember"
...
&healthcareconsentstoreiammember.HealthcareConsentStoreIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.healthcareConsentStoreIamMember.HealthcareConsentStoreIamMemberCondition,
	Id: *string,
}
```
