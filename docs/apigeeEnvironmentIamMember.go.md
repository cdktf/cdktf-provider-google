...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/apigeeenvironmentiammember"
...
&apigeeenvironmentiammember.ApigeeEnvironmentIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.apigeeEnvironmentIamMember.ApigeeEnvironmentIamMemberCondition,
	Id: *string,
}
```
