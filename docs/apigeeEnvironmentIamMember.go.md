...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/apigeeenvironmentiammember"
...
&apigeeenvironmentiammember.ApigeeEnvironmentIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.apigeeEnvironmentIamMember.ApigeeEnvironmentIamMemberCondition,
	Id: *string,
}
```
