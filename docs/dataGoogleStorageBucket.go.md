...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/datagooglestoragebucket"
...
| <code><a href="#@cdktf/provider-google.dataGoogleStorageBucket.DataGoogleStorageBucketConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.62.1/docs/data-sources/storage_bucket#id DataGoogleStorageBucket#id}. |
