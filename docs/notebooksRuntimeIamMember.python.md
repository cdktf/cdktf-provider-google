...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.member">member</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#member NotebooksRuntimeIamMember#member}. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.role">role</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#role NotebooksRuntimeIamMember#role}. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.runtimeName">runtime_name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#runtime_name NotebooksRuntimeIamMember#runtime_name}. |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#id NotebooksRuntimeIamMember#id}. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.location">location</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#location NotebooksRuntimeIamMember#location}. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.Initializer.parameter.project">project</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#project NotebooksRuntimeIamMember#project}. |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.addMoveTarget">add_move_target</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.hasResourceMove">has_resource_move</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.importFrom">import_from</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveFromId">move_from_id</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveTo">move_to</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveToId">move_to_id</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.toHclTerraform"></a>
...
##### `add_move_target` <a name="add_move_target" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.addMoveTarget"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.addMoveTarget.parameter.moveTarget"></a>
...
##### `has_resource_move` <a name="has_resource_move" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.hasResourceMove"></a>

```python
def has_resource_move() -> typing.Union[TerraformResourceMoveByTarget, TerraformResourceMoveById]
```

##### `import_from` <a name="import_from" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.importFrom"></a>
...
##### `move_from_id` <a name="move_from_id" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveFromId"></a>
...
##### `move_to` <a name="move_to" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveTo"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveTo.parameter.moveTarget"></a>
...
##### `move_to_id` <a name="move_to_id" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.moveToId"></a>
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a NotebooksRuntimeIamMember resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.generateConfigForImport"></a>
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMember.property.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMemberCondition.property.expression">expression</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#expression NotebooksRuntimeIamMember#expression}. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMemberCondition.property.title">title</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#title NotebooksRuntimeIamMember#title}. |
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMemberCondition.property.description">description</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#description NotebooksRuntimeIamMember#description}. |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMemberConfig.property.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamMember.NotebooksRuntimeIamMemberConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/notebooks_runtime_iam_member#id NotebooksRuntimeIamMember#id}. |
