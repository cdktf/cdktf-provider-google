...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/eventarcchannel"
...
&eventarcchannel.EventarcChannelConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.eventarcChannel.EventarcChannelTimeouts,
}
```
