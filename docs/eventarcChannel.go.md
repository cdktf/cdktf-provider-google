...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/eventarcchannel"
...
&eventarcchannel.EventarcChannelConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.eventarcChannel.EventarcChannelTimeouts,
}
```
