...
Refer to the Terraform Registory for docs: [`data_google_iap_tunnel_instance_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/data-sources/iap_tunnel_instance_iam_policy).
