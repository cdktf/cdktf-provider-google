...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/sourcereporepositoryiammember"
...
&sourcereporepositoryiammember.SourcerepoRepositoryIamMemberConfig {
	...
	Repository: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.sourcerepoRepositoryIamMember.SourcerepoRepositoryIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
