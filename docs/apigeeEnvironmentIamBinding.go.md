...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/apigeeenvironmentiambinding"
...
&apigeeenvironmentiambinding.ApigeeEnvironmentIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.apigeeEnvironmentIamBinding.ApigeeEnvironmentIamBindingCondition,
	Id: *string,
}
```
