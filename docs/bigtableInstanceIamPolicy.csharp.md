...
Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/bigtable_instance_iam_policy google_bigtable_instance_iam_policy}.
...
new BigtableInstanceIamPolicy(Construct Scope, string Id, BigtableInstanceIamPolicyConfig Config);
```
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.hasResourceMove">HasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.hasResourceMove"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.moveFromId"></a>
...
###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.moveFromId.parameter.id"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.moveToId"></a>
...
###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.moveToId.parameter.id"></a>
...
BigtableInstanceIamPolicy.IsConstruct(object X);
```
...
BigtableInstanceIamPolicy.IsTerraformElement(object X);
```
...
BigtableInstanceIamPolicy.IsTerraformResource(object X);
```
...
BigtableInstanceIamPolicy.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/bigtable_instance_iam_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.connection">Connection</a></code> | <code>HashiCorp.Cdktf.SSHProvisionerConnection\|HashiCorp.Cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.count">Count</a></code> | <code>double\|HashiCorp.Cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicy.property.provisioners">Provisioners</a></code> | <code>HashiCorp.Cdktf.FileProvisioner\|HashiCorp.Cdktf.LocalExecProvisioner\|HashiCorp.Cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
new BigtableInstanceIamPolicyConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.connection">Connection</a></code> | <code>HashiCorp.Cdktf.SSHProvisionerConnection\|HashiCorp.Cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.count">Count</a></code> | <code>double\|HashiCorp.Cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.provisioners">Provisioners</a></code> | <code>HashiCorp.Cdktf.FileProvisioner\|HashiCorp.Cdktf.LocalExecProvisioner\|HashiCorp.Cdktf.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.instance">Instance</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/bigtable_instance_iam_policy#instance BigtableInstanceIamPolicy#instance}. |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.policyData">PolicyData</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/bigtable_instance_iam_policy#policy_data BigtableInstanceIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/bigtable_instance_iam_policy#id BigtableInstanceIamPolicy#id}. |
| <code><a href="#@cdktf/provider-google.bigtableInstanceIamPolicy.BigtableInstanceIamPolicyConfig.property.project">Project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/bigtable_instance_iam_policy#project BigtableInstanceIamPolicy#project}. |
