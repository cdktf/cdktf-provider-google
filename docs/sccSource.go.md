...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/sccsource"
...
&sccsource.SccSourceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.sccSource.SccSourceTimeouts,
}
```
