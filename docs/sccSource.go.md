...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/sccsource"
...
| <code><a href="#@cdktf/provider-google.sccSource.SccSource.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&sccsource.SccSourceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.sccSource.SccSourceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.sccSource.SccSourceConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
