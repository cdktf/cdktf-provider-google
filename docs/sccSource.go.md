...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/sccsource"
...
&sccsource.SccSourceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.sccSource.SccSourceTimeouts,
}
```
