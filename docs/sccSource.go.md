...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/sccsource"
...
&sccsource.SccSourceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.sccSource.SccSourceTimeouts,
}
```
