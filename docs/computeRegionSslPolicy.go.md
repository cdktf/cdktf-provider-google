...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computeregionsslpolicy"
...
&computeregionsslpolicy.ComputeRegionSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeRegionSslPolicy.ComputeRegionSslPolicyTimeouts,
}
```
