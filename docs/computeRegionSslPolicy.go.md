...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeregionsslpolicy"
...
&computeregionsslpolicy.ComputeRegionSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeRegionSslPolicy.ComputeRegionSslPolicyTimeouts,
}
```
