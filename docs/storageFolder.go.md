...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/storagefolder"
...
&storagefolder.StorageFolderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.storageFolder.StorageFolderTimeouts,
}
```
