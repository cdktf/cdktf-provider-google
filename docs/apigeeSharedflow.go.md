...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/apigeesharedflow"
...
&apigeesharedflow.ApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.apigeeSharedflow.ApigeeSharedflowTimeouts,
}
```
