...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/apigeesharedflow"
...
| <code><a href="#@cdktf/provider-google.apigeeSharedflow.ApigeeSharedflow.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&apigeesharedflow.ApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.apigeeSharedflow.ApigeeSharedflowTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.apigeeSharedflow.ApigeeSharedflowConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
