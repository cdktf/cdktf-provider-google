...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/apigeesharedflow"
...
&apigeesharedflow.ApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.apigeeSharedflow.ApigeeSharedflowTimeouts,
}
```
