...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/apigeesharedflow"
...
&apigeesharedflow.ApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.apigeeSharedflow.ApigeeSharedflowTimeouts,
}
```
