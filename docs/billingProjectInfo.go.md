...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/billingprojectinfo"
...
&billingprojectinfo.BillingProjectInfoConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.billingProjectInfo.BillingProjectInfoTimeouts,
}
```
