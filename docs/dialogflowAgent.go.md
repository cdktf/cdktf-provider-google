...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/dialogflowagent"
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.dialogflowAgent.DialogflowAgentTimeouts,
}
```
