...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/dialogflowagent"
...
| <code><a href="#@cdktf/provider-google.dialogflowAgent.DialogflowAgent.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.dialogflowAgent.DialogflowAgentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.dialogflowAgent.DialogflowAgentConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
