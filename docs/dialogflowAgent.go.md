...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dialogflowagent"
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.dialogflowAgent.DialogflowAgentTimeouts,
}
```
