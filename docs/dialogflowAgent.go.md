...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/dialogflowagent"
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.dialogflowAgent.DialogflowAgentTimeouts,
}
```
