...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/dialogflowagent"
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dialogflowAgent.DialogflowAgentTimeouts,
}
```
