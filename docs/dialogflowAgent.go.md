...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/dialogflowagent"
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.dialogflowAgent.DialogflowAgentTimeouts,
}
```
