...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/dialogflowagent"
...
&dialogflowagent.DialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.dialogflowAgent.DialogflowAgentTimeouts,
}
```
