...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/datacatalogpolicytagiammember"
...
&datacatalogpolicytagiammember.DataCatalogPolicyTagIamMemberConfig {
	...
	PolicyTag: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataCatalogPolicyTagIamMember.DataCatalogPolicyTagIamMemberCondition,
	Id: *string,
}
```
