...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/datacatalogpolicytagiammember"
...
&datacatalogpolicytagiammember.DataCatalogPolicyTagIamMemberConfig {
	...
	PolicyTag: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.dataCatalogPolicyTagIamMember.DataCatalogPolicyTagIamMemberCondition,
	Id: *string,
}
```
