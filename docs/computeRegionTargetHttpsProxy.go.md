...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computeregiontargethttpsproxy"
...
&computeregiontargethttpsproxy.ComputeRegionTargetHttpsProxyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeRegionTargetHttpsProxy.ComputeRegionTargetHttpsProxyTimeouts,
}
```
