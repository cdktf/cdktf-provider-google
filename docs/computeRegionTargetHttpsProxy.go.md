...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/computeregiontargethttpsproxy"
...
&computeregiontargethttpsproxy.ComputeRegionTargetHttpsProxyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.computeRegionTargetHttpsProxy.ComputeRegionTargetHttpsProxyTimeouts,
}
```
