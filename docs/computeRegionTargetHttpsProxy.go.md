...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeregiontargethttpsproxy"
...
&computeregiontargethttpsproxy.ComputeRegionTargetHttpsProxyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeRegionTargetHttpsProxy.ComputeRegionTargetHttpsProxyTimeouts,
}
```
