...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/computeregiontargethttpsproxy"
...
&computeregiontargethttpsproxy.ComputeRegionTargetHttpsProxyConfig {
	...
	Region: *string,
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.computeRegionTargetHttpsProxy.ComputeRegionTargetHttpsProxyTimeouts,
}
```
