...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/networksecurityfirewallendpoint"
...
&networksecurityfirewallendpoint.NetworkSecurityFirewallEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.networkSecurityFirewallEndpoint.NetworkSecurityFirewallEndpointTimeouts,
}
```
