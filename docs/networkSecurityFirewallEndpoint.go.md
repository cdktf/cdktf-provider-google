...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networksecurityfirewallendpoint"
...
&networksecurityfirewallendpoint.NetworkSecurityFirewallEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkSecurityFirewallEndpoint.NetworkSecurityFirewallEndpointTimeouts,
}
```
