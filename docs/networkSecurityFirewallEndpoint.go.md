...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v13/networksecurityfirewallendpoint"
...
&networksecurityfirewallendpoint.NetworkSecurityFirewallEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v13.networkSecurityFirewallEndpoint.NetworkSecurityFirewallEndpointTimeouts,
}
```
