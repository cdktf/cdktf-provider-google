...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/networksecurityfirewallendpoint"
...
&networksecurityfirewallendpoint.NetworkSecurityFirewallEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.networkSecurityFirewallEndpoint.NetworkSecurityFirewallEndpointTimeouts,
}
```
