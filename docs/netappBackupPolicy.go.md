...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/netappbackuppolicy"
...
&netappbackuppolicy.NetappBackupPolicyConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.netappBackupPolicy.NetappBackupPolicyTimeouts,
}
```
