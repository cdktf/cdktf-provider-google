...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/netappbackup"
...
&netappbackup.NetappBackupConfig {
	...
	SourceVolume: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.netappBackup.NetappBackupTimeouts,
}
```
