...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/netappbackup"
...
&netappbackup.NetappBackupConfig {
	...
	SourceVolume: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.netappBackup.NetappBackupTimeouts,
}
```
