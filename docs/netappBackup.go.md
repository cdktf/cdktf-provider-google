...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v13/netappbackup"
...
&netappbackup.NetappBackupConfig {
	...
	SourceVolume: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v13.netappBackup.NetappBackupTimeouts,
}
```
