...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/bigqueryreservationassignment"
...
&bigqueryreservationassignment.BigqueryReservationAssignmentConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.bigqueryReservationAssignment.BigqueryReservationAssignmentTimeouts,
}
```
