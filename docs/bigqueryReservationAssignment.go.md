...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/bigqueryreservationassignment"
...
&bigqueryreservationassignment.BigqueryReservationAssignmentConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.bigqueryReservationAssignment.BigqueryReservationAssignmentTimeouts,
}
```
