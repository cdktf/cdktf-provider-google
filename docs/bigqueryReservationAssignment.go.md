...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigqueryreservationassignment"
...
&bigqueryreservationassignment.BigqueryReservationAssignmentConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.bigqueryReservationAssignment.BigqueryReservationAssignmentTimeouts,
}
```
