...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/apigeeendpointattachment"
...
&apigeeendpointattachment.ApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeouts,
}
```
