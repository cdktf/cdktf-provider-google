...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/apigeeendpointattachment"
...
| <code><a href="#@cdktf/provider-google.apigeeEndpointAttachment.ApigeeEndpointAttachment.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&apigeeendpointattachment.ApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.apigeeEndpointAttachment.ApigeeEndpointAttachmentConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
