...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/apigeeendpointattachment"
...
&apigeeendpointattachment.ApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeouts,
}
```
