...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/apigeeendpointattachment"
...
&apigeeendpointattachment.ApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeouts,
}
```
