...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computenetworkfirewallpolicy"
...
&computenetworkfirewallpolicy.ComputeNetworkFirewallPolicyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeNetworkFirewallPolicy.ComputeNetworkFirewallPolicyTimeouts,
}
```
