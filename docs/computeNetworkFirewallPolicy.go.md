...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computenetworkfirewallpolicy"
...
&computenetworkfirewallpolicy.ComputeNetworkFirewallPolicyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeNetworkFirewallPolicy.ComputeNetworkFirewallPolicyTimeouts,
}
```
