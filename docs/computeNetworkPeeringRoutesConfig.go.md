...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computenetworkpeeringroutesconfig"
...
&computenetworkpeeringroutesconfig.ComputeNetworkPeeringRoutesConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeNetworkPeeringRoutesConfig.ComputeNetworkPeeringRoutesConfigTimeouts,
}
```
