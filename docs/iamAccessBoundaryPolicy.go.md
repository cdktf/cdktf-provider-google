...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/iamaccessboundarypolicy"
...
&iamaccessboundarypolicy.IamAccessBoundaryPolicyConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/iam_access_boundary_policy#id IamAccessBoundaryPolicy#id}. |
...
&iamaccessboundarypolicy.IamAccessBoundaryPolicyRules {
	AccessBoundaryRule: github.com/cdktf/cdktf-provider-google-go/google/v11.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyRulesAccessBoundaryRule,
	Description: *string,
}
```
...
&iamaccessboundarypolicy.IamAccessBoundaryPolicyRulesAccessBoundaryRule {
	AvailabilityCondition: github.com/cdktf/cdktf-provider-google-go/google/v11.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyRulesAccessBoundaryRuleAvailabilityCondition,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/iam_access_boundary_policy#create IamAccessBoundaryPolicy#create}. |
| <code><a href="#@cdktf/provider-google.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyTimeouts.property.delete">Delete</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/iam_access_boundary_policy#delete IamAccessBoundaryPolicy#delete}. |
| <code><a href="#@cdktf/provider-google.iamAccessBoundaryPolicy.IamAccessBoundaryPolicyTimeouts.property.update">Update</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/iam_access_boundary_policy#update IamAccessBoundaryPolicy#update}. |
