...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/backupdrbackupplan"
...
&backupdrbackupplan.BackupDrBackupPlanBackupRules {
	...
	RuleId: *string,
	StandardSchedule: github.com/cdktf/cdktf-provider-google-go/google.backupDrBackupPlan.BackupDrBackupPlanBackupRulesStandardSchedule,
}
```
...
&backupdrbackupplan.BackupDrBackupPlanBackupRulesStandardSchedule {
	...
	TimeZone: *string,
	BackupWindow: github.com/cdktf/cdktf-provider-google-go/google.backupDrBackupPlan.BackupDrBackupPlanBackupRulesStandardScheduleBackupWindow,
	DaysOfMonth: *[]*f64,
	DaysOfWeek: *[]*string,
	HourlyFrequency: *f64,
	Months: *[]*string,
	WeekDayOfMonth: github.com/cdktf/cdktf-provider-google-go/google.backupDrBackupPlan.BackupDrBackupPlanBackupRulesStandardScheduleWeekDayOfMonth,
}
```
...
&backupdrbackupplan.BackupDrBackupPlanConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.backupDrBackupPlan.BackupDrBackupPlanTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.backupDrBackupPlan.BackupDrBackupPlanConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.26.0/docs/resources/backup_dr_backup_plan#id BackupDrBackupPlan#id}. |
| <code><a href="#@cdktf/provider-google.backupDrBackupPlan.BackupDrBackupPlanConfig.property.project">Project</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.26.0/docs/resources/backup_dr_backup_plan#project BackupDrBackupPlan#project}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.backupDrBackupPlan.BackupDrBackupPlanTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.26.0/docs/resources/backup_dr_backup_plan#create BackupDrBackupPlan#create}. |
| <code><a href="#@cdktf/provider-google.backupDrBackupPlan.BackupDrBackupPlanTimeouts.property.delete">Delete</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.26.0/docs/resources/backup_dr_backup_plan#delete BackupDrBackupPlan#delete}. |
