...
Refer to the Terraform Registory for docs: [`data_google_gke_backup_backup_plan_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/data-sources/gke_backup_backup_plan_iam_policy).
