...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/tagstagbinding"
...
&tagstagbinding.TagsTagBindingConfig {
	...
	TagValue: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.tagsTagBinding.TagsTagBindingTimeouts,
}
```
