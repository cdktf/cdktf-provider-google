...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/tagstagbinding"
...
&tagstagbinding.TagsTagBindingConfig {
	...
	TagValue: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.tagsTagBinding.TagsTagBindingTimeouts,
}
```
