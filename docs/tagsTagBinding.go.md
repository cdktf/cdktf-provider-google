...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/tagstagbinding"
...
&tagstagbinding.TagsTagBindingConfig {
	...
	TagValue: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.tagsTagBinding.TagsTagBindingTimeouts,
}
```
