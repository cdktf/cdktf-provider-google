...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/tagstagbinding"
...
&tagstagbinding.TagsTagBindingConfig {
	...
	TagValue: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.tagsTagBinding.TagsTagBindingTimeouts,
}
```
