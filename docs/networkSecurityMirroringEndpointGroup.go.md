...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networksecuritymirroringendpointgroup"
...
&networksecuritymirroringendpointgroup.NetworkSecurityMirroringEndpointGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkSecurityMirroringEndpointGroup.NetworkSecurityMirroringEndpointGroupTimeouts,
}
```
