...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/tagstagkeyiammember"
...
&tagstagkeyiammember.TagsTagKeyIamMemberConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.tagsTagKeyIamMember.TagsTagKeyIamMemberCondition,
	Id: *string,
}
```
