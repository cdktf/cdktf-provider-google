...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/tagstagkeyiammember"
...
&tagstagkeyiammember.TagsTagKeyIamMemberConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.tagsTagKeyIamMember.TagsTagKeyIamMemberCondition,
	Id: *string,
}
```
