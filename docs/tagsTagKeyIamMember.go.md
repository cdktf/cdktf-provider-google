...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/tagstagkeyiammember"
...
&tagstagkeyiammember.TagsTagKeyIamMemberConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.tagsTagKeyIamMember.TagsTagKeyIamMemberCondition,
	Id: *string,
}
```
