...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computeaddress"
...
&computeaddress.ComputeAddressConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeAddress.ComputeAddressTimeouts,
}
```
