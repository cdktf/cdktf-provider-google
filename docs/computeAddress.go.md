...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeaddress"
...
&computeaddress.ComputeAddressConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeAddress.ComputeAddressTimeouts,
}
```
