...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/computetargetpool"
...
&computetargetpool.ComputeTargetPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.computeTargetPool.ComputeTargetPoolTimeouts,
}
```
