...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/computetargetpool"
...
&computetargetpool.ComputeTargetPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.computeTargetPool.ComputeTargetPoolTimeouts,
}
```
