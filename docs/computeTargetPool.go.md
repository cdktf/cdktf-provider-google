...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computetargetpool"
...
&computetargetpool.ComputeTargetPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeTargetPool.ComputeTargetPoolTimeouts,
}
```
