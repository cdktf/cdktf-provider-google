...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computenetworkpeering"
...
&computenetworkpeering.ComputeNetworkPeeringConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeNetworkPeering.ComputeNetworkPeeringTimeouts,
}
```
