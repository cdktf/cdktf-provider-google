...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computenetworkpeering"
...
&computenetworkpeering.ComputeNetworkPeeringConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeNetworkPeering.ComputeNetworkPeeringTimeouts,
}
```
