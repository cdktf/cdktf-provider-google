...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/tagstagkey"
...
&tagstagkey.TagsTagKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.tagsTagKey.TagsTagKeyTimeouts,
}
```
