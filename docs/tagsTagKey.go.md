...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/tagstagkey"
...
&tagstagkey.TagsTagKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.tagsTagKey.TagsTagKeyTimeouts,
}
```
