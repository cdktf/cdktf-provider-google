...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/tagstagkey"
...
&tagstagkey.TagsTagKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.tagsTagKey.TagsTagKeyTimeouts,
}
```
