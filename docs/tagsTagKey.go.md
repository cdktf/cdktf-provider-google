...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/tagstagkey"
...
&tagstagkey.TagsTagKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.tagsTagKey.TagsTagKeyTimeouts,
}
```
