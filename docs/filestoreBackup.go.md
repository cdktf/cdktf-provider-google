...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.filestoreBackup.FilestoreBackupTimeouts,
}
```
