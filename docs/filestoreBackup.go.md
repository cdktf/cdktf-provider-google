...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.filestoreBackup.FilestoreBackupTimeouts,
}
```
