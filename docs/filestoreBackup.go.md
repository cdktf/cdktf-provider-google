...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.filestoreBackup.FilestoreBackupTimeouts,
}
```
