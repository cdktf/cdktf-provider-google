...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.filestoreBackup.FilestoreBackupTimeouts,
}
```
