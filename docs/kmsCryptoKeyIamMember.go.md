...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/kmscryptokeyiammember"
...
&kmscryptokeyiammember.KmsCryptoKeyIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.kmsCryptoKeyIamMember.KmsCryptoKeyIamMemberCondition,
	Id: *string,
}
```
