...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computenetworkendpointgroup"
...
&computenetworkendpointgroup.ComputeNetworkEndpointGroupConfig {
	...
	Project: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeNetworkEndpointGroup.ComputeNetworkEndpointGroupTimeouts,
	Zone: *string,
}
```
