...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/computenetworkendpointgroup"
...
&computenetworkendpointgroup.ComputeNetworkEndpointGroupConfig {
	...
	Project: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.computeNetworkEndpointGroup.ComputeNetworkEndpointGroupTimeouts,
	Zone: *string,
}
```
