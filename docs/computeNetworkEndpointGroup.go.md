...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computenetworkendpointgroup"
...
&computenetworkendpointgroup.ComputeNetworkEndpointGroupConfig {
	...
	Project: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeNetworkEndpointGroup.ComputeNetworkEndpointGroupTimeouts,
	Zone: *string,
}
```
