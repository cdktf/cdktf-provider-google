...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/healthcarefhirstoreiambinding"
...
&healthcarefhirstoreiambinding.HealthcareFhirStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.healthcareFhirStoreIamBinding.HealthcareFhirStoreIamBindingCondition,
	Id: *string,
}
```
