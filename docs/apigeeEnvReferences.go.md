...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/apigeeenvreferences"
...
&apigeeenvreferences.ApigeeEnvReferencesConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.apigeeEnvReferences.ApigeeEnvReferencesTimeouts,
}
```
