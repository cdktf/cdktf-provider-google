...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/computefirewall"
...
&computefirewall.ComputeFirewallConfig {
	...
	Id: *string,
	LogConfig: github.com/cdktf/cdktf-provider-google-go/google/v15.computeFirewall.ComputeFirewallLogConfig,
	Priority: *f64,
	Project: *string,
	SourceRanges: *[]*string,
	...
	TargetTags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.computeFirewall.ComputeFirewallTimeouts,
}
```
