...
Refer to the Terraform Registory for docs: [`google_certificate_manager_certificate_issuance_config`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/resources/certificate_manager_certificate_issuance_config).
