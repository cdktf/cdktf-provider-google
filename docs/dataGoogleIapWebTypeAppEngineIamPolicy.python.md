...
Refer to the Terraform Registory for docs: [`data_google_iap_web_type_app_engine_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/data-sources/iap_web_type_app_engine_iam_policy).
