...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/kmskeyring"
...
&kmskeyring.KmsKeyRingConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.kmsKeyRing.KmsKeyRingTimeouts,
}
```
