...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/kmskeyring"
...
&kmskeyring.KmsKeyRingConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.kmsKeyRing.KmsKeyRingTimeouts,
}
```
