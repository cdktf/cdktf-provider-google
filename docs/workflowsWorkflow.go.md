...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/workflowsworkflow"
...
&workflowsworkflow.WorkflowsWorkflowConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.workflowsWorkflow.WorkflowsWorkflowTimeouts,
}
```
