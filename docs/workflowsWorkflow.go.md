...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/workflowsworkflow"
...
&workflowsworkflow.WorkflowsWorkflowConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.workflowsWorkflow.WorkflowsWorkflowTimeouts,
}
```
