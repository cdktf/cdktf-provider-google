...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/sqluser"
...
&sqluser.SqlUserConfig {
	...
	Id: *string,
	Password: *string,
	PasswordPolicy: github.com/cdktf/cdktf-provider-google-go/google/v8.sqlUser.SqlUserPasswordPolicy,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.sqlUser.SqlUserTimeouts,
	Type: *string,
}
```
