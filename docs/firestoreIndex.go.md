...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/firestoreindex"
...
&firestoreindex.FirestoreIndexConfig {
	...
	Project: *string,
	QueryScope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.firestoreIndex.FirestoreIndexTimeouts,
}
```
