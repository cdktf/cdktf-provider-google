...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/firestoreindex"
...
&firestoreindex.FirestoreIndexConfig {
	...
	Project: *string,
	QueryScope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.firestoreIndex.FirestoreIndexTimeouts,
}
```
