...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/identityplatformtenantoauthidpconfig"
...
| <code><a href="#@cdktf/provider-google.identityPlatformTenantOauthIdpConfig.IdentityPlatformTenantOauthIdpConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&identityplatformtenantoauthidpconfig.IdentityPlatformTenantOauthIdpConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.identityPlatformTenantOauthIdpConfig.IdentityPlatformTenantOauthIdpConfigTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.identityPlatformTenantOauthIdpConfig.IdentityPlatformTenantOauthIdpConfigConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
