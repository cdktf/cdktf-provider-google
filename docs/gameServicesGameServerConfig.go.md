...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/gameservicesgameserverconfig"
...
&gameservicesgameserverconfig.GameServicesGameServerConfigConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.gameServicesGameServerConfig.GameServicesGameServerConfigTimeouts,
}
```
