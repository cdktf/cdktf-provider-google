...
```typescript
public readonly timeoutsInput: CertificateManagerCertificateIssuanceConfigTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-google.certificateManagerCertificateIssuanceConfig.CertificateManagerCertificateIssuanceConfigTimeouts">CertificateManagerCertificateIssuanceConfigTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: CertificateManagerCertificateIssuanceConfigTimeouts | IResolvable;
```
