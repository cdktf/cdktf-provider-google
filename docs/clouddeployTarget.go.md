...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/clouddeploytarget"
...
&clouddeploytarget.ClouddeployTargetConfig {
	...
	AnthosCluster: github.com/cdktf/cdktf-provider-google-go/google/v5.clouddeployTarget.ClouddeployTargetAnthosCluster,
	Description: *string,
	ExecutionConfigs: interface{},
	Gke: github.com/cdktf/cdktf-provider-google-go/google/v5.clouddeployTarget.ClouddeployTargetGke,
	Id: *string,
	Labels: *map[string]*string,
	Project: *string,
	RequireApproval: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.clouddeployTarget.ClouddeployTargetTimeouts,
}
```
