...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computesharedvpcserviceproject"
...
&computesharedvpcserviceproject.ComputeSharedVpcServiceProjectConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeSharedVpcServiceProject.ComputeSharedVpcServiceProjectTimeouts,
}
```
