...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/healthcaredatasetiammember"
...
&healthcaredatasetiammember.HealthcareDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.healthcareDatasetIamMember.HealthcareDatasetIamMemberCondition,
	Id: *string,
}
```
