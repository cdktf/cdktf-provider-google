...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/healthcaredatasetiammember"
...
&healthcaredatasetiammember.HealthcareDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.healthcareDatasetIamMember.HealthcareDatasetIamMemberCondition,
	Id: *string,
}
```
