...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/datacatalogentrygroup"
...
&datacatalogentrygroup.DataCatalogEntryGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dataCatalogEntryGroup.DataCatalogEntryGroupTimeouts,
}
```
