...
Refer to the Terraform Registory for docs: [`data_google_tags_tag_value_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/data-sources/tags_tag_value_iam_policy).
