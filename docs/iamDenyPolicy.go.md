...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/iamdenypolicy"
...
&iamdenypolicy.IamDenyPolicyConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.iamDenyPolicy.IamDenyPolicyTimeouts,
}
```
...
&iamdenypolicy.IamDenyPolicyRules {
	DenyRule: github.com/cdktf/cdktf-provider-google-go/google/v9.iamDenyPolicy.IamDenyPolicyRulesDenyRule,
	Description: *string,
}
```
...
&iamdenypolicy.IamDenyPolicyRulesDenyRule {
	DenialCondition: github.com/cdktf/cdktf-provider-google-go/google/v9.iamDenyPolicy.IamDenyPolicyRulesDenyRuleDenialCondition,
