...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/bigquerydatasetiammember"
...
&bigquerydatasetiammember.BigqueryDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.bigqueryDatasetIamMember.BigqueryDatasetIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
