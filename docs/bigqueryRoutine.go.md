...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/bigqueryroutine"
...
&bigqueryroutine.BigqueryRoutineConfig {
	...
	ReturnType: *string,
	RoutineType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.bigqueryRoutine.BigqueryRoutineTimeouts,
}
```
