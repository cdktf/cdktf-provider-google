...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/bigqueryroutine"
...
&bigqueryroutine.BigqueryRoutineConfig {
	...
	ReturnType: *string,
	RoutineType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.bigqueryRoutine.BigqueryRoutineTimeouts,
}
```
