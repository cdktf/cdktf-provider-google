...
```csharp
private void PutBuildConfig(CloudRunV2ServiceBuildConfig Value)
```
...
```csharp
private void PutScaling(CloudRunV2ServiceScaling Value)
```
...
```csharp
private void ResetInvokerIamDisabled()
```
...
CloudRunV2Service.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.effectiveAnnotations">EffectiveAnnotations</a></code> | <code>HashiCorp.Cdktf.StringMap</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.effectiveLabels">EffectiveLabels</a></code> | <code>HashiCorp.Cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.terraformLabels">TerraformLabels</a></code> | <code>HashiCorp.Cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.deletionProtectionInput">DeletionProtectionInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.invokerIamDisabledInput">InvokerIamDisabledInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.deletionProtection">DeletionProtection</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2Service.property.invokerIamDisabled">InvokerIamDisabled</a></code> | <code>object</code> | *No description.* |
...
```csharp
public CloudRunV2ServiceBuildConfigOutputReference BuildConfig { get; }
```
...
```csharp
public CloudRunV2ServiceScalingOutputReference Scaling { get; }
```
...
```csharp
public CloudRunV2ServiceBuildConfig BuildConfigInput { get; }
```
...
```csharp
public object InvokerIamDisabledInput { get; }
```
...
```csharp
public CloudRunV2ServiceScaling ScalingInput { get; }
```
...
```csharp
public object InvokerIamDisabled { get; }
```
...
new CloudRunV2ServiceBuildConfig {
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfig.property.enableAutomaticUpdates">EnableAutomaticUpdates</a></code> | <code>object</code> | Sets whether the function will receive automatic base image updates. |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfig.property.environmentVariables">EnvironmentVariables</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | User-provided build-time environment variables for the function. |
...
new CloudRunV2ServiceConfig {
    ...
    CloudRunV2ServiceBuildConfig BuildConfig = null,
    string Client = null,
    ...
    string Id = null,
    string Ingress = null,
    object InvokerIamDisabled = null,
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceConfig.property.deletionProtection">DeletionProtection</a></code> | <code>object</code> | Whether Terraform will be prevented from destroying the service. |
...
```csharp
public CloudRunV2ServiceBuildConfig BuildConfig { get; set; }
```
...
```csharp
public object InvokerIamDisabled { get; set; }
```
...
```csharp
public CloudRunV2ServiceScaling Scaling { get; set; }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceScaling.property.minInstanceCount">MinInstanceCount</a></code> | <code>double</code> | Minimum number of instances for the service, to be divided among all revisions receiving traffic. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplate.property.annotations">Annotations</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Unstructured key value map that may be set by external tools to store and arbitrary metadata. |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplate.property.labels">Labels</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Unstructured key value map that can be used to organize and categorize objects. |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplate.property.sessionAffinity">SessionAffinity</a></code> | <code>object</code> | Enables session affinity. For more information, go to https://cloud.google.com/run/docs/configuring/session-affinity. |
...
new CloudRunV2ServiceTemplateContainers {
    string Image,
    string[] Args = null,
    string BaseImageUri = null,
    string[] Command = null,
    string[] DependsOn = null,
    object Env = null,
    CloudRunV2ServiceTemplateContainersLivenessProbe LivenessProbe = null,
    string Name = null,
    CloudRunV2ServiceTemplateContainersPorts Ports = null,
...
```csharp
public CloudRunV2ServiceTemplateContainersPorts Ports { get; set; }
```
...
new CloudRunV2ServiceTemplateContainersBuildInfo {
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersLivenessProbeHttpGet.property.port">Port</a></code> | <code>double</code> | Port number to access on the container. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersResources.property.cpuIdle">CpuIdle</a></code> | <code>object</code> | Determines whether CPU is only allocated during requests. |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersStartupProbeHttpGet.property.port">Port</a></code> | <code>double</code> | Port number to access on the container. |
...
new CloudRunV2ServiceTemplateVolumes {
    ...
    CloudRunV2ServiceTemplateVolumesEmptyDir EmptyDir = null,
    CloudRunV2ServiceTemplateVolumesGcs Gcs = null,
    CloudRunV2ServiceTemplateVolumesNfs Nfs = null,
...
```csharp
public CloudRunV2ServiceTemplateVolumesEmptyDir EmptyDir { get; set; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesGcs Gcs { get; set; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesNfs Nfs { get; set; }
```
...
new CloudRunV2ServiceTemplateVolumesEmptyDir {
    string Medium = null,
...
new CloudRunV2ServiceTemplateVolumesGcs {
    string Bucket,
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesGcs.property.readOnly">ReadOnly</a></code> | <code>object</code> | If true, mount the GCS bucket as read-only. |
...
new CloudRunV2ServiceTemplateVolumesNfs {
    string Path,
    string Server,
    object ReadOnly = null
};
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesNfs.property.readOnly">ReadOnly</a></code> | <code>object</code> | If true, mount the NFS volume as read only. |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccess.property.networkInterfaces">NetworkInterfaces</a></code> | <code>object</code> | network_interfaces block. |
...
new CloudRunV2ServiceTemplateVpcAccessNetworkInterfaces {
    string Network = null,
...
new CloudRunV2ServiceBuildConfigOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfigOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfigOutputReference.resolve.parameter._context"></a>
...
```csharp
private void ResetFunctionTarget()
```
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfigOutputReference.property.enableAutomaticUpdatesInput">EnableAutomaticUpdatesInput</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfigOutputReference.property.environmentVariablesInput">EnvironmentVariablesInput</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfigOutputReference.property.enableAutomaticUpdates">EnableAutomaticUpdates</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceBuildConfigOutputReference.property.environmentVariables">EnvironmentVariables</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | *No description.* |
...
```csharp
public string FunctionTargetInput { get; }
```
...
```csharp
public CloudRunV2ServiceBuildConfig InternalValue { get; }
```
...
new CloudRunV2ServiceScalingOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceScalingOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceScalingOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceScalingOutputReference.property.minInstanceCountInput">MinInstanceCountInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceScalingOutputReference.property.minInstanceCount">MinInstanceCount</a></code> | <code>double</code> | *No description.* |
...
```csharp
public CloudRunV2ServiceScaling InternalValue { get; }
```
...
new CloudRunV2ServiceTemplateContainersBuildInfoList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersBuildInfoList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersBuildInfoList.resolve.parameter._context"></a>
...
```csharp
private CloudRunV2ServiceTemplateContainersBuildInfoOutputReference Get(double Index)
```
...
new CloudRunV2ServiceTemplateContainersBuildInfoOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersBuildInfoOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersBuildInfoOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersBuildInfoOutputReference.resolve.parameter._context"></a>
...
```csharp
public CloudRunV2ServiceTemplateContainersBuildInfo InternalValue { get; }
```
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersLivenessProbeHttpGetOutputReference.property.portInput">PortInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersLivenessProbeHttpGetOutputReference.property.port">Port</a></code> | <code>double</code> | *No description.* |
...
```csharp
private void PutPorts(CloudRunV2ServiceTemplateContainersPorts Value)
```
...
```csharp
private void ResetBaseImageUri()
```
...
```csharp
public CloudRunV2ServiceTemplateContainersBuildInfoList BuildInfo { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateContainersPortsOutputReference Ports { get; }
```
...
```csharp
public string BaseImageUriInput { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateContainersPorts PortsInput { get; }
```
...
new CloudRunV2ServiceTemplateContainersPortsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```
...
```csharp
public CloudRunV2ServiceTemplateContainersPorts InternalValue { get; }
```
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersResourcesOutputReference.property.startupCpuBoostInput">StartupCpuBoostInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersResourcesOutputReference.property.startupCpuBoost">StartupCpuBoost</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersStartupProbeHttpGetOutputReference.property.portInput">PortInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateContainersStartupProbeHttpGetOutputReference.property.port">Port</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateOutputReference.property.sessionAffinityInput">SessionAffinityInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateOutputReference.property.sessionAffinity">SessionAffinity</a></code> | <code>object</code> | *No description.* |
...
new CloudRunV2ServiceTemplateVolumesEmptyDirOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesEmptyDirOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesEmptyDirOutputReference.resolve.parameter._context"></a>
...
```csharp
public CloudRunV2ServiceTemplateVolumesEmptyDir InternalValue { get; }
```
...
new CloudRunV2ServiceTemplateVolumesGcsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesGcsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesGcsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesGcsOutputReference.property.readOnlyInput">ReadOnlyInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesGcsOutputReference.property.readOnly">ReadOnly</a></code> | <code>object</code> | *No description.* |
...
```csharp
public CloudRunV2ServiceTemplateVolumesGcs InternalValue { get; }
```
...
new CloudRunV2ServiceTemplateVolumesNfsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesNfsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesNfsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesNfsOutputReference.property.readOnlyInput">ReadOnlyInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVolumesNfsOutputReference.property.readOnly">ReadOnly</a></code> | <code>object</code> | *No description.* |
...
```csharp
public CloudRunV2ServiceTemplateVolumesNfs InternalValue { get; }
```
...
```csharp
private void PutEmptyDir(CloudRunV2ServiceTemplateVolumesEmptyDir Value)
```
...
```csharp
private void PutGcs(CloudRunV2ServiceTemplateVolumesGcs Value)
```
...
```csharp
private void PutNfs(CloudRunV2ServiceTemplateVolumesNfs Value)
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesEmptyDirOutputReference EmptyDir { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesGcsOutputReference Gcs { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesNfsOutputReference Nfs { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesEmptyDir EmptyDirInput { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesGcs GcsInput { get; }
```
...
```csharp
public CloudRunV2ServiceTemplateVolumesNfs NfsInput { get; }
```
...
new CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList.resolve.parameter._context"></a>
...
```csharp
private CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesOutputReference Get(double Index)
```
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList.property.internalValue">InternalValue</a></code> | <code>object</code> | *No description.* |
...
new CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesOutputReference.property.internalValue">InternalValue</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.cloudRunV2Service.CloudRunV2ServiceTemplateVpcAccessOutputReference.property.networkInterfacesInput">NetworkInterfacesInput</a></code> | <code>object</code> | *No description.* |
...
```csharp
public CloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList NetworkInterfaces { get; }
```
