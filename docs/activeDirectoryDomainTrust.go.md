...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/activedirectorydomaintrust"
...
&activedirectorydomaintrust.ActiveDirectoryDomainTrustConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.activeDirectoryDomainTrust.ActiveDirectoryDomainTrustTimeouts,
}
```
