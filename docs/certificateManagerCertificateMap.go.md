...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/certificatemanagercertificatemap"
...
&certificatemanagercertificatemap.CertificateManagerCertificateMapConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.certificateManagerCertificateMap.CertificateManagerCertificateMapTimeouts,
}
```
