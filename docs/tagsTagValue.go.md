...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/tagstagvalue"
...
&tagstagvalue.TagsTagValueConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.tagsTagValue.TagsTagValueTimeouts,
}
```
