...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/dialogflowcxentitytype"
...
&dialogflowcxentitytype.DialogflowCxEntityTypeConfig {
	...
	Parent: *string,
	Redact: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.dialogflowCxEntityType.DialogflowCxEntityTypeTimeouts,
}
```
