...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/dialogflowcxentitytype"
...
&dialogflowcxentitytype.DialogflowCxEntityTypeConfig {
	...
	Parent: *string,
	Redact: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dialogflowCxEntityType.DialogflowCxEntityTypeTimeouts,
}
```
