...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/datafusioninstanceiammember"
...
&datafusioninstanceiammember.DataFusionInstanceIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataFusionInstanceIamMember.DataFusionInstanceIamMemberCondition,
	Id: *string,
	Project: *string,
	Region: *string,
}
