...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dialogflowentitytype"
...
&dialogflowentitytype.DialogflowEntityTypeConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.dialogflowEntityType.DialogflowEntityTypeTimeouts,
}
```
