...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/kmskeyringimportjob"
...
&kmskeyringimportjob.KmsKeyRingImportJobConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.kmsKeyRingImportJob.KmsKeyRingImportJobTimeouts,
}
```
