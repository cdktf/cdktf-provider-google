...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/kmskeyringimportjob"
...
&kmskeyringimportjob.KmsKeyRingImportJobConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.kmsKeyRingImportJob.KmsKeyRingImportJobTimeouts,
}
```
