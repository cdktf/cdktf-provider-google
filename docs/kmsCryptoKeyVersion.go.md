...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/kmscryptokeyversion"
...
&kmscryptokeyversion.KmsCryptoKeyVersionConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.kmsCryptoKeyVersion.KmsCryptoKeyVersionTimeouts,
}
```
