...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/kmscryptokeyversion"
...
&kmscryptokeyversion.KmsCryptoKeyVersionConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.kmsCryptoKeyVersion.KmsCryptoKeyVersionTimeouts,
}
```
