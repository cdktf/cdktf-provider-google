...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dialogflowcxenvironment"
...
&dialogflowcxenvironment.DialogflowCxEnvironmentConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.dialogflowCxEnvironment.DialogflowCxEnvironmentTimeouts,
}
```
