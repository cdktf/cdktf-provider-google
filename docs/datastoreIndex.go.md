...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/datastoreindex"
...
&datastoreindex.DatastoreIndexConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.datastoreIndex.DatastoreIndexTimeouts,
}
```
