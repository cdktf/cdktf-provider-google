...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/datastoreindex"
...
&datastoreindex.DatastoreIndexConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.datastoreIndex.DatastoreIndexTimeouts,
}
```
