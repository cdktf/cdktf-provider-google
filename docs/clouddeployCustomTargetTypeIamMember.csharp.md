...
Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member google_clouddeploy_custom_target_type_iam_member}.
...
new ClouddeployCustomTargetTypeIamMember(Construct Scope, string Id, ClouddeployCustomTargetTypeIamMemberConfig Config);
```
...
```csharp
private void PutCondition(ClouddeployCustomTargetTypeIamMemberCondition Value)
```
...
ClouddeployCustomTargetTypeIamMember.IsConstruct(object X);
```
...
ClouddeployCustomTargetTypeIamMember.IsTerraformElement(object X);
```
...
ClouddeployCustomTargetTypeIamMember.IsTerraformResource(object X);
```
...
ClouddeployCustomTargetTypeIamMember.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMember.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
```csharp
public ClouddeployCustomTargetTypeIamMemberConditionOutputReference Condition { get; }
```
...
```csharp
public ClouddeployCustomTargetTypeIamMemberCondition ConditionInput { get; }
```
...
new ClouddeployCustomTargetTypeIamMemberCondition {
    string Expression,
    string Title,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberCondition.property.expression">Expression</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#expression ClouddeployCustomTargetTypeIamMember#expression}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberCondition.property.title">Title</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#title ClouddeployCustomTargetTypeIamMember#title}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberCondition.property.description">Description</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#description ClouddeployCustomTargetTypeIamMember#description}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#expression ClouddeployCustomTargetTypeIamMember#expression}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#title ClouddeployCustomTargetTypeIamMember#title}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#description ClouddeployCustomTargetTypeIamMember#description}.
...
new ClouddeployCustomTargetTypeIamMemberConfig {
    ...
    string Name,
    string Role,
    ClouddeployCustomTargetTypeIamMemberCondition Condition = null,
    string Id = null,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.member">Member</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#member ClouddeployCustomTargetTypeIamMember#member}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.name">Name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#name ClouddeployCustomTargetTypeIamMember#name}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.role">Role</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#role ClouddeployCustomTargetTypeIamMember#role}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.condition">Condition</a></code> | <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberCondition">ClouddeployCustomTargetTypeIamMemberCondition</a></code> | condition block. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#id ClouddeployCustomTargetTypeIamMember#id}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.location">Location</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#location ClouddeployCustomTargetTypeIamMember#location}. |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConfig.property.project">Project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#project ClouddeployCustomTargetTypeIamMember#project}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#member ClouddeployCustomTargetTypeIamMember#member}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#name ClouddeployCustomTargetTypeIamMember#name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#role ClouddeployCustomTargetTypeIamMember#role}.
...
```csharp
public ClouddeployCustomTargetTypeIamMemberCondition Condition { get; set; }
```
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#condition ClouddeployCustomTargetTypeIamMember#condition}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#id ClouddeployCustomTargetTypeIamMember#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#location ClouddeployCustomTargetTypeIamMember#location}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.12.0/docs/resources/clouddeploy_custom_target_type_iam_member#project ClouddeployCustomTargetTypeIamMember#project}.
...
new ClouddeployCustomTargetTypeIamMemberConditionOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConditionOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-google.clouddeployCustomTargetTypeIamMember.ClouddeployCustomTargetTypeIamMemberConditionOutputReference.resolve.parameter._context"></a>
...
```csharp
public ClouddeployCustomTargetTypeIamMemberCondition InternalValue { get; }
```
