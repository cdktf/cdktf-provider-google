...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeregiondiskiambinding"
...
&computeregiondiskiambinding.ComputeRegionDiskIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.computeRegionDiskIamBinding.ComputeRegionDiskIamBindingCondition,
	Id: *string,
	Project: *string,
	Region: *string,
}
