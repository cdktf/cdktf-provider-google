...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/bigquerydatasetaccess"
...
```go
func PutCondition(value BigqueryDatasetAccessConditionA)
```
...
| <code><a href="#@cdktf/provider-google.bigqueryDatasetAccess.BigqueryDatasetAccessA.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func Condition() BigqueryDatasetAccessConditionAOutputReference
```
...
```go
func ConditionInput() BigqueryDatasetAccessConditionA
```
...
&bigquerydatasetaccess.BigqueryDatasetAccessAConfig {
	...
	DatasetId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.bigqueryDatasetAccess.BigqueryDatasetAccessConditionA,
	Dataset: github.com/cdktf/cdktf-provider-google-go/google/v14.bigqueryDatasetAccess.BigqueryDatasetAccessDatasetA,
	Domain: *string,
	GroupByEmail: *string,
	IamMember: *string,
	Id: *string,
	Project: *string,
	Role: *string,
	Routine: github.com/cdktf/cdktf-provider-google-go/google/v14.bigqueryDatasetAccess.BigqueryDatasetAccessRoutineA,
	SpecialGroup: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.bigqueryDatasetAccess.BigqueryDatasetAccessTimeouts,
	UserByEmail: *string,
	View: github.com/cdktf/cdktf-provider-google-go/google/v14.bigqueryDatasetAccess.BigqueryDatasetAccessViewA,
}
```
...
| <code><a href="#@cdktf/provider-google.bigqueryDatasetAccess.BigqueryDatasetAccessAConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&bigquerydatasetaccess.BigqueryDatasetAccessDatasetA {
	Dataset: github.com/cdktf/cdktf-provider-google-go/google/v14.bigqueryDatasetAccess.BigqueryDatasetAccessDatasetDatasetA,
	TargetTypes: *[]*string,
}
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.bigqueryDatasetAccess.BigqueryDatasetAccessConditionAOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
```go
func InternalValue() BigqueryDatasetAccessConditionA
```
