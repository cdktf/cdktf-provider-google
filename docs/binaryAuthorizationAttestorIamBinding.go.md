...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/binaryauthorizationattestoriambinding"
...
&binaryauthorizationattestoriambinding.BinaryAuthorizationAttestorIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.binaryAuthorizationAttestorIamBinding.BinaryAuthorizationAttestorIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
