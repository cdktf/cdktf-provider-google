...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computetargetsslproxy"
...
&computetargetsslproxy.ComputeTargetSslProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeTargetSslProxy.ComputeTargetSslProxyTimeouts,
}
```
