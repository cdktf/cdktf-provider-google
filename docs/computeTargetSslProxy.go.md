...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computetargetsslproxy"
...
&computetargetsslproxy.ComputeTargetSslProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeTargetSslProxy.ComputeTargetSslProxyTimeouts,
}
```
