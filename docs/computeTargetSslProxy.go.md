...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/computetargetsslproxy"
...
&computetargetsslproxy.ComputeTargetSslProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.computeTargetSslProxy.ComputeTargetSslProxyTimeouts,
}
```
