...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/lustreinstance"
...
&lustreinstance.LustreInstanceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.lustreInstance.LustreInstanceTimeouts,
}
```
