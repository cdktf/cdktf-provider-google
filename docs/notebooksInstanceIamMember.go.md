...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/notebooksinstanceiammember"
...
&notebooksinstanceiammember.NotebooksInstanceIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.notebooksInstanceIamMember.NotebooksInstanceIamMemberCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
