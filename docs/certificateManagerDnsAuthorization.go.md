...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/certificatemanagerdnsauthorization"
...
&certificatemanagerdnsauthorization.CertificateManagerDnsAuthorizationConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.certificateManagerDnsAuthorization.CertificateManagerDnsAuthorizationTimeouts,
	Type: *string,
}
```
