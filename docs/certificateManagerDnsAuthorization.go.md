...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/certificatemanagerdnsauthorization"
...
&certificatemanagerdnsauthorization.CertificateManagerDnsAuthorizationConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.certificateManagerDnsAuthorization.CertificateManagerDnsAuthorizationTimeouts,
}
```
