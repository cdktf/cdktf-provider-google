...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/endpointsserviceiambinding"
...
&endpointsserviceiambinding.EndpointsServiceIamBindingConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.endpointsServiceIamBinding.EndpointsServiceIamBindingCondition,
	Id: *string,
}
```
