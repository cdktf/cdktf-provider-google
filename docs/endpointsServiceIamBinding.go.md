...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/endpointsserviceiambinding"
...
&endpointsserviceiambinding.EndpointsServiceIamBindingConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.endpointsServiceIamBinding.EndpointsServiceIamBindingCondition,
	Id: *string,
}
```
