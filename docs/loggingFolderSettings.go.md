...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/loggingfoldersettings"
...
&loggingfoldersettings.LoggingFolderSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.loggingFolderSettings.LoggingFolderSettingsTimeouts,
}
```
