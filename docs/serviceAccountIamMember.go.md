...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
