...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
