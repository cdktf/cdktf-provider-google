...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v16.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
