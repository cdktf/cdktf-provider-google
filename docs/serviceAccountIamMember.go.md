...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
