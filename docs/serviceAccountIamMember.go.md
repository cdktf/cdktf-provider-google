...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
