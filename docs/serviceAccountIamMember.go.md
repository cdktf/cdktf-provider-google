...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v15.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
