...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
