...
Refer to the Terraform Registory for docs: [`data_google_data_catalog_tag_template_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/data-sources/data_catalog_tag_template_iam_policy).
