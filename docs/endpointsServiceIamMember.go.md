...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/endpointsserviceiammember"
...
&endpointsserviceiammember.EndpointsServiceIamMemberConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.endpointsServiceIamMember.EndpointsServiceIamMemberCondition,
	Id: *string,
}
```
