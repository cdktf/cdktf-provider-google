...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigtableinstance"
...
&bigtableinstance.BigtableInstanceCluster {
	ClusterId: *string,
	AutoscalingConfig: github.com/cdktf/cdktf-provider-google-go/google/v6.bigtableInstance.BigtableInstanceClusterAutoscalingConfig,
	KmsKeyName: *string,
	NumNodes: *f64,
	StorageType: *string,
	Zone: *string,
