...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/apigeeenvkeystore"
...
&apigeeenvkeystore.ApigeeEnvKeystoreConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.apigeeEnvKeystore.ApigeeEnvKeystoreTimeouts,
}
```
