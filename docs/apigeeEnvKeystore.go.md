...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/apigeeenvkeystore"
...
&apigeeenvkeystore.ApigeeEnvKeystoreConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.apigeeEnvKeystore.ApigeeEnvKeystoreTimeouts,
}
```
