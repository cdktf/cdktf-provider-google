...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/compute_disk_iam_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google.computeDiskIamPolicy.ComputeDiskIamPolicyConfig.property.name">Name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/compute_disk_iam_policy#name ComputeDiskIamPolicy#name}. |
| <code><a href="#@cdktf/provider-google.computeDiskIamPolicy.ComputeDiskIamPolicyConfig.property.policyData">PolicyData</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/compute_disk_iam_policy#policy_data ComputeDiskIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google.computeDiskIamPolicy.ComputeDiskIamPolicyConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/compute_disk_iam_policy#id ComputeDiskIamPolicy#id}. |
| <code><a href="#@cdktf/provider-google.computeDiskIamPolicy.ComputeDiskIamPolicyConfig.property.project">Project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/compute_disk_iam_policy#project ComputeDiskIamPolicy#project}. |
| <code><a href="#@cdktf/provider-google.computeDiskIamPolicy.ComputeDiskIamPolicyConfig.property.zone">Zone</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/compute_disk_iam_policy#zone ComputeDiskIamPolicy#zone}. |
