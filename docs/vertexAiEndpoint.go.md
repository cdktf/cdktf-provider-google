...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/vertexaiendpoint"
...
| <code><a href="#@cdktf/provider-google.vertexAiEndpoint.VertexAiEndpoint.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&vertexaiendpoint.VertexAiEndpointConfig {
	...
	Name: *string,
	Description: *string,
	EncryptionSpec: github.com/cdktf/cdktf-provider-google-go/google/v6.vertexAiEndpoint.VertexAiEndpointEncryptionSpec,
	Id: *string,
	Labels: *map[string]*string,
	Network: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.vertexAiEndpoint.VertexAiEndpointTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.vertexAiEndpoint.VertexAiEndpointConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
