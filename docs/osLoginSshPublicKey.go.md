...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/osloginsshpublickey"
...
&osloginsshpublickey.OsLoginSshPublicKeyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.osLoginSshPublicKey.OsLoginSshPublicKeyTimeouts,
}
```
