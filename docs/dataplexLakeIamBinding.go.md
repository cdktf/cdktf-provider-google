...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dataplexlakeiambinding"
...
&dataplexlakeiambinding.DataplexLakeIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataplexLakeIamBinding.DataplexLakeIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
