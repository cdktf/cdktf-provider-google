...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/monitoringmonitoredproject"
...
&monitoringmonitoredproject.MonitoringMonitoredProjectConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.monitoringMonitoredProject.MonitoringMonitoredProjectTimeouts,
}
```
