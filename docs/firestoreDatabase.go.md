...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/firestoredatabase"
...
&firestoredatabase.FirestoreDatabaseConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.firestoreDatabase.FirestoreDatabaseTimeouts,
}
```
