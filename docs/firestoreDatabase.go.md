...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/firestoredatabase"
...
&firestoredatabase.FirestoreDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.firestoreDatabase.FirestoreDatabaseTimeouts,
}
```
