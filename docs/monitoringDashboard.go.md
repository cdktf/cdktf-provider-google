...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/monitoringdashboard"
...
&monitoringdashboard.MonitoringDashboardConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.monitoringDashboard.MonitoringDashboardTimeouts,
}
```
