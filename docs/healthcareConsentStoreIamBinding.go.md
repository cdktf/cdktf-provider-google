...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/healthcareconsentstoreiambinding"
...
&healthcareconsentstoreiambinding.HealthcareConsentStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.healthcareConsentStoreIamBinding.HealthcareConsentStoreIamBindingCondition,
	Id: *string,
}
```
