...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/spannerinstance"
...
&spannerinstance.SpannerInstanceConfig {
	...
	ProcessingUnits: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.spannerInstance.SpannerInstanceTimeouts,
}
```
