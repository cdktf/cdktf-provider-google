...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigtabletableiambinding"
...
&bigtabletableiambinding.BigtableTableIamBindingConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.bigtableTableIamBinding.BigtableTableIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
