...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/bigtabletableiambinding"
...
&bigtabletableiambinding.BigtableTableIamBindingConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.bigtableTableIamBinding.BigtableTableIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
