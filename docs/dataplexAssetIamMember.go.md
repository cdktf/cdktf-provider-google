...
Refer to the Terraform Registory for docs: [`google_dataplex_asset_iam_member`](https://www.terraform.io/docs/providers/google/r/dataplex_asset_iam_member).
...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/dataplexassetiammember"
...
&dataplexassetiammember.DataplexAssetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.dataplexAssetIamMember.DataplexAssetIamMemberCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
