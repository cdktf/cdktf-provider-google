...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/pubsubtopiciammember"
...
&pubsubtopiciammember.PubsubTopicIamMemberConfig {
	...
	Role: *string,
	Topic: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.pubsubTopicIamMember.PubsubTopicIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
