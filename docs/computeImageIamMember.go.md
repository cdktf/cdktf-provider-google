...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeimageiammember"
...
&computeimageiammember.ComputeImageIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.computeImageIamMember.ComputeImageIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
