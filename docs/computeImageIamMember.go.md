...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computeimageiammember"
...
&computeimageiammember.ComputeImageIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.computeImageIamMember.ComputeImageIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
