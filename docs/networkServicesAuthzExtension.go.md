...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/networkservicesauthzextension"
...
&networkservicesauthzextension.NetworkServicesAuthzExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.networkServicesAuthzExtension.NetworkServicesAuthzExtensionTimeouts,
	WireFormat: *string,
}
```
