...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/appenginefirewallrule"
...
&appenginefirewallrule.AppEngineFirewallRuleConfig {
	...
	Priority: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.appEngineFirewallRule.AppEngineFirewallRuleTimeouts,
}
```
