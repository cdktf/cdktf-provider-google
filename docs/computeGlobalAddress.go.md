...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computeglobaladdress"
...
&computeglobaladdress.ComputeGlobalAddressConfig {
	...
	Project: *string,
	Purpose: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeGlobalAddress.ComputeGlobalAddressTimeouts,
}
```
