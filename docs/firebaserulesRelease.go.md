...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/firebaserulesrelease"
...
| <code><a href="#@cdktf/provider-google.firebaserulesRelease.FirebaserulesRelease.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&firebaserulesrelease.FirebaserulesReleaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.firebaserulesRelease.FirebaserulesReleaseTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.firebaserulesRelease.FirebaserulesReleaseConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
