...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/firebaserulesrelease"
...
&firebaserulesrelease.FirebaserulesReleaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.firebaserulesRelease.FirebaserulesReleaseTimeouts,
}
```
