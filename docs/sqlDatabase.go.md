...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/sqldatabase"
...
&sqldatabase.SqlDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.sqlDatabase.SqlDatabaseTimeouts,
}
```
