...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/sqldatabase"
...
&sqldatabase.SqlDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.sqlDatabase.SqlDatabaseTimeouts,
}
```
