...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/sqldatabase"
...
&sqldatabase.SqlDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.sqlDatabase.SqlDatabaseTimeouts,
}
```
