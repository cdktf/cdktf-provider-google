...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/accesscontextmanageraccesspolicy"
...
&accesscontextmanageraccesspolicy.AccessContextManagerAccessPolicyConfig {
	...
	Id: *string,
	Scopes: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.accessContextManagerAccessPolicy.AccessContextManagerAccessPolicyTimeouts,
}
```
