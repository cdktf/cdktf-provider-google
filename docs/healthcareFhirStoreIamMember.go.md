...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/healthcarefhirstoreiammember"
...
&healthcarefhirstoreiammember.HealthcareFhirStoreIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.healthcareFhirStoreIamMember.HealthcareFhirStoreIamMemberCondition,
	Id: *string,
}
```
