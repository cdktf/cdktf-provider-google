...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/healthcarefhirstoreiammember"
...
&healthcarefhirstoreiammember.HealthcareFhirStoreIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.healthcareFhirStoreIamMember.HealthcareFhirStoreIamMemberCondition,
	Id: *string,
}
```
