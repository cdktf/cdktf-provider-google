...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/endpointsservice"
...
&endpointsservice.EndpointsServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.endpointsService.EndpointsServiceTimeouts,
}
```
