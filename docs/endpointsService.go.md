...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/endpointsservice"
...
&endpointsservice.EndpointsServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.endpointsService.EndpointsServiceTimeouts,
}
```
