...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/iamworkforcepool"
...
&iamworkforcepool.IamWorkforcePoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.iamWorkforcePool.IamWorkforcePoolTimeouts,
}
```
