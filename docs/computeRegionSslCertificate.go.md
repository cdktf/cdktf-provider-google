...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/computeregionsslcertificate"
...
| <code><a href="#@cdktf/provider-google.computeRegionSslCertificate.ComputeRegionSslCertificate.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&computeregionsslcertificate.ComputeRegionSslCertificateConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.computeRegionSslCertificate.ComputeRegionSslCertificateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.computeRegionSslCertificate.ComputeRegionSslCertificateConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
