...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeregionsslcertificate"
...
&computeregionsslcertificate.ComputeRegionSslCertificateConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeRegionSslCertificate.ComputeRegionSslCertificateTimeouts,
}
```
