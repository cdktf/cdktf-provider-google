...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/computeregionsslcertificate"
...
&computeregionsslcertificate.ComputeRegionSslCertificateConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.computeRegionSslCertificate.ComputeRegionSslCertificateTimeouts,
}
```
