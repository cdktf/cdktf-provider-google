...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computesnapshotiambinding"
...
&computesnapshotiambinding.ComputeSnapshotIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.computeSnapshotIamBinding.ComputeSnapshotIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
