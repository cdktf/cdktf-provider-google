...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computebackendservicesignedurlkey"
...
&computebackendservicesignedurlkey.ComputeBackendServiceSignedUrlKeyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeBackendServiceSignedUrlKey.ComputeBackendServiceSignedUrlKeyTimeouts,
}
```
