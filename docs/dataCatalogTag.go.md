...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/datacatalogtag"
...
&datacatalogtag.DataCatalogTagConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dataCatalogTag.DataCatalogTagTimeouts,
}
```
