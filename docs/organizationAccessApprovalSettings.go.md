...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/organizationaccessapprovalsettings"
...
&organizationaccessapprovalsettings.OrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsTimeouts,
}
```
