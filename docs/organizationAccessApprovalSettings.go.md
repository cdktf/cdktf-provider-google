...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/organizationaccessapprovalsettings"
...
&organizationaccessapprovalsettings.OrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsTimeouts,
}
```
