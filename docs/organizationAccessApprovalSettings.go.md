...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/organizationaccessapprovalsettings"
...
| <code><a href="#@cdktf/provider-google.organizationAccessApprovalSettings.OrganizationAccessApprovalSettings.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&organizationaccessapprovalsettings.OrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
