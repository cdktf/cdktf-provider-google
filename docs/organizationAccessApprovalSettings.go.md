...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/organizationaccessapprovalsettings"
...
&organizationaccessapprovalsettings.OrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsTimeouts,
}
```
