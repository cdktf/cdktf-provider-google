...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/organizationaccessapprovalsettings"
...
&organizationaccessapprovalsettings.OrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsTimeouts,
}
```
