...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/organizationaccessapprovalsettings"
...
&organizationaccessapprovalsettings.OrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.organizationAccessApprovalSettings.OrganizationAccessApprovalSettingsTimeouts,
}
```
