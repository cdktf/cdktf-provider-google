...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/healthcaredicomstoreiambinding"
...
&healthcaredicomstoreiambinding.HealthcareDicomStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.healthcareDicomStoreIamBinding.HealthcareDicomStoreIamBindingCondition,
	Id: *string,
}
```
