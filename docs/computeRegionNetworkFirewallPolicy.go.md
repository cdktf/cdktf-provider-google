...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/computeregionnetworkfirewallpolicy"
...
| <code><a href="#@cdktf/provider-google.computeRegionNetworkFirewallPolicy.ComputeRegionNetworkFirewallPolicy.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&computeregionnetworkfirewallpolicy.ComputeRegionNetworkFirewallPolicyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.computeRegionNetworkFirewallPolicy.ComputeRegionNetworkFirewallPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.computeRegionNetworkFirewallPolicy.ComputeRegionNetworkFirewallPolicyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
