...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/kmskeyringiammember"
...
&kmskeyringiammember.KmsKeyRingIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.kmsKeyRingIamMember.KmsKeyRingIamMemberCondition,
	Id: *string,
}
```
