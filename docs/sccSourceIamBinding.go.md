...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/sccsourceiambinding"
...
&sccsourceiambinding.SccSourceIamBindingConfig {
	...
	Role: *string,
	Source: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.sccSourceIamBinding.SccSourceIamBindingCondition,
	Id: *string,
}
```
