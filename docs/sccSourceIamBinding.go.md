...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/sccsourceiambinding"
...
&sccsourceiambinding.SccSourceIamBindingConfig {
	...
	Role: *string,
	Source: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.sccSourceIamBinding.SccSourceIamBindingCondition,
	Id: *string,
}
```
