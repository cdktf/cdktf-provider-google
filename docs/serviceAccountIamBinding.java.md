...
Refer to the Terraform Registory for docs: [`google_service_account_iam_binding`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/resources/service_account_iam_binding).
