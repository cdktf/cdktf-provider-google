...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computesslcertificate"
...
&computesslcertificate.ComputeSslCertificateConfig {
	...
	NamePrefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeSslCertificate.ComputeSslCertificateTimeouts,
}
```
