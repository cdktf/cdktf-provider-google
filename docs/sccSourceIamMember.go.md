...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/sccsourceiammember"
...
&sccsourceiammember.SccSourceIamMemberConfig {
	...
	Role: *string,
	Source: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.sccSourceIamMember.SccSourceIamMemberCondition,
	Id: *string,
}
```
