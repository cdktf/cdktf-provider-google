...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/sccsourceiammember"
...
&sccsourceiammember.SccSourceIamMemberConfig {
	...
	Role: *string,
	Source: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.sccSourceIamMember.SccSourceIamMemberCondition,
	Id: *string,
}
```
