...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/servicenetworkingpeereddnsdomain"
...
&servicenetworkingpeereddnsdomain.ServiceNetworkingPeeredDnsDomainConfig {
	...
	Project: *string,
	Service: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.serviceNetworkingPeeredDnsDomain.ServiceNetworkingPeeredDnsDomainTimeouts,
}
```
