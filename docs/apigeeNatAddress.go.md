...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/apigeenataddress"
...
&apigeenataddress.ApigeeNatAddressConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.apigeeNatAddress.ApigeeNatAddressTimeouts,
}
```
