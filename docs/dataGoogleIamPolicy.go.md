...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/datagoogleiampolicy"
...
&datagoogleiampolicy.DataGoogleIamPolicyBinding {
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataGoogleIamPolicy.DataGoogleIamPolicyBindingCondition,
}
```
