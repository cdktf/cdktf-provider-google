...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/organizationiammember"
...
&organizationiammember.OrganizationIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v11.organizationIamMember.OrganizationIamMemberCondition,
	Id: *string,
}
```
