...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/organizationiammember"
...
| <code><a href="#@cdktf/provider-google.organizationIamMember.OrganizationIamMember.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&organizationiammember.OrganizationIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.organizationIamMember.OrganizationIamMemberCondition,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.organizationIamMember.OrganizationIamMemberConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
