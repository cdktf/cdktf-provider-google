...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/organizationiammember"
...
&organizationiammember.OrganizationIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.organizationIamMember.OrganizationIamMemberCondition,
	Id: *string,
}
```
