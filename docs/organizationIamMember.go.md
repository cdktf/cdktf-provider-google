...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/organizationiammember"
...
&organizationiammember.OrganizationIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v16.organizationIamMember.OrganizationIamMemberCondition,
	Id: *string,
}
```
