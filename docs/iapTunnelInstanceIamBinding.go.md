...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/iaptunnelinstanceiambinding"
...
&iaptunnelinstanceiambinding.IapTunnelInstanceIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.iapTunnelInstanceIamBinding.IapTunnelInstanceIamBindingCondition,
	Id: *string,
	Project: *string,
	Zone: *string,
}
