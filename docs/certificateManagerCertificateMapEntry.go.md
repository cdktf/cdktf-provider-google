...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/certificatemanagercertificatemapentry"
...
&certificatemanagercertificatemapentry.CertificateManagerCertificateMapEntryConfig {
	...
	Matcher: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.certificateManagerCertificateMapEntry.CertificateManagerCertificateMapEntryTimeouts,
}
```
