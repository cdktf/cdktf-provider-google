...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/iapbrand"
...
&iapbrand.IapBrandConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.iapBrand.IapBrandTimeouts,
}
```
