...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/iapbrand"
...
&iapbrand.IapBrandConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.iapBrand.IapBrandTimeouts,
}
```
