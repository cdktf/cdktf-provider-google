...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/secretmanagersecretversion"
...
&secretmanagersecretversion.SecretManagerSecretVersionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.secretManagerSecretVersion.SecretManagerSecretVersionTimeouts,
}
```
