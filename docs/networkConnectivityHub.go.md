...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/networkconnectivityhub"
...
&networkconnectivityhub.NetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.networkConnectivityHub.NetworkConnectivityHubTimeouts,
}
```
