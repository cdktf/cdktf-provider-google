...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/networkconnectivityhub"
...
&networkconnectivityhub.NetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.networkConnectivityHub.NetworkConnectivityHubTimeouts,
}
```
