...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/networkconnectivityhub"
...
&networkconnectivityhub.NetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.networkConnectivityHub.NetworkConnectivityHubTimeouts,
}
```
