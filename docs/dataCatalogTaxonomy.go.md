...
Refer to the Terraform Registory for docs: [`google_data_catalog_taxonomy`](https://www.terraform.io/docs/providers/google/r/data_catalog_taxonomy).
...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/datacatalogtaxonomy"
...
&datacatalogtaxonomy.DataCatalogTaxonomyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dataCatalogTaxonomy.DataCatalogTaxonomyTimeouts,
}
```
