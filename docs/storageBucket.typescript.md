...
| <code><a href="#@cdktf/provider-google.storageBucket.StorageBucketLifecycleRuleCondition.property.noAge">noAge</a></code> | <code>boolean \| cdktf.IResolvable</code> | While set true, age value will be omitted.Required to set true when age is unset in the config file. |
...
```typescript
public readonly noAge: boolean | IResolvable;
```
...
| <code><a href="#@cdktf/provider-google.storageBucket.StorageBucketLifecycleRuleConditionOutputReference.property.noAgeInput">noAgeInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.storageBucket.StorageBucketLifecycleRuleConditionOutputReference.property.noAge">noAge</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly noAgeInput: boolean | IResolvable;
```
