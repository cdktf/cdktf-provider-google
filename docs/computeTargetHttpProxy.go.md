...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computetargethttpproxy"
...
&computetargethttpproxy.ComputeTargetHttpProxyConfig {
	...
	Project: *string,
	ProxyBind: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeTargetHttpProxy.ComputeTargetHttpProxyTimeouts,
}
```
