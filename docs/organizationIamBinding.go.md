...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/organizationiambinding"
...
&organizationiambinding.OrganizationIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.organizationIamBinding.OrganizationIamBindingCondition,
	Id: *string,
}
```
