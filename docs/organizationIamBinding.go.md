...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/organizationiambinding"
...
&organizationiambinding.OrganizationIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.organizationIamBinding.OrganizationIamBindingCondition,
	Id: *string,
}
```
