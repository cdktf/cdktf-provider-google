...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeinstancegroup"
...
&computeinstancegroup.ComputeInstanceGroupConfig {
	...
	Network: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeInstanceGroup.ComputeInstanceGroupTimeouts,
	Zone: *string,
}
```
