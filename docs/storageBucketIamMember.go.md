...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/storagebucketiammember"
...
&storagebucketiammember.StorageBucketIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.storageBucketIamMember.StorageBucketIamMemberCondition,
	Id: *string,
}
```
