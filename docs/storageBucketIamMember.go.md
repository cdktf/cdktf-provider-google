...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/storagebucketiammember"
...
&storagebucketiammember.StorageBucketIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.storageBucketIamMember.StorageBucketIamMemberCondition,
	Id: *string,
}
```
