...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/storagebucketiammember"
...
&storagebucketiammember.StorageBucketIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v15.storageBucketIamMember.StorageBucketIamMemberCondition,
	Id: *string,
}
```
