...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/projectdefaultserviceaccounts"
...
&projectdefaultserviceaccounts.ProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.projectDefaultServiceAccounts.ProjectDefaultServiceAccountsTimeouts,
}
```
