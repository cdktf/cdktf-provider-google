...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/projectdefaultserviceaccounts"
...
&projectdefaultserviceaccounts.ProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.projectDefaultServiceAccounts.ProjectDefaultServiceAccountsTimeouts,
}
```
