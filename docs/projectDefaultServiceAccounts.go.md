...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/projectdefaultserviceaccounts"
...
&projectdefaultserviceaccounts.ProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.projectDefaultServiceAccounts.ProjectDefaultServiceAccountsTimeouts,
}
```
