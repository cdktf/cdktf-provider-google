...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/resources/pubsub_schema_iam_binding#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google.pubsubSchemaIamBinding.PubsubSchemaIamBindingConfig.property.role">Role</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/resources/pubsub_schema_iam_binding#role PubsubSchemaIamBinding#role}. |
...
| <code><a href="#@cdktf/provider-google.pubsubSchemaIamBinding.PubsubSchemaIamBindingConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/resources/pubsub_schema_iam_binding#id PubsubSchemaIamBinding#id}. |
