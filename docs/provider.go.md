...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/provider"
...
&provider.GoogleProviderConfig {
	...
	Batching: github.com/cdktf/cdktf-provider-google-go/google/v6.provider.GoogleProviderBatching,
