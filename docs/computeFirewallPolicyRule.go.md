...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computefirewallpolicyrule"
...
| <code><a href="#@cdktf/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&computefirewallpolicyrule.ComputeFirewallPolicyRuleConfig {
	...
	Match: github.com/cdktf/cdktf-provider-google-go/google/v5.computeFirewallPolicyRule.ComputeFirewallPolicyRuleMatch,
	Priority: *f64,
	Description: *string,
	Disabled: interface{},
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeFirewallPolicyRule.ComputeFirewallPolicyRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
