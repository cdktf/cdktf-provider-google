...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/eventarcgooglechannelconfig"
...
&eventarcgooglechannelconfig.EventarcGoogleChannelConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.eventarcGoogleChannelConfig.EventarcGoogleChannelConfigTimeouts,
}
```
