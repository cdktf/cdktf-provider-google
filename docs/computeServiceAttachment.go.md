...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeserviceattachment"
...
&computeserviceattachment.ComputeServiceAttachmentConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeServiceAttachment.ComputeServiceAttachmentTimeouts,
}
```
