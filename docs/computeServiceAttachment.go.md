...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computeserviceattachment"
...
&computeserviceattachment.ComputeServiceAttachmentConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeServiceAttachment.ComputeServiceAttachmentTimeouts,
}
```
