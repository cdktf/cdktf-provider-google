...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computeserviceattachment"
...
&computeserviceattachment.ComputeServiceAttachmentConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeServiceAttachment.ComputeServiceAttachmentTimeouts,
}
```
