...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeserviceattachment"
...
&computeserviceattachment.ComputeServiceAttachmentConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeServiceAttachment.ComputeServiceAttachmentTimeouts,
}
```
