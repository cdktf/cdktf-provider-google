...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/accesscontextmanageraccesspolicyiammember"
...
&accesscontextmanageraccesspolicyiammember.AccessContextManagerAccessPolicyIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.accessContextManagerAccessPolicyIamMember.AccessContextManagerAccessPolicyIamMemberCondition,
	Id: *string,
}
```
