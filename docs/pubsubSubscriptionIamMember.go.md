...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/pubsubsubscriptioniammember"
...
&pubsubsubscriptioniammember.PubsubSubscriptionIamMemberConfig {
	...
	Role: *string,
	Subscription: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.pubsubSubscriptionIamMember.PubsubSubscriptionIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
