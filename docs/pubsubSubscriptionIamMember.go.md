...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/pubsubsubscriptioniammember"
...
&pubsubsubscriptioniammember.PubsubSubscriptionIamMemberConfig {
	...
	Role: *string,
	Subscription: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.pubsubSubscriptionIamMember.PubsubSubscriptionIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
