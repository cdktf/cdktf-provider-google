...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/containeranalysisnoteiammember"
...
&containeranalysisnoteiammember.ContainerAnalysisNoteIamMemberConfig {
	...
	Note: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.containerAnalysisNoteIamMember.ContainerAnalysisNoteIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
