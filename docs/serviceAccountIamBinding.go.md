...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/serviceaccountiambinding"
...
&serviceaccountiambinding.ServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.serviceAccountIamBinding.ServiceAccountIamBindingCondition,
	Id: *string,
}
```
