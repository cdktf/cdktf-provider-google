...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/serviceaccountiambinding"
...
&serviceaccountiambinding.ServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.serviceAccountIamBinding.ServiceAccountIamBindingCondition,
	Id: *string,
}
```
