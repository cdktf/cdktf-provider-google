...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/monitoringgroup"
...
&monitoringgroup.MonitoringGroupConfig {
	...
	ParentName: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.monitoringGroup.MonitoringGroupTimeouts,
}
```
