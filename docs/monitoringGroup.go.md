...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/monitoringgroup"
...
&monitoringgroup.MonitoringGroupConfig {
	...
	ParentName: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.monitoringGroup.MonitoringGroupTimeouts,
}
```
