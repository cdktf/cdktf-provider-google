...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/monitoringgroup"
...
&monitoringgroup.MonitoringGroupConfig {
	...
	ParentName: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.monitoringGroup.MonitoringGroupTimeouts,
}
```
