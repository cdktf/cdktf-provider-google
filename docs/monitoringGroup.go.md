...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/monitoringgroup"
...
| <code><a href="#@cdktf/provider-google.monitoringGroup.MonitoringGroup.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&monitoringgroup.MonitoringGroupConfig {
	...
	ParentName: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.monitoringGroup.MonitoringGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.monitoringGroup.MonitoringGroupConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
