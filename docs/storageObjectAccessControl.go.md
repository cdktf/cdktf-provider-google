...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/storageobjectaccesscontrol"
...
&storageobjectaccesscontrol.StorageObjectAccessControlConfig {
	...
	Role: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.storageObjectAccessControl.StorageObjectAccessControlTimeouts,
}
```
