...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/storageobjectaccesscontrol"
...
| <code><a href="#@cdktf/provider-google.storageObjectAccessControl.StorageObjectAccessControl.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&storageobjectaccesscontrol.StorageObjectAccessControlConfig {
	...
	Role: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.storageObjectAccessControl.StorageObjectAccessControlTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.storageObjectAccessControl.StorageObjectAccessControlConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
