...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/storageobjectaccesscontrol"
...
&storageobjectaccesscontrol.StorageObjectAccessControlConfig {
	...
	Role: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.storageObjectAccessControl.StorageObjectAccessControlTimeouts,
}
```
