...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computeattacheddisk"
...
&computeattacheddisk.ComputeAttachedDiskConfig {
	...
	Mode: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeAttachedDisk.ComputeAttachedDiskTimeouts,
	Zone: *string,
}
```
