...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeattacheddisk"
...
&computeattacheddisk.ComputeAttachedDiskConfig {
	...
	Mode: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeAttachedDisk.ComputeAttachedDiskTimeouts,
	Zone: *string,
}
```
