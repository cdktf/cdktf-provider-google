...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/folderaccessapprovalsettings"
...
&folderaccessapprovalsettings.FolderAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.folderAccessApprovalSettings.FolderAccessApprovalSettingsTimeouts,
}
```
