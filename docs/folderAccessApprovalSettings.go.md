...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/folderaccessapprovalsettings"
...
&folderaccessapprovalsettings.FolderAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.folderAccessApprovalSettings.FolderAccessApprovalSettingsTimeouts,
}
```
