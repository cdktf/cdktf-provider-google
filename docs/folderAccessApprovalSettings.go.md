...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/folderaccessapprovalsettings"
...
&folderaccessapprovalsettings.FolderAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.folderAccessApprovalSettings.FolderAccessApprovalSettingsTimeouts,
}
```
