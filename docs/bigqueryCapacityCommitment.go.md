...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigquerycapacitycommitment"
...
&bigquerycapacitycommitment.BigqueryCapacityCommitmentConfig {
	...
	Project: *string,
	RenewalPlan: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.bigqueryCapacityCommitment.BigqueryCapacityCommitmentTimeouts,
}
```
