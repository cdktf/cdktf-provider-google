...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/backupdrbackupvault"
...
&backupdrbackupvault.BackupDrBackupVaultConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.backupDrBackupVault.BackupDrBackupVaultTimeouts,
}
```
