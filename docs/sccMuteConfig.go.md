...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/sccmuteconfig"
...
&sccmuteconfig.SccMuteConfigConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.sccMuteConfig.SccMuteConfigTimeouts,
}
```
