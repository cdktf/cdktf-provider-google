...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/edgenetworknetwork"
...
&edgenetworknetwork.EdgenetworkNetworkConfig {
	...
	Mtu: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.edgenetworkNetwork.EdgenetworkNetworkTimeouts,
}
```
