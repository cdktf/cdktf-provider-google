...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/iaptunnelinstanceiammember"
...
| <code><a href="#@cdktf/provider-google.iapTunnelInstanceIamMember.IapTunnelInstanceIamMember.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&iaptunnelinstanceiammember.IapTunnelInstanceIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v11.iapTunnelInstanceIamMember.IapTunnelInstanceIamMemberCondition,
	Id: *string,
	Project: *string,
	Zone: *string,
}
...
| <code><a href="#@cdktf/provider-google.iapTunnelInstanceIamMember.IapTunnelInstanceIamMemberConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
