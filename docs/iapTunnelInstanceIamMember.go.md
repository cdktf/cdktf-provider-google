...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/iaptunnelinstanceiammember"
...
&iaptunnelinstanceiammember.IapTunnelInstanceIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.iapTunnelInstanceIamMember.IapTunnelInstanceIamMemberCondition,
	Id: *string,
	Project: *string,
	Zone: *string,
}
