...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/tagstagvalueiambinding"
...
&tagstagvalueiambinding.TagsTagValueIamBindingConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.tagsTagValueIamBinding.TagsTagValueIamBindingCondition,
	Id: *string,
}
```
