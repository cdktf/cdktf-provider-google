...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/resourcemanagerlien"
...
&resourcemanagerlien.ResourceManagerLienConfig {
	...
	Restrictions: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.resourceManagerLien.ResourceManagerLienTimeouts,
}
```
