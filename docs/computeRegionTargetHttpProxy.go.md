...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computeregiontargethttpproxy"
...
&computeregiontargethttpproxy.ComputeRegionTargetHttpProxyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeRegionTargetHttpProxy.ComputeRegionTargetHttpProxyTimeouts,
}
```
