...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/cloudiotregistryiammember"
...
&cloudiotregistryiammember.CloudiotRegistryIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.cloudiotRegistryIamMember.CloudiotRegistryIamMemberCondition,
	Id: *string,
	Project: *string,
	Region: *string,
}
