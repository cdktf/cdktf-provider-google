...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dialogflowintent"
...
&dialogflowintent.DialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.dialogflowIntent.DialogflowIntentTimeouts,
	WebhookState: *string,
}
```
