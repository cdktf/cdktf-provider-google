...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/dialogflowintent"
...
&dialogflowintent.DialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dialogflowIntent.DialogflowIntentTimeouts,
	WebhookState: *string,
}
```
