...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/containeranalysisnoteiambinding"
...
&containeranalysisnoteiambinding.ContainerAnalysisNoteIamBindingConfig {
	...
	Note: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.containerAnalysisNoteIamBinding.ContainerAnalysisNoteIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
