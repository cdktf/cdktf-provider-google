...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/containeranalysisnoteiambinding"
...
&containeranalysisnoteiambinding.ContainerAnalysisNoteIamBindingConfig {
	...
	Note: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.containerAnalysisNoteIamBinding.ContainerAnalysisNoteIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
