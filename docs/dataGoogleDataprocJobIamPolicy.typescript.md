...
Refer to the Terraform Registory for docs: [`data_google_dataproc_job_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.68.0/docs/data-sources/dataproc_job_iam_policy).
