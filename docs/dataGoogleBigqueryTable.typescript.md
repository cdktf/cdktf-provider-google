...
| <code><a href="#@cdktf/provider-google.dataGoogleBigqueryTable.DataGoogleBigqueryTable.property.ignoreAutoGeneratedSchema">ignoreAutoGeneratedSchema</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly generatedSchemaColumns: string;
```
...
```typescript
public readonly ignoreAutoGeneratedSchema: IResolvable;
```
