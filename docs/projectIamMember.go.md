...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/projectiammember"
...
&projectiammember.ProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.projectIamMember.ProjectIamMemberCondition,
	Id: *string,
}
```
