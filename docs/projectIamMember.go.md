...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/projectiammember"
...
| <code><a href="#@cdktf/provider-google.projectIamMember.ProjectIamMember.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&projectiammember.ProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.projectIamMember.ProjectIamMemberCondition,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.projectIamMember.ProjectIamMemberConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
