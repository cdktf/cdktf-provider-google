...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/projectiammember"
...
&projectiammember.ProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v7.projectIamMember.ProjectIamMemberCondition,
	Id: *string,
}
```
