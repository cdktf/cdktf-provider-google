...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/projectiammember"
...
&projectiammember.ProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v8.projectIamMember.ProjectIamMemberCondition,
	Id: *string,
}
```
