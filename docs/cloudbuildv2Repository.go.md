...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/cloudbuildv2repository"
...
&cloudbuildv2repository.Cloudbuildv2RepositoryConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.cloudbuildv2Repository.Cloudbuildv2RepositoryTimeouts,
}
```
