...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/logginglinkeddataset"
...
&logginglinkeddataset.LoggingLinkedDatasetConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.loggingLinkedDataset.LoggingLinkedDatasetTimeouts,
}
```
