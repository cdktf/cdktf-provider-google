...
```typescript
import { computeInstanceTemplateIamPolicy } from '@cdktf/provider-google'

new computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy(scope: Construct, id: string, config: ComputeInstanceTemplateIamPolicyConfig)
```
...
computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.isConstruct(x: any)
```
...
computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.isTerraformElement(x: any)
```
...
computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.isTerraformResource(x: any)
```
...
computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicy.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const computeInstanceTemplateIamPolicyConfig: computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicyConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicyConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicyConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.computeInstanceTemplateIamPolicy.ComputeInstanceTemplateIamPolicyConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_instance_template_iam_policy#name ComputeInstanceTemplateIamPolicy#name}. |
