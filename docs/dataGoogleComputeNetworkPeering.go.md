...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/datagooglecomputenetworkpeering"
...
&datagooglecomputenetworkpeering.DataGoogleComputeNetworkPeeringConfig {
	...
	Network: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.dataGoogleComputeNetworkPeering.DataGoogleComputeNetworkPeeringTimeouts,
}
```
