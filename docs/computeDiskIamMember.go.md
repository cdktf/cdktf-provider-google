...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computediskiammember"
...
&computediskiammember.ComputeDiskIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.computeDiskIamMember.ComputeDiskIamMemberCondition,
	Id: *string,
	Project: *string,
	Zone: *string,
}
