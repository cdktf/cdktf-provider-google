...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/cloudtasksqueueiambinding"
...
| <code><a href="#@cdktf/provider-google.cloudTasksQueueIamBinding.CloudTasksQueueIamBinding.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&cloudtasksqueueiambinding.CloudTasksQueueIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.cloudTasksQueueIamBinding.CloudTasksQueueIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
...
| <code><a href="#@cdktf/provider-google.cloudTasksQueueIamBinding.CloudTasksQueueIamBindingConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
