...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computenetworkendpoints"
...
&computenetworkendpoints.ComputeNetworkEndpointsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeNetworkEndpoints.ComputeNetworkEndpointsTimeouts,
	Zone: *string,
}
```
