...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/filestoresnapshot"
...
&filestoresnapshot.FilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.filestoreSnapshot.FilestoreSnapshotTimeouts,
}
```
