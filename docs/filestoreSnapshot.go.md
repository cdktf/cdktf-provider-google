...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/filestoresnapshot"
...
&filestoresnapshot.FilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.filestoreSnapshot.FilestoreSnapshotTimeouts,
}
```
