...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/filestoresnapshot"
...
&filestoresnapshot.FilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.filestoreSnapshot.FilestoreSnapshotTimeouts,
}
```
