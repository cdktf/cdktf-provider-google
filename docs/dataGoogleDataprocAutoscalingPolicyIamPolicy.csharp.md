...
Refer to the Terraform Registory for docs: [`data_google_dataproc_autoscaling_policy_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/data-sources/dataproc_autoscaling_policy_iam_policy).
