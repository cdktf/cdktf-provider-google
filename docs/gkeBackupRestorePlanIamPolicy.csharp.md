...
Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy google_gke_backup_restore_plan_iam_policy}.
...
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.Initializer.parameter.scope">Scope</a></code> | <code>Constructs.Construct</code> | The scope in which to define this construct. |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.addMoveTarget"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.hasResourceMove"></a>

```csharp
private object HasResourceMove()
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.importFrom"></a>

```csharp
private void ImportFrom(string Id, TerraformProvider Provider = null)
```

###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.importFrom.parameter.id"></a>

- *Type:* string

---

###### `Provider`<sup>Optional</sup> <a name="Provider" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.importFrom.parameter.provider"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveFromId"></a>
...
###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveFromId.parameter.id"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveTo"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveTo.parameter.moveTarget"></a>
...
###### `Index`<sup>Optional</sup> <a name="Index" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveTo.parameter.index"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveToId"></a>
...
###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a GkeBackupRestorePlanIamPolicy resource upon running "cdktf plan <stack-name>". |
...
##### `GenerateConfigForImport` <a name="GenerateConfigForImport" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.generateConfigForImport"></a>
...
Generates CDKTF code for importing a GkeBackupRestorePlanIamPolicy resource upon running "cdktf plan <stack-name>".

###### `Scope`<sup>Required</sup> <a name="Scope" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.generateConfigForImport.parameter.scope"></a>
...
###### `ImportToId`<sup>Required</sup> <a name="ImportToId" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.generateConfigForImport.parameter.importToId"></a>
...
###### `ImportFromId`<sup>Required</sup> <a name="ImportFromId" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing GkeBackupRestorePlanIamPolicy that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#import import section} in the documentation of this resource for the id to use

---

###### `Provider`<sup>Optional</sup> <a name="Provider" id="@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.generateConfigForImport.parameter.provider"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.node">Node</a></code> | <code>Constructs.Node</code> | The tree node. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicy.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.name">Name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#name GkeBackupRestorePlanIamPolicy#name}. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.policyData">PolicyData</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#policy_data GkeBackupRestorePlanIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#id GkeBackupRestorePlanIamPolicy#id}. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.location">Location</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#location GkeBackupRestorePlanIamPolicy#location}. |
| <code><a href="#@cdktf/provider-google.gkeBackupRestorePlanIamPolicy.GkeBackupRestorePlanIamPolicyConfig.property.project">Project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#project GkeBackupRestorePlanIamPolicy#project}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#name GkeBackupRestorePlanIamPolicy#name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#policy_data GkeBackupRestorePlanIamPolicy#policy_data}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#id GkeBackupRestorePlanIamPolicy#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#location GkeBackupRestorePlanIamPolicy#location}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/gke_backup_restore_plan_iam_policy#project GkeBackupRestorePlanIamPolicy#project}.
