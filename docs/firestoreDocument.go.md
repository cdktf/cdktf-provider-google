...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/firestoredocument"
...
&firestoredocument.FirestoreDocumentConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.firestoreDocument.FirestoreDocumentTimeouts,
}
```
