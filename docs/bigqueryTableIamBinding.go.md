...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v10/bigquerytableiambinding"
...
&bigquerytableiambinding.BigqueryTableIamBindingConfig {
	...
	Role: *string,
	TableId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v10.bigqueryTableIamBinding.BigqueryTableIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.bigqueryTableIamBinding.BigqueryTableIamBindingConfig.property.role">Role</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/bigquery_table_iam_binding#role BigqueryTableIamBinding#role}. |
...
| <code><a href="#@cdktf/provider-google.bigqueryTableIamBinding.BigqueryTableIamBindingConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/bigquery_table_iam_binding#id BigqueryTableIamBinding#id}. |
