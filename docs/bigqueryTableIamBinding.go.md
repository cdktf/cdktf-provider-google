...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigquerytableiambinding"
...
&bigquerytableiambinding.BigqueryTableIamBindingConfig {
	...
	Role: *string,
	TableId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.bigqueryTableIamBinding.BigqueryTableIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
