...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/bigquerytableiambinding"
...
&bigquerytableiambinding.BigqueryTableIamBindingConfig {
	...
	Role: *string,
	TableId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.bigqueryTableIamBinding.BigqueryTableIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
