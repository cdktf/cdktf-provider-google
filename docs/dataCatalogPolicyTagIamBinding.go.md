...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/datacatalogpolicytagiambinding"
...
&datacatalogpolicytagiambinding.DataCatalogPolicyTagIamBindingConfig {
	...
	PolicyTag: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataCatalogPolicyTagIamBinding.DataCatalogPolicyTagIamBindingCondition,
	Id: *string,
}
```
