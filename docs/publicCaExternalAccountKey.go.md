...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/publiccaexternalaccountkey"
...
&publiccaexternalaccountkey.PublicCaExternalAccountKeyConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.publicCaExternalAccountKey.PublicCaExternalAccountKeyTimeouts,
}
```
