...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/iapclient"
...
&iapclient.IapClientConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.iapClient.IapClientTimeouts,
}
```
