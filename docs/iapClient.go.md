...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/iapclient"
...
&iapclient.IapClientConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.iapClient.IapClientTimeouts,
}
```
