...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/iapclient"
...
&iapclient.IapClientConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.iapClient.IapClientTimeouts,
}
```
