...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/datacatalogpolicytag"
...
&datacatalogpolicytag.DataCatalogPolicyTagConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.dataCatalogPolicyTag.DataCatalogPolicyTagTimeouts,
}
```
