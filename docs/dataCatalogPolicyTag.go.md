...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/datacatalogpolicytag"
...
&datacatalogpolicytag.DataCatalogPolicyTagConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dataCatalogPolicyTag.DataCatalogPolicyTagTimeouts,
}
```
