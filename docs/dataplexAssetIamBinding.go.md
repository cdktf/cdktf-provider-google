...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dataplexassetiambinding"
...
&dataplexassetiambinding.DataplexAssetIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataplexAssetIamBinding.DataplexAssetIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
