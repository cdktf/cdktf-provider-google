...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/bigquerytableiammember"
...
&bigquerytableiammember.BigqueryTableIamMemberConfig {
	...
	Role: *string,
	TableId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v9.bigqueryTableIamMember.BigqueryTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
