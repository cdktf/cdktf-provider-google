...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/bigquerytableiammember"
...
&bigquerytableiammember.BigqueryTableIamMemberConfig {
	...
	Role: *string,
	TableId: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.bigqueryTableIamMember.BigqueryTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
