...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/projectusageexportbucket"
...
&projectusageexportbucket.ProjectUsageExportBucketConfig {
	...
	Prefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.projectUsageExportBucket.ProjectUsageExportBucketTimeouts,
}
```
