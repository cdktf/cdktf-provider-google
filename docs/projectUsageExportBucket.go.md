...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/projectusageexportbucket"
...
&projectusageexportbucket.ProjectUsageExportBucketConfig {
	...
	Prefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.projectUsageExportBucket.ProjectUsageExportBucketTimeouts,
}
```
