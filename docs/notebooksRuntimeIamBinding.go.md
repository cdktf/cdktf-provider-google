...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/notebooksruntimeiambinding"
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamBinding.NotebooksRuntimeIamBinding.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&notebooksruntimeiambinding.NotebooksRuntimeIamBindingConfig {
	...
	Role: *string,
	RuntimeName: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.notebooksRuntimeIamBinding.NotebooksRuntimeIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
...
| <code><a href="#@cdktf/provider-google.notebooksRuntimeIamBinding.NotebooksRuntimeIamBindingConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
