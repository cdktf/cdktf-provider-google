...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
