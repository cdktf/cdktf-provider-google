...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
