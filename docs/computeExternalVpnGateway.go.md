...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
