...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
