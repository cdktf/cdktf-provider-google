...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v12.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
