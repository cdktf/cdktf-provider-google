...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
