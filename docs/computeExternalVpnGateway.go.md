...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/computeexternalvpngateway"
...
&computeexternalvpngateway.ComputeExternalVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts,
}
```
