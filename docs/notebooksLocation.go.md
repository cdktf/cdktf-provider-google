...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/notebookslocation"
...
&notebookslocation.NotebooksLocationConfig {
	...
	Name: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.notebooksLocation.NotebooksLocationTimeouts,
}
```
