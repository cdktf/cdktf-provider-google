...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeinstancegroupnamedport"
...
&computeinstancegroupnamedport.ComputeInstanceGroupNamedPortAConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeInstanceGroupNamedPort.ComputeInstanceGroupNamedPortTimeouts,
	Zone: *string,
}
```
