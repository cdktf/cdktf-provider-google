...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/edgenetworksubnet"
...
&edgenetworksubnet.EdgenetworkSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.edgenetworkSubnet.EdgenetworkSubnetTimeouts,
	VlanId: *f64,
}
```
