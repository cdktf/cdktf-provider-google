...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/edgenetworksubnet"
...
&edgenetworksubnet.EdgenetworkSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.edgenetworkSubnet.EdgenetworkSubnetTimeouts,
	VlanId: *f64,
}
```
