...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v15/networkserviceslbtrafficextension"
...
&networkserviceslbtrafficextension.NetworkServicesLbTrafficExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v15.networkServicesLbTrafficExtension.NetworkServicesLbTrafficExtensionTimeouts,
}
```
...
&networkserviceslbtrafficextension.NetworkServicesLbTrafficExtensionExtensionChains {
	...
	MatchCondition: github.com/cdktf/cdktf-provider-google-go/google/v15.networkServicesLbTrafficExtension.NetworkServicesLbTrafficExtensionExtensionChainsMatchCondition,
	Name: *string,
}
```
