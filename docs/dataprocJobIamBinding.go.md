...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/dataprocjobiambinding"
...
&dataprocjobiambinding.DataprocJobIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.dataprocJobIamBinding.DataprocJobIamBindingCondition,
	Id: *string,
	Project: *string,
	Region: *string,
}
