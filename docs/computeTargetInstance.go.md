...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/computetargetinstance"
...
| <code><a href="#@cdktf/provider-google.computeTargetInstance.ComputeTargetInstance.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&computetargetinstance.ComputeTargetInstanceConfig {
	...
	NatPolicy: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v14.computeTargetInstance.ComputeTargetInstanceTimeouts,
	Zone: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.computeTargetInstance.ComputeTargetInstanceConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
