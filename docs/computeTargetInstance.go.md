...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/computetargetinstance"
...
&computetargetinstance.ComputeTargetInstanceConfig {
	...
	NatPolicy: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.computeTargetInstance.ComputeTargetInstanceTimeouts,
	Zone: *string,
}
```
