...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computetargetinstance"
...
&computetargetinstance.ComputeTargetInstanceConfig {
	...
	NatPolicy: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeTargetInstance.ComputeTargetInstanceTimeouts,
	Zone: *string,
}
```
