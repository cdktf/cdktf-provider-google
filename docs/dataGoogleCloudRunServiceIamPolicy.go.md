...
Refer to the Terraform Registory for docs: [`data_google_cloud_run_service_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/data-sources/cloud_run_service_iam_policy).
