...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/cloudiotdevice"
...
| <code><a href="#@cdktf/provider-google.cloudiotDevice.CloudiotDevice.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&cloudiotdevice.CloudiotDeviceConfig {
	...
	GatewayConfig: github.com/cdktf/cdktf-provider-google-go/google/v8.cloudiotDevice.CloudiotDeviceGatewayConfig,
	Id: *string,
	LogLevel: *string,
	Metadata: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.cloudiotDevice.CloudiotDeviceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.cloudiotDevice.CloudiotDeviceConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&cloudiotdevice.CloudiotDeviceCredentials {
	PublicKey: github.com/cdktf/cdktf-provider-google-go/google/v8.cloudiotDevice.CloudiotDeviceCredentialsPublicKey,
