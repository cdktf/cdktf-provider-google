...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computeglobalnetworkendpoint"
...
&computeglobalnetworkendpoint.ComputeGlobalNetworkEndpointConfig {
	...
	IpAddress: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeGlobalNetworkEndpoint.ComputeGlobalNetworkEndpointTimeouts,
}
```
