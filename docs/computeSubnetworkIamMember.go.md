...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/computesubnetworkiammember"
...
| <code><a href="#@cdktf/provider-google.computeSubnetworkIamMember.ComputeSubnetworkIamMember.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&computesubnetworkiammember.ComputeSubnetworkIamMemberConfig {
	...
	Role: *string,
	Subnetwork: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v16.computeSubnetworkIamMember.ComputeSubnetworkIamMemberCondition,
	Id: *string,
	Project: *string,
	Region: *string,
}
...
| <code><a href="#@cdktf/provider-google.computeSubnetworkIamMember.ComputeSubnetworkIamMemberConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
