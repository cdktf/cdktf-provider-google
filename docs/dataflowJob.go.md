...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/dataflowjob"
...
&dataflowjob.DataflowJobConfig {
	...
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.dataflowJob.DataflowJobTimeouts,
