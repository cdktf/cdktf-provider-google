...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networksecuritymirroringdeployment"
...
&networksecuritymirroringdeployment.NetworkSecurityMirroringDeploymentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkSecurityMirroringDeployment.NetworkSecurityMirroringDeploymentTimeouts,
}
```
