...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/apigeeenvgroupattachment"
...
&apigeeenvgroupattachment.ApigeeEnvgroupAttachmentConfig {
	...
	Environment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.apigeeEnvgroupAttachment.ApigeeEnvgroupAttachmentTimeouts,
}
```
