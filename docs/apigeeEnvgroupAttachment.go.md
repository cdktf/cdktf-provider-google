...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/apigeeenvgroupattachment"
...
&apigeeenvgroupattachment.ApigeeEnvgroupAttachmentConfig {
	...
	Environment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.apigeeEnvgroupAttachment.ApigeeEnvgroupAttachmentTimeouts,
}
```
