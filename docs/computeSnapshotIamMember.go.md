...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computesnapshotiammember"
...
&computesnapshotiammember.ComputeSnapshotIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v5.computeSnapshotIamMember.ComputeSnapshotIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
