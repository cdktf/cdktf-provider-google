...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/firebaseappcheckrecaptchav3config"
...
&firebaseappcheckrecaptchav3config.FirebaseAppCheckRecaptchaV3ConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.firebaseAppCheckRecaptchaV3Config.FirebaseAppCheckRecaptchaV3ConfigTimeouts,
	TokenTtl: *string,
}
```
