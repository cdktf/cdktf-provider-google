...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computediskresourcepolicyattachment"
...
&computediskresourcepolicyattachment.ComputeDiskResourcePolicyAttachmentConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeDiskResourcePolicyAttachment.ComputeDiskResourcePolicyAttachmentTimeouts,
	Zone: *string,
}
```
