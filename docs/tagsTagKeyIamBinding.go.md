...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/tagstagkeyiambinding"
...
&tagstagkeyiambinding.TagsTagKeyIamBindingConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.tagsTagKeyIamBinding.TagsTagKeyIamBindingCondition,
	Id: *string,
}
```
