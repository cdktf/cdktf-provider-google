...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/orgpolicypolicy"
...
&orgpolicypolicy.OrgPolicyPolicyConfig {
	...
	Parent: *string,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-google-go/google/v6.orgPolicyPolicy.OrgPolicyPolicySpec,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.orgPolicyPolicy.OrgPolicyPolicyTimeouts,
}
```
...
&orgpolicypolicy.OrgPolicyPolicySpecRules {
	AllowAll: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.orgPolicyPolicy.OrgPolicyPolicySpecRulesCondition,
	DenyAll: *string,
	Enforce: *string,
	Values: github.com/cdktf/cdktf-provider-google-go/google/v6.orgPolicyPolicy.OrgPolicyPolicySpecRulesValues,
}
```
