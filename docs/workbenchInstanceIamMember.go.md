...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v12/workbenchinstanceiammember"
...
&workbenchinstanceiammember.WorkbenchInstanceIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v12.workbenchInstanceIamMember.WorkbenchInstanceIamMemberCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
