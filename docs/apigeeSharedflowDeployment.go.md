...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/apigeesharedflowdeployment"
...
&apigeesharedflowdeployment.ApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.apigeeSharedflowDeployment.ApigeeSharedflowDeploymentTimeouts,
}
```
