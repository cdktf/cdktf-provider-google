...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/apigeesharedflowdeployment"
...
&apigeesharedflowdeployment.ApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.apigeeSharedflowDeployment.ApigeeSharedflowDeploymentTimeouts,
}
```
