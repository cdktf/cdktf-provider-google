...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/apigeesharedflowdeployment"
...
&apigeesharedflowdeployment.ApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.apigeeSharedflowDeployment.ApigeeSharedflowDeploymentTimeouts,
}
```
