...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/apigeesharedflowdeployment"
...
&apigeesharedflowdeployment.ApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.apigeeSharedflowDeployment.ApigeeSharedflowDeploymentTimeouts,
}
```
