...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/integrationconnectorsmanagedzone"
...
&integrationconnectorsmanagedzone.IntegrationConnectorsManagedZoneConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.integrationConnectorsManagedZone.IntegrationConnectorsManagedZoneTimeouts,
}
```
