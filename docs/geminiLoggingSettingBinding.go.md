...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/geminiloggingsettingbinding"
...
&geminiloggingsettingbinding.GeminiLoggingSettingBindingConfig {
	...
	Product: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.geminiLoggingSettingBinding.GeminiLoggingSettingBindingTimeouts,
}
```
