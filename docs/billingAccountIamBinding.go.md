...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/billingaccountiambinding"
...
&billingaccountiambinding.BillingAccountIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.billingAccountIamBinding.BillingAccountIamBindingCondition,
	Id: *string,
}
```
