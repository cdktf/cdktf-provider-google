...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v14/billingaccountiambinding"
...
| <code><a href="#@cdktf/provider-google.billingAccountIamBinding.BillingAccountIamBinding.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&billingaccountiambinding.BillingAccountIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v14.billingAccountIamBinding.BillingAccountIamBindingCondition,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.billingAccountIamBinding.BillingAccountIamBindingConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
