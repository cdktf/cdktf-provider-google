...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computetargettcpproxy"
...
&computetargettcpproxy.ComputeTargetTcpProxyConfig {
	...
	ProxyBind: interface{},
	ProxyHeader: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeTargetTcpProxy.ComputeTargetTcpProxyTimeouts,
}
```
