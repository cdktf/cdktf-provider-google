...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/spannerdatabaseiammember"
...
&spannerdatabaseiammember.SpannerDatabaseIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google/v6.spannerDatabaseIamMember.SpannerDatabaseIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
