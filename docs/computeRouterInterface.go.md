...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/computerouterinterface"
...
&computerouterinterface.ComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.computeRouterInterface.ComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
