...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/computerouterinterface"
...
&computerouterinterface.ComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.computeRouterInterface.ComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
