...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v11/computerouterinterface"
...
&computerouterinterface.ComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v11.computeRouterInterface.ComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
