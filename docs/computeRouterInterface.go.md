...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v16/computerouterinterface"
...
| <code><a href="#@cdktf/provider-google.computeRouterInterface.ComputeRouterInterface.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&computerouterinterface.ComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v16.computeRouterInterface.ComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
...
| <code><a href="#@cdktf/provider-google.computeRouterInterface.ComputeRouterInterfaceConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
