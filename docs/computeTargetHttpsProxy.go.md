...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/computetargethttpsproxy"
...
&computetargethttpsproxy.ComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.computeTargetHttpsProxy.ComputeTargetHttpsProxyTimeouts,
}
```
