...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v5/computetargethttpsproxy"
...
&computetargethttpsproxy.ComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v5.computeTargetHttpsProxy.ComputeTargetHttpsProxyTimeouts,
}
```
