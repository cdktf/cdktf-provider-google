...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/computetargethttpsproxy"
...
&computetargethttpsproxy.ComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.computeTargetHttpsProxy.ComputeTargetHttpsProxyTimeouts,
}
```
