...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v8/cloudiotregistry"
...
&cloudiotregistry.CloudiotRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v8.cloudiotRegistry.CloudiotRegistryTimeouts,
}
```
