...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v7/cloudiotregistry"
...
| <code><a href="#@cdktf/provider-google.cloudiotRegistry.CloudiotRegistry.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&cloudiotregistry.CloudiotRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v7.cloudiotRegistry.CloudiotRegistryTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.cloudiotRegistry.CloudiotRegistryConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
