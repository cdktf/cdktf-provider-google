...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v6/cloudiotregistry"
...
&cloudiotregistry.CloudiotRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v6.cloudiotRegistry.CloudiotRegistryTimeouts,
}
```
