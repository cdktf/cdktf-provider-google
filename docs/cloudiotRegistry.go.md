...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/v9/cloudiotregistry"
...
&cloudiotregistry.CloudiotRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google/v9.cloudiotRegistry.CloudiotRegistryTimeouts,
}
```
