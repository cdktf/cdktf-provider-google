...
Refer to the Terraform Registory for docs: [`google_bigquery_analytics_hub_listing_iam_policy`](https://registry.terraform.io/providers/hashicorp/google/4.70.0/docs/resources/bigquery_analytics_hub_listing_iam_policy).
