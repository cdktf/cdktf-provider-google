...
// https://registry.terraform.io/providers/hashicorp/google/6.14.1/docs/data-sources/iap_web_region_backend_service_iam_policy
...
export class DataGoogleIapWebRegionBackendServiceIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleIapWebRegionBackendServiceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.14.1/docs/data-sources/iap_web_region_backend_service_iam_policy#import import section} in the documentation of this resource for the id to use
