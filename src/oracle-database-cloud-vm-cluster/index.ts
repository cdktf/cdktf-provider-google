...
// https://registry.terraform.io/providers/hashicorp/google/6.24.0/docs/resources/oracle_database_cloud_vm_cluster
...
export class OracleDatabaseCloudVmCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OracleDatabaseCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.24.0/docs/resources/oracle_database_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
