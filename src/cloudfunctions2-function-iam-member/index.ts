// https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/cloudfunctions2_function_iam_member
...
export class Cloudfunctions2FunctionIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cloudfunctions2FunctionIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/cloudfunctions2_function_iam_member#import import section} in the documentation of this resource for the id to use
