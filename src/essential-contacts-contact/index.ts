...
// https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/resources/essential_contacts_contact
...
export class EssentialContactsContact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EssentialContactsContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/resources/essential_contacts_contact#import import section} in the documentation of this resource for the id to use
