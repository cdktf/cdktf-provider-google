...
export function pubsubLiteReservationTimeoutsToTerraform(struct?: PubsubLiteReservationTimeoutsOutputReference | PubsubLiteReservationTimeouts | cdktf.IResolvable): any {
...
export class PubsubLiteReservation extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PubsubLiteReservationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
