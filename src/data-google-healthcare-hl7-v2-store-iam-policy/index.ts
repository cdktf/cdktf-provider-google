...
// https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/data-sources/healthcare_hl7_v2_store_iam_policy
...
export class DataGoogleHealthcareHl7V2StoreIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleHealthcareHl7V2StoreIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/data-sources/healthcare_hl7_v2_store_iam_policy#import import section} in the documentation of this resource for the id to use
