// https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/data_loss_prevention_job_trigger
...
export class DataLossPreventionJobTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataLossPreventionJobTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/data_loss_prevention_job_trigger#import import section} in the documentation of this resource for the id to use
