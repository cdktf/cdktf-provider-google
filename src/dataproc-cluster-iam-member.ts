// https://www.terraform.io/docs/providers/google/r/dataproc_cluster_iam_member
...
export class DataprocClusterIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new DataprocClusterIamMemberConditionOutputReference(this, "condition", true);
