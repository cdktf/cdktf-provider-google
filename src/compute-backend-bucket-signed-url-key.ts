...
export function computeBackendBucketSignedUrlKeyTimeoutsToTerraform(struct?: ComputeBackendBucketSignedUrlKeyTimeoutsOutputReference | ComputeBackendBucketSignedUrlKeyTimeouts): any {
...
export class ComputeBackendBucketSignedUrlKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ComputeBackendBucketSignedUrlKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
