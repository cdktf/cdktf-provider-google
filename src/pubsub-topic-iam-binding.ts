...
function pubsubTopicIamBindingConditionToTerraform(struct?: PubsubTopicIamBindingConditionOutputReference | PubsubTopicIamBindingCondition): any {
...
export class PubsubTopicIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: PubsubTopicIamBindingCondition | undefined; 
  private __conditionOutput = new PubsubTopicIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: PubsubTopicIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: pubsubTopicIamBindingConditionToTerraform(this._condition),
    };
  }
}
