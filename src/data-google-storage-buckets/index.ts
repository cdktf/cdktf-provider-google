...
// https://registry.terraform.io/providers/hashicorp/google/6.14.0/docs/data-sources/storage_buckets
...
export class DataGoogleStorageBuckets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleStorageBuckets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.14.0/docs/data-sources/storage_buckets#import import section} in the documentation of this resource for the id to use
