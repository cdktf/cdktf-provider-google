// https://registry.terraform.io/providers/hashicorp/google/5.35.0/docs/resources/healthcare_hl7_v2_store_iam_binding
...
export class HealthcareHl7V2StoreIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareHl7V2StoreIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.35.0/docs/resources/healthcare_hl7_v2_store_iam_binding#import import section} in the documentation of this resource for the id to use
