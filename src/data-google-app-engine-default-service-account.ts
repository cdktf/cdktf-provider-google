...
export interface DataGoogleAppEngineDefaultServiceAccountConfig extends TerraformMetaArguments {
  readonly project?: string;
}

// Resource

export class DataGoogleAppEngineDefaultServiceAccount extends TerraformDataSource {
