// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_docker_image
...
export class DataGoogleArtifactRegistryDockerImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleArtifactRegistryDockerImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_docker_image#import import section} in the documentation of this resource for the id to use
