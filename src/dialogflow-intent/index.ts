// https://registry.terraform.io/providers/hashicorp/google/5.22.0/docs/resources/dialogflow_intent
...
export class DialogflowIntent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowIntent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.22.0/docs/resources/dialogflow_intent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.22.0/docs/resources/dialogflow_intent google_dialogflow_intent} Resource
  *
  * @param scope The scope in which to define this construct
