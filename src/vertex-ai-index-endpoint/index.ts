...
// https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/vertex_ai_index_endpoint
...
export class VertexAiIndexEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiIndexEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/vertex_ai_index_endpoint#import import section} in the documentation of this resource for the id to use
