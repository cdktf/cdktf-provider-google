...
// https://registry.terraform.io/providers/hashicorp/google/5.29.1/docs/resources/scc_project_custom_module
...
export class SccProjectCustomModule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccProjectCustomModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.29.1/docs/resources/scc_project_custom_module#import import section} in the documentation of this resource for the id to use
