// https://www.terraform.io/docs/providers/google/r/dataplex_zone_iam_policy
...
export class DataplexZoneIamPolicy extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google/r/dataplex_zone_iam_policy google_dataplex_zone_iam_policy} Resource
  *
