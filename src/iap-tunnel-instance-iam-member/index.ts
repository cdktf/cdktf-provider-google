// https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/iap_tunnel_instance_iam_member
...
export class IapTunnelInstanceIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapTunnelInstanceIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/iap_tunnel_instance_iam_member#import import section} in the documentation of this resource for the id to use
