...
function spannerInstanceIamBindingConditionToTerraform(struct?: SpannerInstanceIamBindingConditionOutputReference | SpannerInstanceIamBindingCondition): any {
...
export class SpannerInstanceIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: SpannerInstanceIamBindingCondition | undefined; 
  private __conditionOutput = new SpannerInstanceIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: SpannerInstanceIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: spannerInstanceIamBindingConditionToTerraform(this._condition),
    };
  }
}
