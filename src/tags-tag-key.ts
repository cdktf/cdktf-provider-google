// https://www.terraform.io/docs/providers/google/r/tags_tag_key
...
export function tagsTagKeyTimeoutsToTerraform(struct?: TagsTagKeyTimeoutsOutputReference | TagsTagKeyTimeouts | cdktf.IResolvable): any {
...
export class TagsTagKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): TagsTagKeyTimeouts | undefined {
  ...
  public set internalValue(value: TagsTagKeyTimeouts | undefined) {
    if (value === undefined) {
...
export class TagsTagKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new TagsTagKeyTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
