...
export function tagsTagKeyTimeoutsToTerraform(struct?: TagsTagKeyTimeoutsOutputReference | TagsTagKeyTimeouts): any {
...
export class TagsTagKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new TagsTagKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
