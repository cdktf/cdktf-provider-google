// https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/clouddeploy_deploy_policy
...
export class ClouddeployDeployPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClouddeployDeployPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/clouddeploy_deploy_policy#import import section} in the documentation of this resource for the id to use
