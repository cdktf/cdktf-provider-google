// https://registry.terraform.io/providers/hashicorp/google/5.22.0/docs/resources/dataplex_task_iam_member
...
export class DataplexTaskIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexTaskIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.22.0/docs/resources/dataplex_task_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.22.0/docs/resources/dataplex_task_iam_member google_dataplex_task_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
