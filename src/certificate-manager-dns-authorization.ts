...
export class CertificateManagerDnsAuthorizationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CertificateManagerDnsAuthorizationTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: CertificateManagerDnsAuthorizationTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
