...
// https://registry.terraform.io/providers/hashicorp/google/6.14.0/docs/data-sources/monitoring_app_engine_service
...
export class DataGoogleMonitoringAppEngineService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleMonitoringAppEngineService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.14.0/docs/data-sources/monitoring_app_engine_service#import import section} in the documentation of this resource for the id to use
