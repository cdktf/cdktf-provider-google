...
function computeRegionDiskIamMemberConditionToTerraform(struct?: ComputeRegionDiskIamMemberConditionOutputReference | ComputeRegionDiskIamMemberCondition): any {
...
export class ComputeRegionDiskIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: ComputeRegionDiskIamMemberCondition | undefined; 
  private __conditionOutput = new ComputeRegionDiskIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: ComputeRegionDiskIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: computeRegionDiskIamMemberConditionToTerraform(this._condition),
    };
  }
}
