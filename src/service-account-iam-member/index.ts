...
// https://registry.terraform.io/providers/hashicorp/google/5.29.0/docs/resources/service_account_iam_member
...
export class ServiceAccountIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.29.0/docs/resources/service_account_iam_member#import import section} in the documentation of this resource for the id to use
