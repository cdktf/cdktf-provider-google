// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy
...
export class KmsEkmConnectionIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsEkmConnectionIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/kms_ekm_connection_iam_policy google_kms_ekm_connection_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
