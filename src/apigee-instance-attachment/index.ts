...
// https://registry.terraform.io/providers/hashicorp/google/5.26.0/docs/resources/apigee_instance_attachment
...
export class ApigeeInstanceAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeInstanceAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.26.0/docs/resources/apigee_instance_attachment#import import section} in the documentation of this resource for the id to use
