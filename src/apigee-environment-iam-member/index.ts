// https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/apigee_environment_iam_member
...
export class ApigeeEnvironmentIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeEnvironmentIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/apigee_environment_iam_member#import import section} in the documentation of this resource for the id to use
