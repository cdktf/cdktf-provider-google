...
// https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/dataplex_entry_group
...
export class DataplexEntryGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexEntryGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/dataplex_entry_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/dataplex_entry_group google_dataplex_entry_group} Resource
  *
  * @param scope The scope in which to define this construct
