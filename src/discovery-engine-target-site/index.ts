// https://registry.terraform.io/providers/hashicorp/google/6.23.0/docs/resources/discovery_engine_target_site
...
export class DiscoveryEngineTargetSite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryEngineTargetSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.23.0/docs/resources/discovery_engine_target_site#import import section} in the documentation of this resource for the id to use
