// https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/data-sources/compute_instance_serial_port
...
export class DataGoogleComputeInstanceSerialPort extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeInstanceSerialPort that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/data-sources/compute_instance_serial_port#import import section} in the documentation of this resource for the id to use
