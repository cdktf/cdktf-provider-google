// https://registry.terraform.io/providers/hashicorp/google/5.3.0/docs/resources/firestore_field
...
export class FirestoreField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirestoreField that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.3.0/docs/resources/firestore_field#import import section} in the documentation of this resource for the id to use
