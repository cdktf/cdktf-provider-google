...
// https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/integrations_auth_config
...
export class IntegrationsAuthConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationsAuthConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/integrations_auth_config#import import section} in the documentation of this resource for the id to use
