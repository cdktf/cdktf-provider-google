...
// https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/logging_billing_account_bucket_config
...
export class LoggingBillingAccountBucketConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingBillingAccountBucketConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/logging_billing_account_bucket_config#import import section} in the documentation of this resource for the id to use
