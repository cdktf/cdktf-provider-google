...
export class SccSourceIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccSourceIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/scc_source_iam_binding#import import section} in the documentation of this resource for the id to use
