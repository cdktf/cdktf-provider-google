...
function binaryAuthorizationAttestorIamBindingConditionToTerraform(struct?: BinaryAuthorizationAttestorIamBindingConditionOutputReference | BinaryAuthorizationAttestorIamBindingCondition): any {
...
export class BinaryAuthorizationAttestorIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: BinaryAuthorizationAttestorIamBindingCondition | undefined; 
  private __conditionOutput = new BinaryAuthorizationAttestorIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: BinaryAuthorizationAttestorIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: binaryAuthorizationAttestorIamBindingConditionToTerraform(this._condition),
    };
  }
}
