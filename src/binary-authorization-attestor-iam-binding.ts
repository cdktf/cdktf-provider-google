// https://www.terraform.io/docs/providers/google/r/binary_authorization_attestor_iam_binding
...
export function binaryAuthorizationAttestorIamBindingConditionToTerraform(struct?: BinaryAuthorizationAttestorIamBindingConditionOutputReference | BinaryAuthorizationAttestorIamBindingCondition): any {
...
export class BinaryAuthorizationAttestorIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BinaryAuthorizationAttestorIamBindingCondition | undefined {
  ...
  public set internalValue(value: BinaryAuthorizationAttestorIamBindingCondition | undefined) {
    if (value === undefined) {
...
export class BinaryAuthorizationAttestorIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new BinaryAuthorizationAttestorIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this._condition;
  }
  public putCondition(value: BinaryAuthorizationAttestorIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: binaryAuthorizationAttestorIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
}
