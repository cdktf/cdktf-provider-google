// https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/app_engine_standard_app_version
...
export class AppEngineStandardAppVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppEngineStandardAppVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/app_engine_standard_app_version#import import section} in the documentation of this resource for the id to use
