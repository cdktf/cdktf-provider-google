...
// https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/data_fusion_instance
...
export class DataFusionInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFusionInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/data_fusion_instance#import import section} in the documentation of this resource for the id to use
