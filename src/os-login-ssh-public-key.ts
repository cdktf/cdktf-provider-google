...
export function osLoginSshPublicKeyTimeoutsToTerraform(struct?: OsLoginSshPublicKeyTimeoutsOutputReference | OsLoginSshPublicKeyTimeouts | cdktf.IResolvable): any {
...
export class OsLoginSshPublicKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OsLoginSshPublicKeyTimeouts | undefined {
  ...
  public set internalValue(value: OsLoginSshPublicKeyTimeouts | undefined) {
    if (value === undefined) {
...
export class OsLoginSshPublicKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new OsLoginSshPublicKeyTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
