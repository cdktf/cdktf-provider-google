...
export function osLoginSshPublicKeyTimeoutsToTerraform(struct?: OsLoginSshPublicKeyTimeoutsOutputReference | OsLoginSshPublicKeyTimeouts): any {
...
export class OsLoginSshPublicKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new OsLoginSshPublicKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
