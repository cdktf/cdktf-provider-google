...
// https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/dataplex_asset_iam_member
...
export class DataplexAssetIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexAssetIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/dataplex_asset_iam_member#import import section} in the documentation of this resource for the id to use
