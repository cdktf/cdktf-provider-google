// https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/firebase_app_check_recaptcha_enterprise_config
...
export class FirebaseAppCheckRecaptchaEnterpriseConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirebaseAppCheckRecaptchaEnterpriseConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/firebase_app_check_recaptcha_enterprise_config#import import section} in the documentation of this resource for the id to use
