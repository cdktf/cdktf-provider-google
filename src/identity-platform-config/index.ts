// https://registry.terraform.io/providers/hashicorp/google/6.7.0/docs/resources/identity_platform_config
...
export class IdentityPlatformConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityPlatformConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.7.0/docs/resources/identity_platform_config#import import section} in the documentation of this resource for the id to use
