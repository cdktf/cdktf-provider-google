...
function pubsubSubscriptionIamMemberConditionToTerraform(struct?: PubsubSubscriptionIamMemberConditionOutputReference | PubsubSubscriptionIamMemberCondition): any {
...
export class PubsubSubscriptionIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: PubsubSubscriptionIamMemberCondition | undefined; 
  private __conditionOutput = new PubsubSubscriptionIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: PubsubSubscriptionIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: pubsubSubscriptionIamMemberConditionToTerraform(this._condition),
    };
  }
}
