// https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/vmwareengine_subnet
...
export class VmwareengineSubnet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmwareengineSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/vmwareengine_subnet#import import section} in the documentation of this resource for the id to use
