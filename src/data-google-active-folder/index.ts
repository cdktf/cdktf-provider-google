...
// https://registry.terraform.io/providers/hashicorp/google/5.29.1/docs/data-sources/active_folder
...
export class DataGoogleActiveFolder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleActiveFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.29.1/docs/data-sources/active_folder#import import section} in the documentation of this resource for the id to use
