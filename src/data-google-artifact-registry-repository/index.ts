...
// https://registry.terraform.io/providers/hashicorp/google/6.43.0/docs/data-sources/artifact_registry_repository
...
export interface DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepository {
}
...
export class DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepositoryOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepository | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepository | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepositoryList extends cdktf.ComplexList {
...
export class DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // common_repository - computed: true, optional: false, required: false
  private _commonRepository = new DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepositoryList(this, "common_repository", false);
...
export class DataGoogleArtifactRegistryRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleArtifactRegistryRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.43.0/docs/data-sources/artifact_registry_repository#import import section} in the documentation of this resource for the id to use
