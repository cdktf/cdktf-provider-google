...
function spannerDatabaseIamBindingConditionToTerraform(struct?: SpannerDatabaseIamBindingConditionOutputReference | SpannerDatabaseIamBindingCondition): any {
...
export class SpannerDatabaseIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: SpannerDatabaseIamBindingCondition | undefined; 
  private __conditionOutput = new SpannerDatabaseIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: SpannerDatabaseIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: spannerDatabaseIamBindingConditionToTerraform(this._condition),
    };
  }
}
