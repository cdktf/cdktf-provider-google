...
// https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/iap_client
...
export class IapClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/iap_client#import import section} in the documentation of this resource for the id to use
