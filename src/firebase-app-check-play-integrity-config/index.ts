// https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/firebase_app_check_play_integrity_config
...
export class FirebaseAppCheckPlayIntegrityConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirebaseAppCheckPlayIntegrityConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/firebase_app_check_play_integrity_config#import import section} in the documentation of this resource for the id to use
