...
// https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/data-sources/gke_hub_membership
...
export class DataGoogleGkeHubMembership extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleGkeHubMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/data-sources/gke_hub_membership#import import section} in the documentation of this resource for the id to use
