// https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/access_context_manager_authorized_orgs_desc
...
export class AccessContextManagerAuthorizedOrgsDesc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessContextManagerAuthorizedOrgsDesc that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/access_context_manager_authorized_orgs_desc#import import section} in the documentation of this resource for the id to use
