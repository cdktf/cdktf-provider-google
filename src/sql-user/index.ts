// https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/sql_user
...
export class SqlUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/sql_user#import import section} in the documentation of this resource for the id to use
