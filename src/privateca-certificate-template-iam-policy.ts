// https://www.terraform.io/docs/providers/google/r/privateca_certificate_template_iam_policy
...
*/
export class PrivatecaCertificateTemplateIamPolicy extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: PrivatecaCertificateTemplateIamPolicyConfig) {
    super(scope, id, {
