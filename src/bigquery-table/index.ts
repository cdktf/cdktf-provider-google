...
// https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/bigquery_table
...
export interface BigqueryTableConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly ignoreAutoGeneratedSchema?: boolean | cdktf.IResolvable;
  /**
...
export class BigqueryTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/bigquery_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/bigquery_table google_bigquery_table} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: BigqueryTableConfig) {
    ...
    this._id = config.id;
    this._ignoreAutoGeneratedSchema = config.ignoreAutoGeneratedSchema;
  ...
  // ignore_auto_generated_schema - computed: false, optional: true, required: false
  private _ignoreAutoGeneratedSchema?: boolean | cdktf.IResolvable; 
  public get ignoreAutoGeneratedSchema() {
    return this.getBooleanAttribute('ignore_auto_generated_schema');
  }
  public set ignoreAutoGeneratedSchema(value: boolean | cdktf.IResolvable) {
    this._ignoreAutoGeneratedSchema = value;
  }
  public resetIgnoreAutoGeneratedSchema() {
    this._ignoreAutoGeneratedSchema = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ignoreAutoGeneratedSchemaInput() {
    return this._ignoreAutoGeneratedSchema;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ignore_auto_generated_schema: cdktf.booleanToTerraform(this._ignoreAutoGeneratedSchema),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ignore_auto_generated_schema: {
        value: cdktf.booleanToHclTerraform(this._ignoreAutoGeneratedSchema),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
