...
// https://registry.terraform.io/providers/hashicorp/google/5.42.0/docs/resources/bigquery_table
...
export interface BigqueryTableConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly allowResourceTagsOnDeletion?: boolean | cdktf.IResolvable;
  /**
...
export class BigqueryTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.42.0/docs/resources/bigquery_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.42.0/docs/resources/bigquery_table google_bigquery_table} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: BigqueryTableConfig) {
    ...
    this._allowResourceTagsOnDeletion = config.allowResourceTagsOnDeletion;
  ...
  // allow_resource_tags_on_deletion - computed: false, optional: true, required: false
  private _allowResourceTagsOnDeletion?: boolean | cdktf.IResolvable; 
  public get allowResourceTagsOnDeletion() {
    return this.getBooleanAttribute('allow_resource_tags_on_deletion');
  }
  public set allowResourceTagsOnDeletion(value: boolean | cdktf.IResolvable) {
    this._allowResourceTagsOnDeletion = value;
  }
  public resetAllowResourceTagsOnDeletion() {
    this._allowResourceTagsOnDeletion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get allowResourceTagsOnDeletionInput() {
    return this._allowResourceTagsOnDeletion;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      allow_resource_tags_on_deletion: cdktf.booleanToTerraform(this._allowResourceTagsOnDeletion),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      allow_resource_tags_on_deletion: {
        value: cdktf.booleanToHclTerraform(this._allowResourceTagsOnDeletion),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
