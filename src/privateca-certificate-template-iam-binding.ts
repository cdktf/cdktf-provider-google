// https://www.terraform.io/docs/providers/google/r/privateca_certificate_template_iam_binding
...
export function privatecaCertificateTemplateIamBindingConditionToTerraform(struct?: PrivatecaCertificateTemplateIamBindingConditionOutputReference | PrivatecaCertificateTemplateIamBindingCondition): any {
...
export class PrivatecaCertificateTemplateIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PrivatecaCertificateTemplateIamBindingCondition | undefined {
  ...
  public set internalValue(value: PrivatecaCertificateTemplateIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class PrivatecaCertificateTemplateIamBinding extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_privateca_certificate_template_iam_binding";
  ...
  */
  public constructor(scope: Construct, id: string, config: PrivatecaCertificateTemplateIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new PrivatecaCertificateTemplateIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: PrivatecaCertificateTemplateIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: privatecaCertificateTemplateIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
}
