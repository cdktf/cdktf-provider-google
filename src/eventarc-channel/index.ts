...
// https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/eventarc_channel
...
export class EventarcChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventarcChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/eventarc_channel#import import section} in the documentation of this resource for the id to use
