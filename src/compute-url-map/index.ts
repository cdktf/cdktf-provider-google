// https://registry.terraform.io/providers/hashicorp/google/5.6.0/docs/resources/compute_url_map
...
export class ComputeUrlMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeUrlMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.6.0/docs/resources/compute_url_map#import import section} in the documentation of this resource for the id to use
