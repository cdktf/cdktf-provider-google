...
// https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/data-sources/beyondcorp_security_gateway
...
export class DataGoogleBeyondcorpSecurityGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBeyondcorpSecurityGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/data-sources/beyondcorp_security_gateway#import import section} in the documentation of this resource for the id to use
