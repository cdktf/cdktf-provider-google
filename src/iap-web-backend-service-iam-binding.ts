...
export function iapWebBackendServiceIamBindingConditionToTerraform(struct?: IapWebBackendServiceIamBindingConditionOutputReference | IapWebBackendServiceIamBindingCondition): any {
...
export class IapWebBackendServiceIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IapWebBackendServiceIamBindingCondition | undefined {
  ...
  public set internalValue(value: IapWebBackendServiceIamBindingCondition | undefined) {
    if (value === undefined) {
...
export class IapWebBackendServiceIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new IapWebBackendServiceIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this._condition;
  }
  public putCondition(value: IapWebBackendServiceIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapWebBackendServiceIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
}
