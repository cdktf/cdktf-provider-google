...
function iapWebBackendServiceIamBindingConditionToTerraform(struct?: IapWebBackendServiceIamBindingConditionOutputReference | IapWebBackendServiceIamBindingCondition): any {
...
export class IapWebBackendServiceIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: IapWebBackendServiceIamBindingCondition | undefined; 
  private __conditionOutput = new IapWebBackendServiceIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapWebBackendServiceIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapWebBackendServiceIamBindingConditionToTerraform(this._condition),
    };
  }
}
