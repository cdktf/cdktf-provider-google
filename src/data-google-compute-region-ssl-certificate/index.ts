...
// https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/data-sources/compute_region_ssl_certificate
...
export class DataGoogleComputeRegionSslCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeRegionSslCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/data-sources/compute_region_ssl_certificate#import import section} in the documentation of this resource for the id to use
