...
// https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/project_service
...
export class ProjectService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/project_service#import import section} in the documentation of this resource for the id to use
