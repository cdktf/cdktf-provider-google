// https://registry.terraform.io/providers/hashicorp/google/5.25.0/docs/resources/bigquery_dataset_access
...
export class BigqueryDatasetAccessA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryDatasetAccessA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.25.0/docs/resources/bigquery_dataset_access#import import section} in the documentation of this resource for the id to use
