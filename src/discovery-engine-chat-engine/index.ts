// https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/discovery_engine_chat_engine
...
export interface DiscoveryEngineChatEngineChatEngineConfig {
  ...
  */
  readonly dialogflowAgentToLink?: string;
  /**
...
export class DiscoveryEngineChatEngineChatEngineConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DiscoveryEngineChatEngineChatEngineConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._allowCrossRegion !== undefined) {
      hasAnyValues = true;
      internalValueResult.allowCrossRegion = this._allowCrossRegion;
    }
    if (this._dialogflowAgentToLink !== undefined) {
      hasAnyValues = true;
      internalValueResult.dialogflowAgentToLink = this._dialogflowAgentToLink;
    }
  ...
  public set internalValue(value: DiscoveryEngineChatEngineChatEngineConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._allowCrossRegion = undefined;
      this._dialogflowAgentToLink = undefined;
      this._agentCreationConfig.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._allowCrossRegion = value.allowCrossRegion;
      this._dialogflowAgentToLink = value.dialogflowAgentToLink;
  ...
  // Temporarily expose input value. Use with caution.
  public get allowCrossRegionInput() {
    return this._allowCrossRegion;
  }

  // dialogflow_agent_to_link - computed: false, optional: true, required: false
  private _dialogflowAgentToLink?: string; 
  public get dialogflowAgentToLink() {
    return this.getStringAttribute('dialogflow_agent_to_link');
  }
  public set dialogflowAgentToLink(value: string) {
    this._dialogflowAgentToLink = value;
  }
  public resetDialogflowAgentToLink() {
    this._dialogflowAgentToLink = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get dialogflowAgentToLinkInput() {
    return this._dialogflowAgentToLink;
  }

  // agent_creation_config - computed: false, optional: true, required: false
  ...
  public resetAgentCreationConfig() {
    this._agentCreationConfig.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
...
export class DiscoveryEngineChatEngine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryEngineChatEngine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/discovery_engine_chat_engine#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/discovery_engine_chat_engine google_discovery_engine_chat_engine} Resource
  *
  * @param scope The scope in which to define this construct
