...
// https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/discovery_engine_chat_engine
...
export class DiscoveryEngineChatEngine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryEngineChatEngine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/discovery_engine_chat_engine#import import section} in the documentation of this resource for the id to use
