// https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/dns_response_policy
...
export class DnsResponsePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsResponsePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/dns_response_policy#import import section} in the documentation of this resource for the id to use
