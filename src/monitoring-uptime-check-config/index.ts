...
// https://registry.terraform.io/providers/hashicorp/google/5.33.0/docs/resources/monitoring_uptime_check_config
...
export class MonitoringUptimeCheckConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitoringUptimeCheckConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.33.0/docs/resources/monitoring_uptime_check_config#import import section} in the documentation of this resource for the id to use
