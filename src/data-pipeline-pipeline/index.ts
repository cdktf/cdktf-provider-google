...
// https://registry.terraform.io/providers/hashicorp/google/6.43.0/docs/resources/data_pipeline_pipeline
...
export class DataPipelinePipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataPipelinePipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.43.0/docs/resources/data_pipeline_pipeline#import import section} in the documentation of this resource for the id to use
