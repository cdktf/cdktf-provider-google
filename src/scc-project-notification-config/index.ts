...
// https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/scc_project_notification_config
...
export class SccProjectNotificationConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccProjectNotificationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/scc_project_notification_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/scc_project_notification_config google_scc_project_notification_config} Resource
  *
  * @param scope The scope in which to define this construct
