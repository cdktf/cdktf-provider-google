...
export function computeSharedVpcServiceProjectTimeoutsToTerraform(struct?: ComputeSharedVpcServiceProjectTimeoutsOutputReference | ComputeSharedVpcServiceProjectTimeouts | cdktf.IResolvable): any {
...
export class ComputeSharedVpcServiceProject extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ComputeSharedVpcServiceProjectTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
