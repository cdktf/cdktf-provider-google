...
// https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/healthcare_hl7_v2_store
...
export class HealthcareHl7V2Store extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareHl7V2Store that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/healthcare_hl7_v2_store#import import section} in the documentation of this resource for the id to use
