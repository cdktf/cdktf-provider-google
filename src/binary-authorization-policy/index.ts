...
// https://registry.terraform.io/providers/hashicorp/google/5.9.0/docs/resources/binary_authorization_policy
...
export class BinaryAuthorizationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BinaryAuthorizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.9.0/docs/resources/binary_authorization_policy#import import section} in the documentation of this resource for the id to use
