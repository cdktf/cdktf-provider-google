// https://www.terraform.io/docs/providers/google/r/gke_backup_backup_plan_iam_binding
...
export class GkeBackupBackupPlanIamBinding extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google/r/gke_backup_backup_plan_iam_binding google_gke_backup_backup_plan_iam_binding} Resource
  *
