...
// https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/container_analysis_note_iam_policy
...
export class ContainerAnalysisNoteIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerAnalysisNoteIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/container_analysis_note_iam_policy#import import section} in the documentation of this resource for the id to use
