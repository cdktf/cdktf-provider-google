...
// https://registry.terraform.io/providers/hashicorp/google/6.49.2/docs/resources/composer_user_workloads_secret
...
export class ComposerUserWorkloadsSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComposerUserWorkloadsSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.2/docs/resources/composer_user_workloads_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.2/docs/resources/composer_user_workloads_secret google_composer_user_workloads_secret} Resource
  *
  * @param scope The scope in which to define this construct
