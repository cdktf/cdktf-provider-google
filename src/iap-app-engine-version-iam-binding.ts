...
function iapAppEngineVersionIamBindingConditionToTerraform(struct?: IapAppEngineVersionIamBindingConditionOutputReference | IapAppEngineVersionIamBindingCondition): any {
...
export class IapAppEngineVersionIamBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "google_iap_app_engine_version_iam_binding";
  ...
  */
  ...
  private _condition?: IapAppEngineVersionIamBindingCondition | undefined; 
  private __conditionOutput = new IapAppEngineVersionIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapAppEngineVersionIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapAppEngineVersionIamBindingConditionToTerraform(this._condition),
    };
  }
}
