// https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/edgenetwork_subnet
...
export class EdgenetworkSubnet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgenetworkSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/edgenetwork_subnet#import import section} in the documentation of this resource for the id to use
