...
// https://registry.terraform.io/providers/hashicorp/google/6.10.0/docs/resources/apigee_developer
...
export class ApigeeDeveloper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeDeveloper that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.10.0/docs/resources/apigee_developer#import import section} in the documentation of this resource for the id to use
