// https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/iam_workload_identity_pool
...
export class IamWorkloadIdentityPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamWorkloadIdentityPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/iam_workload_identity_pool#import import section} in the documentation of this resource for the id to use
