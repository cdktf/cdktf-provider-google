...
// https://registry.terraform.io/providers/hashicorp/google/5.41.0/docs/data-sources/sourcerepo_repository
...
export class DataGoogleSourcerepoRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSourcerepoRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.41.0/docs/data-sources/sourcerepo_repository#import import section} in the documentation of this resource for the id to use
