// https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/vertex_ai_feature_online_store
...
export class VertexAiFeatureOnlineStore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiFeatureOnlineStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/vertex_ai_feature_online_store#import import section} in the documentation of this resource for the id to use
