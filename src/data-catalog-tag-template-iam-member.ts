...
function dataCatalogTagTemplateIamMemberConditionToTerraform(struct?: DataCatalogTagTemplateIamMemberConditionOutputReference | DataCatalogTagTemplateIamMemberCondition): any {
...
export class DataCatalogTagTemplateIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: DataCatalogTagTemplateIamMemberCondition | undefined; 
  private __conditionOutput = new DataCatalogTagTemplateIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: DataCatalogTagTemplateIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: dataCatalogTagTemplateIamMemberConditionToTerraform(this._condition),
    };
  }
}
