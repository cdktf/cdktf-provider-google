...
// https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/bigquery_dataset_iam_policy
...
export class DataGoogleBigqueryDatasetIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBigqueryDatasetIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/bigquery_dataset_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/bigquery_dataset_iam_policy google_bigquery_dataset_iam_policy} Data Source
  *
  * @param scope The scope in which to define this construct
