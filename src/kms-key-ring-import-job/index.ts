// https://registry.terraform.io/providers/hashicorp/google/6.22.0/docs/resources/kms_key_ring_import_job
...
export class KmsKeyRingImportJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsKeyRingImportJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.22.0/docs/resources/kms_key_ring_import_job#import import section} in the documentation of this resource for the id to use
