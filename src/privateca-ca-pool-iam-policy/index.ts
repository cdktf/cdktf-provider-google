...
// https://registry.terraform.io/providers/hashicorp/google/5.9.0/docs/resources/privateca_ca_pool_iam_policy
...
export class PrivatecaCaPoolIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatecaCaPoolIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.9.0/docs/resources/privateca_ca_pool_iam_policy#import import section} in the documentation of this resource for the id to use
