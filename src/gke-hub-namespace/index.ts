...
// https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace
...
export interface GkeHubNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#id GkeHubNamespace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#labels GkeHubNamespace#labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#namespace_labels GkeHubNamespace#namespace_labels}
  */
  readonly namespaceLabels?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#project GkeHubNamespace#project}
  */
  readonly project?: string;
  /**
  * The name of the Scope instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#scope GkeHubNamespace#scope}
  */
  readonly scope: string;
  /**
  * Id of the scope
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#scope_id GkeHubNamespace#scope_id}
  */
  readonly scopeId: string;
  /**
  * The client-provided identifier of the namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#scope_namespace_id GkeHubNamespace#scope_namespace_id}
  */
  readonly scopeNamespaceId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#timeouts GkeHubNamespace#timeouts}
  */
...
export interface GkeHubNamespaceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#create GkeHubNamespace#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#delete GkeHubNamespace#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#update GkeHubNamespace#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace google_gke_hub_namespace}
*/
export class GkeHubNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/gke_hub_namespace google_gke_hub_namespace} Resource
  *
  * @param scope The scope in which to define this construct
