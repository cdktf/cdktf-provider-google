...
// https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/gke_hub_namespace
...
export class GkeHubNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/gke_hub_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/gke_hub_namespace google_gke_hub_namespace} Resource
  *
  * @param scope The scope in which to define this construct
