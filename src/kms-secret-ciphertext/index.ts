// https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/kms_secret_ciphertext
...
export class KmsSecretCiphertext extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsSecretCiphertext that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/kms_secret_ciphertext#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/kms_secret_ciphertext google_kms_secret_ciphertext} Resource
  *
  * @param scope The scope in which to define this construct
