// https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/endpoints_service_consumers_iam_policy
...
export class EndpointsServiceConsumersIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointsServiceConsumersIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/endpoints_service_consumers_iam_policy#import import section} in the documentation of this resource for the id to use
