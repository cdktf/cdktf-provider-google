// https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/apigee_sync_authorization
...
export class ApigeeSyncAuthorization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeSyncAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/apigee_sync_authorization#import import section} in the documentation of this resource for the id to use
