...
export interface IapTunnelIamBindingConfig extends TerraformMetaArguments {
...
export class IapTunnelIamBinding extends TerraformResource {
  ...
  public set condition(value: IapTunnelIamBindingCondition[] | undefined) {
