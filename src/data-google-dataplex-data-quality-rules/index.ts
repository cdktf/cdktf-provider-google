...
// https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/data-sources/dataplex_data_quality_rules
...
export class DataGoogleDataplexDataQualityRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDataplexDataQualityRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/data-sources/dataplex_data_quality_rules#import import section} in the documentation of this resource for the id to use
