...
// https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/os_config_os_policy_assignment
...
export class OsConfigOsPolicyAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsConfigOsPolicyAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/os_config_os_policy_assignment#import import section} in the documentation of this resource for the id to use
