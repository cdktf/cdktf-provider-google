// https://www.terraform.io/docs/providers/google/r/bigtable_table_iam_member
...
export class BigtableTableIamMember extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_bigtable_table_iam_member";
  ...
  */
  ...
  private _condition = new BigtableTableIamMemberConditionOutputReference(this, "condition");
