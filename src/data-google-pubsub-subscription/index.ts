// https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/pubsub_subscription
...
export class DataGooglePubsubSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGooglePubsubSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/pubsub_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/pubsub_subscription google_pubsub_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
