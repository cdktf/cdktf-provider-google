// https://registry.terraform.io/providers/hashicorp/google/5.41.0/docs/resources/firebaserules_ruleset
...
export class FirebaserulesRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirebaserulesRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.41.0/docs/resources/firebaserules_ruleset#import import section} in the documentation of this resource for the id to use
