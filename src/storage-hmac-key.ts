...
export function storageHmacKeyTimeoutsToTerraform(struct?: StorageHmacKeyTimeoutsOutputReference | StorageHmacKeyTimeouts): any {
...
export class StorageHmacKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new StorageHmacKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
