...
// https://registry.terraform.io/providers/hashicorp/google/5.9.0/docs/data-sources/container_analysis_note_iam_policy
...
export class DataGoogleContainerAnalysisNoteIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleContainerAnalysisNoteIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.9.0/docs/data-sources/container_analysis_note_iam_policy#import import section} in the documentation of this resource for the id to use
