// https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/tags_tag_value_iam_member
...
export class TagsTagValueIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagsTagValueIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/tags_tag_value_iam_member#import import section} in the documentation of this resource for the id to use
