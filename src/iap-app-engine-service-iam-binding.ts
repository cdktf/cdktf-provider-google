...
function iapAppEngineServiceIamBindingConditionToTerraform(struct?: IapAppEngineServiceIamBindingConditionOutputReference | IapAppEngineServiceIamBindingCondition): any {
...
export class IapAppEngineServiceIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: IapAppEngineServiceIamBindingCondition | undefined; 
  private __conditionOutput = new IapAppEngineServiceIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapAppEngineServiceIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapAppEngineServiceIamBindingConditionToTerraform(this._condition),
    };
  }
}
