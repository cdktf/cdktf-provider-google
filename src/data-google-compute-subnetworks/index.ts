...
// https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/data-sources/compute_subnetworks
...
export class DataGoogleComputeSubnetworks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeSubnetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/data-sources/compute_subnetworks#import import section} in the documentation of this resource for the id to use
