...
function iapAppEngineServiceIamMemberConditionToTerraform(struct?: IapAppEngineServiceIamMemberConditionOutputReference | IapAppEngineServiceIamMemberCondition): any {
...
export class IapAppEngineServiceIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: IapAppEngineServiceIamMemberCondition | undefined; 
  private __conditionOutput = new IapAppEngineServiceIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapAppEngineServiceIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapAppEngineServiceIamMemberConditionToTerraform(this._condition),
    };
  }
}
