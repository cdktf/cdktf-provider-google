// https://www.terraform.io/docs/providers/google/r/iap_app_engine_service_iam_member
...
export function iapAppEngineServiceIamMemberConditionToTerraform(struct?: IapAppEngineServiceIamMemberConditionOutputReference | IapAppEngineServiceIamMemberCondition): any {
...
export class IapAppEngineServiceIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IapAppEngineServiceIamMemberCondition | undefined {
  ...
  public set internalValue(value: IapAppEngineServiceIamMemberCondition | undefined) {
    if (value === undefined) {
...
export class IapAppEngineServiceIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new IapAppEngineServiceIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this._condition;
  }
  public putCondition(value: IapAppEngineServiceIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapAppEngineServiceIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
