// https://registry.terraform.io/providers/hashicorp/google/6.27.0/docs/resources/access_context_manager_egress_policy
...
export class AccessContextManagerEgressPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessContextManagerEgressPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.27.0/docs/resources/access_context_manager_egress_policy#import import section} in the documentation of this resource for the id to use
