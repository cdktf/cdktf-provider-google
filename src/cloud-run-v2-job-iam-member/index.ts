...
// https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/cloud_run_v2_job_iam_member
...
export class CloudRunV2JobIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudRunV2JobIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/cloud_run_v2_job_iam_member#import import section} in the documentation of this resource for the id to use
