...
function gameServicesGameServerDeploymentTimeoutsToTerraform(struct?: GameServicesGameServerDeploymentTimeoutsOutputReference | GameServicesGameServerDeploymentTimeouts): any {
...
export class GameServicesGameServerDeployment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: GameServicesGameServerDeploymentTimeouts | undefined; 
  private __timeoutsOutput = new GameServicesGameServerDeploymentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: GameServicesGameServerDeploymentTimeouts | undefined) {
