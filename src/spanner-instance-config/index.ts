// https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/spanner_instance_config
...
export class SpannerInstanceConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpannerInstanceConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/spanner_instance_config#import import section} in the documentation of this resource for the id to use
