// https://registry.terraform.io/providers/hashicorp/google/6.34.0/docs/resources/dataplex_entry_group_iam_binding
...
export class DataplexEntryGroupIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexEntryGroupIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.34.0/docs/resources/dataplex_entry_group_iam_binding#import import section} in the documentation of this resource for the id to use
