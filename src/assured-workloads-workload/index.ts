...
// https://registry.terraform.io/providers/hashicorp/google/6.23.0/docs/resources/assured_workloads_workload
...
export class AssuredWorkloadsWorkload extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssuredWorkloadsWorkload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.23.0/docs/resources/assured_workloads_workload#import import section} in the documentation of this resource for the id to use
