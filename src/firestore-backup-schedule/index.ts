// https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/firestore_backup_schedule
...
export class FirestoreBackupSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirestoreBackupSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/firestore_backup_schedule#import import section} in the documentation of this resource for the id to use
