// https://www.terraform.io/docs/providers/google/r/dataproc_autoscaling_policy_iam_member
...
export interface DataprocAutoscalingPolicyIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function dataprocAutoscalingPolicyIamMemberConditionToTerraform(struct?: DataprocAutoscalingPolicyIamMemberConditionOutputReference | DataprocAutoscalingPolicyIamMemberCondition): any {
...
export class DataprocAutoscalingPolicyIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataprocAutoscalingPolicyIamMemberCondition | undefined {
  ...
  public set internalValue(value: DataprocAutoscalingPolicyIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class DataprocAutoscalingPolicyIamMember extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_dataproc_autoscaling_policy_iam_member";
  ...
  * @param options DataprocAutoscalingPolicyIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: DataprocAutoscalingPolicyIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new DataprocAutoscalingPolicyIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: DataprocAutoscalingPolicyIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: dataprocAutoscalingPolicyIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
