// https://registry.terraform.io/providers/hashicorp/google/5.32.0/docs/resources/scc_mute_config
...
export class SccMuteConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccMuteConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.32.0/docs/resources/scc_mute_config#import import section} in the documentation of this resource for the id to use
