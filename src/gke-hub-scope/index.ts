// https://registry.terraform.io/providers/hashicorp/google/5.26.0/docs/resources/gke_hub_scope
...
export class GkeHubScope extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.26.0/docs/resources/gke_hub_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.26.0/docs/resources/gke_hub_scope google_gke_hub_scope} Resource
  *
  * @param scope The scope in which to define this construct
