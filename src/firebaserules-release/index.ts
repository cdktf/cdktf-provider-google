...
// https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/firebaserules_release
...
export class FirebaserulesRelease extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirebaserulesRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/firebaserules_release#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.4.0/docs/resources/firebaserules_release google_firebaserules_release} Resource
  *
  * @param scope The scope in which to define this construct
