...
// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/logging_sink
...
export class DataGoogleLoggingSink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleLoggingSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/logging_sink#import import section} in the documentation of this resource for the id to use
