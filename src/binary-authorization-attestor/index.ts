...
// https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/binary_authorization_attestor
...
export class BinaryAuthorizationAttestor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BinaryAuthorizationAttestor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/binary_authorization_attestor#import import section} in the documentation of this resource for the id to use
