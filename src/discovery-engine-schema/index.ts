...
// https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/resources/discovery_engine_schema
...
export class DiscoveryEngineSchema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryEngineSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/resources/discovery_engine_schema#import import section} in the documentation of this resource for the id to use
