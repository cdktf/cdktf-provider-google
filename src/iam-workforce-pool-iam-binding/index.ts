...
// https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/iam_workforce_pool_iam_binding
...
export interface IamWorkforcePoolIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: IamWorkforcePoolIamBindingCondition;
}
export interface IamWorkforcePoolIamBindingCondition {
  /**
...
export function iamWorkforcePoolIamBindingConditionToTerraform(struct?: IamWorkforcePoolIamBindingConditionOutputReference | IamWorkforcePoolIamBindingCondition): any {
...
export function iamWorkforcePoolIamBindingConditionToHclTerraform(struct?: IamWorkforcePoolIamBindingConditionOutputReference | IamWorkforcePoolIamBindingCondition): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IamWorkforcePoolIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IamWorkforcePoolIamBindingCondition | undefined {
  ...
  public set internalValue(value: IamWorkforcePoolIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class IamWorkforcePoolIamBinding extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the IamWorkforcePoolIamBinding to import
  * @param importFromId The id of the existing IamWorkforcePoolIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/iam_workforce_pool_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_iam_workforce_pool_iam_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/iam_workforce_pool_iam_binding google_iam_workforce_pool_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IamWorkforcePoolIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: IamWorkforcePoolIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new IamWorkforcePoolIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: IamWorkforcePoolIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iamWorkforcePoolIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: iamWorkforcePoolIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "IamWorkforcePoolIamBindingConditionList",
      },
    };
