// https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/logging_log_view_iam_member
...
export class LoggingLogViewIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingLogViewIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/logging_log_view_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.33.0/docs/resources/logging_log_view_iam_member google_logging_log_view_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
