...
// https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/logging_folder_settings
...
export class LoggingFolderSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingFolderSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/logging_folder_settings#import import section} in the documentation of this resource for the id to use
