...
// https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/scc_source_iam_member
...
export class SccSourceIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccSourceIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/scc_source_iam_member#import import section} in the documentation of this resource for the id to use
