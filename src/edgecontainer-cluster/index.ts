...
export class EdgecontainerCluster extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/edgecontainer_cluster google_edgecontainer_cluster} Resource
  *
  * @param scope The scope in which to define this construct
