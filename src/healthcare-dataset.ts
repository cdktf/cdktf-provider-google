...
export function healthcareDatasetTimeoutsToTerraform(struct?: HealthcareDatasetTimeoutsOutputReference | HealthcareDatasetTimeouts): any {
...
export class HealthcareDatasetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): HealthcareDatasetTimeouts | undefined {
  ...
  public set internalValue(value: HealthcareDatasetTimeouts | undefined) {
    if (value === undefined) {
...
export class HealthcareDataset extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new HealthcareDatasetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
