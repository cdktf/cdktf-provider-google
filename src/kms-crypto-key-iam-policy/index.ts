// https://registry.terraform.io/providers/hashicorp/google/5.31.1/docs/resources/kms_crypto_key_iam_policy
...
export class KmsCryptoKeyIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsCryptoKeyIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.31.1/docs/resources/kms_crypto_key_iam_policy#import import section} in the documentation of this resource for the id to use
