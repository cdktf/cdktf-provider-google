...
function iapTunnelIamMemberConditionToTerraform(struct?: IapTunnelIamMemberConditionOutputReference | IapTunnelIamMemberCondition): any {
...
export class IapTunnelIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: IapTunnelIamMemberCondition | undefined; 
  private __conditionOutput = new IapTunnelIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapTunnelIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapTunnelIamMemberConditionToTerraform(this._condition),
    };
  }
}
