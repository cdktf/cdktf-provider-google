...
// https://registry.terraform.io/providers/hashicorp/google/6.13.0/docs/resources/iam_folders_policy_binding
...
export class IamFoldersPolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamFoldersPolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.13.0/docs/resources/iam_folders_policy_binding#import import section} in the documentation of this resource for the id to use
