// https://registry.terraform.io/providers/hashicorp/google/6.19.0/docs/resources/dialogflow_cx_test_case
...
export class DialogflowCxTestCase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowCxTestCase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.19.0/docs/resources/dialogflow_cx_test_case#import import section} in the documentation of this resource for the id to use
