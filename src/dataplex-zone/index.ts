// https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/dataplex_zone
...
export class DataplexZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/dataplex_zone#import import section} in the documentation of this resource for the id to use
