...
// https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/data-sources/sql_database_instance
...
export class DataGoogleSqlDatabaseInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSqlDatabaseInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/data-sources/sql_database_instance#import import section} in the documentation of this resource for the id to use
