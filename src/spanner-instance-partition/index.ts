// https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/spanner_instance_partition
...
export class SpannerInstancePartition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpannerInstancePartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/spanner_instance_partition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/spanner_instance_partition google_spanner_instance_partition} Resource
  *
  * @param scope The scope in which to define this construct
