...
// https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/gke_hub_feature
...
export interface GkeHubFeatureSpecRbacrolebindingactuation {
  /**
...
export function gkeHubFeatureSpecRbacrolebindingactuationToTerraform(struct?: GkeHubFeatureSpecRbacrolebindingactuationOutputReference | GkeHubFeatureSpecRbacrolebindingactuation): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function gkeHubFeatureSpecRbacrolebindingactuationToHclTerraform(struct?: GkeHubFeatureSpecRbacrolebindingactuationOutputReference | GkeHubFeatureSpecRbacrolebindingactuation): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GkeHubFeatureSpecRbacrolebindingactuationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GkeHubFeatureSpecRbacrolebindingactuation | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GkeHubFeatureSpecRbacrolebindingactuation | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GkeHubFeatureSpec {
  ...
  */
  readonly rbacrolebindingactuation?: GkeHubFeatureSpecRbacrolebindingactuation;
}
...
export function gkeHubFeatureSpecToTerraform(struct?: GkeHubFeatureSpecOutputReference | GkeHubFeatureSpec): any {
  ...
  return {
    ...
    rbacrolebindingactuation: gkeHubFeatureSpecRbacrolebindingactuationToTerraform(struct!.rbacrolebindingactuation),
  }
}
...
export function gkeHubFeatureSpecToHclTerraform(struct?: GkeHubFeatureSpecOutputReference | GkeHubFeatureSpec): any {
  ...
  const attrs = {
    ...
    rbacrolebindingactuation: {
      value: gkeHubFeatureSpecRbacrolebindingactuationToHclTerraform(struct!.rbacrolebindingactuation),
      isBlock: true,
      type: "list",
      storageClassType: "GkeHubFeatureSpecRbacrolebindingactuationList",
    },
  };
...
export class GkeHubFeatureSpecOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _rbacrolebindingactuation = new GkeHubFeatureSpecRbacrolebindingactuationOutputReference(this, "rbacrolebindingactuation");
  public get rbacrolebindingactuation() {
    return this._rbacrolebindingactuation;
  }
  public putRbacrolebindingactuation(value: GkeHubFeatureSpecRbacrolebindingactuation) {
...
export class GkeHubFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/gke_hub_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/gke_hub_feature google_gke_hub_feature} Resource
  *
  * @param scope The scope in which to define this construct
