...
export function certificateManagerCertificateManagedToTerraform(struct?: CertificateManagerCertificateManagedOutputReference | CertificateManagerCertificateManaged): any {
  ...
  return {
    dns_authorizations: cdktf.listMapper(cdktf.stringToTerraform)(struct!.dnsAuthorizations),
...
export class CertificateManagerCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CertificateManagerCertificateTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: CertificateManagerCertificateTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
