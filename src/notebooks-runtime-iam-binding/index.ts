// https://registry.terraform.io/providers/hashicorp/google/5.5.0/docs/resources/notebooks_runtime_iam_binding
...
export class NotebooksRuntimeIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotebooksRuntimeIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.5.0/docs/resources/notebooks_runtime_iam_binding#import import section} in the documentation of this resource for the id to use
