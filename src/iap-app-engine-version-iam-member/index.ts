// https://registry.terraform.io/providers/hashicorp/google/6.13.0/docs/resources/iap_app_engine_version_iam_member
...
export class IapAppEngineVersionIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapAppEngineVersionIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.13.0/docs/resources/iap_app_engine_version_iam_member#import import section} in the documentation of this resource for the id to use
