// https://registry.terraform.io/providers/hashicorp/google/5.37.0/docs/resources/public_ca_external_account_key
...
export class PublicCaExternalAccountKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicCaExternalAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.37.0/docs/resources/public_ca_external_account_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.37.0/docs/resources/public_ca_external_account_key google_public_ca_external_account_key} Resource
  *
  * @param scope The scope in which to define this construct
