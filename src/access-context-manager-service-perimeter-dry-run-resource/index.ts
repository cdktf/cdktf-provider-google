// https://registry.terraform.io/providers/hashicorp/google/6.37.0/docs/resources/access_context_manager_service_perimeter_dry_run_resource
...
export class AccessContextManagerServicePerimeterDryRunResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessContextManagerServicePerimeterDryRunResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.37.0/docs/resources/access_context_manager_service_perimeter_dry_run_resource#import import section} in the documentation of this resource for the id to use
