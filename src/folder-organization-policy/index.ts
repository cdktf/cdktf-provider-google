// https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/folder_organization_policy
...
export class FolderOrganizationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FolderOrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/folder_organization_policy#import import section} in the documentation of this resource for the id to use
