...
export function pubsubSchemaTimeoutsToTerraform(struct?: PubsubSchemaTimeoutsOutputReference | PubsubSchemaTimeouts): any {
...
export class PubsubSchemaTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: PubsubSchemaTimeouts | undefined) {
    if (value === undefined) {
...
export class PubsubSchema extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PubsubSchemaTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
