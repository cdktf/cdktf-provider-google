...
function bigtableInstanceIamMemberConditionToTerraform(struct?: BigtableInstanceIamMemberConditionOutputReference | BigtableInstanceIamMemberCondition): any {
...
export class BigtableInstanceIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: BigtableInstanceIamMemberCondition | undefined; 
  private __conditionOutput = new BigtableInstanceIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: BigtableInstanceIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: bigtableInstanceIamMemberConditionToTerraform(this._condition),
    };
  }
}
