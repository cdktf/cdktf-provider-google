...
// https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/resources/iap_web_type_app_engine_iam_member
...
export class IapWebTypeAppEngineIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapWebTypeAppEngineIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/resources/iap_web_type_app_engine_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/resources/iap_web_type_app_engine_iam_member google_iap_web_type_app_engine_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
