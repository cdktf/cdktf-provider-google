// https://registry.terraform.io/providers/hashicorp/google/6.17.0/docs/data-sources/secret_manager_secret_version
...
export class DataGoogleSecretManagerSecretVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSecretManagerSecretVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.17.0/docs/data-sources/secret_manager_secret_version#import import section} in the documentation of this resource for the id to use
