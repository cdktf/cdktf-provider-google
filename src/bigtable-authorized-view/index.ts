...
// https://registry.terraform.io/providers/hashicorp/google/6.5.0/docs/resources/bigtable_authorized_view
...
export class BigtableAuthorizedView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigtableAuthorizedView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.5.0/docs/resources/bigtable_authorized_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.5.0/docs/resources/bigtable_authorized_view google_bigtable_authorized_view} Resource
  *
  * @param scope The scope in which to define this construct
