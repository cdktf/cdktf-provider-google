...
// https://registry.terraform.io/providers/hashicorp/google/6.43.0/docs/resources/project_iam_audit_config
...
export class ProjectIamAuditConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIamAuditConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.43.0/docs/resources/project_iam_audit_config#import import section} in the documentation of this resource for the id to use
