...
// https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/data-sources/data_catalog_policy_tag_iam_policy
...
export class DataGoogleDataCatalogPolicyTagIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDataCatalogPolicyTagIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/data-sources/data_catalog_policy_tag_iam_policy#import import section} in the documentation of this resource for the id to use
