...
// https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/compute_subnetwork_iam_member
...
export class ComputeSubnetworkIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeSubnetworkIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/compute_subnetwork_iam_member#import import section} in the documentation of this resource for the id to use
