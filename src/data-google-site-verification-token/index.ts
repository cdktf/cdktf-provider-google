...
// https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/data-sources/site_verification_token
...
export class DataGoogleSiteVerificationToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSiteVerificationToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/data-sources/site_verification_token#import import section} in the documentation of this resource for the id to use
