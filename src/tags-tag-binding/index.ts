...
// https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/tags_tag_binding
...
export class TagsTagBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagsTagBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/tags_tag_binding#import import section} in the documentation of this resource for the id to use
