...
export function computeHttpsHealthCheckTimeoutsToTerraform(struct?: ComputeHttpsHealthCheckTimeoutsOutputReference | ComputeHttpsHealthCheckTimeouts): any {
...
export class ComputeHttpsHealthCheckTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeHttpsHealthCheckTimeouts | undefined {
  ...
  public set internalValue(value: ComputeHttpsHealthCheckTimeouts | undefined) {
    if (value === undefined) {
...
export class ComputeHttpsHealthCheck extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ComputeHttpsHealthCheckTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
