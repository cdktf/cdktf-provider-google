...
export function iapClientTimeoutsToTerraform(struct?: IapClientTimeoutsOutputReference | IapClientTimeouts): any {
...
export class IapClient extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IapClientTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
