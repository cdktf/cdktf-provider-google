...
// https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/resources/firestore_index
...
export class FirestoreIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirestoreIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/resources/firestore_index#import import section} in the documentation of this resource for the id to use
