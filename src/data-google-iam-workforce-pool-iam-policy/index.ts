...
// https://registry.terraform.io/providers/hashicorp/google/6.49.2/docs/data-sources/iam_workforce_pool_iam_policy
...
export class DataGoogleIamWorkforcePoolIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleIamWorkforcePoolIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.2/docs/data-sources/iam_workforce_pool_iam_policy#import import section} in the documentation of this resource for the id to use
