// https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/data-sources/endpoints_service_consumers_iam_policy
...
export class DataGoogleEndpointsServiceConsumersIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleEndpointsServiceConsumersIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/data-sources/endpoints_service_consumers_iam_policy#import import section} in the documentation of this resource for the id to use
