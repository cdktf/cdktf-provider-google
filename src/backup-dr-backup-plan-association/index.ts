// https://registry.terraform.io/providers/hashicorp/google/6.27.0/docs/resources/backup_dr_backup_plan_association
...
export class BackupDrBackupPlanAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupDrBackupPlanAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.27.0/docs/resources/backup_dr_backup_plan_association#import import section} in the documentation of this resource for the id to use
