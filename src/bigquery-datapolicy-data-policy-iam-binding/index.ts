...
// https://registry.terraform.io/providers/hashicorp/google/6.14.0/docs/resources/bigquery_datapolicy_data_policy_iam_binding
...
export class BigqueryDatapolicyDataPolicyIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryDatapolicyDataPolicyIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.14.0/docs/resources/bigquery_datapolicy_data_policy_iam_binding#import import section} in the documentation of this resource for the id to use
