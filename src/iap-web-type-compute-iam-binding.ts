...
export interface IapWebTypeComputeIamBindingConfig extends TerraformMetaArguments {
...
export class IapWebTypeComputeIamBinding extends TerraformResource {
  ...
  public set condition(value: IapWebTypeComputeIamBindingCondition[] | undefined) {
