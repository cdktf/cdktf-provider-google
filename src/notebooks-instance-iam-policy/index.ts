// https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/notebooks_instance_iam_policy
...
export class NotebooksInstanceIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotebooksInstanceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/notebooks_instance_iam_policy#import import section} in the documentation of this resource for the id to use
