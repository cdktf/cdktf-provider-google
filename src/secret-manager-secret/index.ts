// https://registry.terraform.io/providers/hashicorp/google/6.1.0/docs/resources/secret_manager_secret
...
export class SecretManagerSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretManagerSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.1.0/docs/resources/secret_manager_secret#import import section} in the documentation of this resource for the id to use
