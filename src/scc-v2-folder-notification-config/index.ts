// https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/resources/scc_v2_folder_notification_config
...
export class SccV2FolderNotificationConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccV2FolderNotificationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/resources/scc_v2_folder_notification_config#import import section} in the documentation of this resource for the id to use
