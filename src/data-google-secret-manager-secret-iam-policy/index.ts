...
// https://registry.terraform.io/providers/hashicorp/google/6.11.2/docs/data-sources/secret_manager_secret_iam_policy
...
export class DataGoogleSecretManagerSecretIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSecretManagerSecretIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.11.2/docs/data-sources/secret_manager_secret_iam_policy#import import section} in the documentation of this resource for the id to use
