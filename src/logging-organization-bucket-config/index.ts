// https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/logging_organization_bucket_config
...
export class LoggingOrganizationBucketConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingOrganizationBucketConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/logging_organization_bucket_config#import import section} in the documentation of this resource for the id to use
