...
// https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/scc_organization_scc_big_query_export
...
export class SccOrganizationSccBigQueryExport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccOrganizationSccBigQueryExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/scc_organization_scc_big_query_export#import import section} in the documentation of this resource for the id to use
