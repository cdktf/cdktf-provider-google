// https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/tags_tag_key_iam_binding
...
export class TagsTagKeyIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagsTagKeyIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/tags_tag_key_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/tags_tag_key_iam_binding google_tags_tag_key_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
