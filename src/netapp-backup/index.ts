// https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup
...
export interface NetappBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#description NetappBackup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#id NetappBackup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#labels NetappBackup#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Location of the backup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#location NetappBackup#location}
  */
  readonly location: string;
  /**
  * The resource name of the backup. Needs to be unique per location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#name NetappBackup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#project NetappBackup#project}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#source_snapshot NetappBackup#source_snapshot}
  */
  readonly sourceSnapshot?: string;
  /**
  * ID of volumes this backup belongs to. Format: 'projects/{{projects_id}}/locations/{{location}}/volumes/{{name}}''
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#source_volume NetappBackup#source_volume}
  */
  readonly sourceVolume?: string;
  /**
  * Name of the backup vault to store the backup in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#vault_name NetappBackup#vault_name}
  */
  readonly vaultName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#timeouts NetappBackup#timeouts}
  */
  readonly timeouts?: NetappBackupTimeouts;
}
export interface NetappBackupTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#create NetappBackup#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#delete NetappBackup#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#update NetappBackup#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup google_netapp_backup}
*/
export class NetappBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/netapp_backup google_netapp_backup} Resource
  *
  * @param scope The scope in which to define this construct
