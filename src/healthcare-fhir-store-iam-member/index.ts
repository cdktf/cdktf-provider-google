// https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/healthcare_fhir_store_iam_member
...
export class HealthcareFhirStoreIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareFhirStoreIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/resources/healthcare_fhir_store_iam_member#import import section} in the documentation of this resource for the id to use
