...
export function apigeeEnvironmentTimeoutsToTerraform(struct?: ApigeeEnvironmentTimeoutsOutputReference | ApigeeEnvironmentTimeouts): any {
...
export class ApigeeEnvironment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApigeeEnvironmentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
