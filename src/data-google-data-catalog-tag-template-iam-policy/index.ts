...
// https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/data_catalog_tag_template_iam_policy
...
export class DataGoogleDataCatalogTagTemplateIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDataCatalogTagTemplateIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/data_catalog_tag_template_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/data_catalog_tag_template_iam_policy google_data_catalog_tag_template_iam_policy} Data Source
  *
  * @param scope The scope in which to define this construct
