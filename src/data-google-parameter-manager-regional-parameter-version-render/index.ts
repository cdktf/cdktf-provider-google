// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/parameter_manager_regional_parameter_version_render
...
export class DataGoogleParameterManagerRegionalParameterVersionRender extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleParameterManagerRegionalParameterVersionRender that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/parameter_manager_regional_parameter_version_render#import import section} in the documentation of this resource for the id to use
