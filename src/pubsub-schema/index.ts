...
// https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/pubsub_schema
...
export class PubsubSchema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PubsubSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/pubsub_schema#import import section} in the documentation of this resource for the id to use
