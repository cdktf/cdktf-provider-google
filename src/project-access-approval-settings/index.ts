...
// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/project_access_approval_settings
...
export class ProjectAccessApprovalSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectAccessApprovalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/project_access_approval_settings#import import section} in the documentation of this resource for the id to use
