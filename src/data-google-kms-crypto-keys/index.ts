...
// https://registry.terraform.io/providers/hashicorp/google/6.3.0/docs/data-sources/kms_crypto_keys
...
export class DataGoogleKmsCryptoKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsCryptoKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.3.0/docs/data-sources/kms_crypto_keys#import import section} in the documentation of this resource for the id to use
