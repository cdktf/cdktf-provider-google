...
// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/oracle_database_db_nodes
...
export class DataGoogleOracleDatabaseDbNodes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOracleDatabaseDbNodes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/oracle_database_db_nodes#import import section} in the documentation of this resource for the id to use
