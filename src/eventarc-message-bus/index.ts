...
// https://registry.terraform.io/providers/hashicorp/google/6.49.3/docs/resources/eventarc_message_bus
...
export class EventarcMessageBus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventarcMessageBus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.3/docs/resources/eventarc_message_bus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.3/docs/resources/eventarc_message_bus google_eventarc_message_bus} Resource
  *
  * @param scope The scope in which to define this construct
