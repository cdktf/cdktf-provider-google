...
// https://registry.terraform.io/providers/hashicorp/google/6.39.0/docs/data-sources/bigquery_datasets
...
export class DataGoogleBigqueryDatasets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBigqueryDatasets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.39.0/docs/data-sources/bigquery_datasets#import import section} in the documentation of this resource for the id to use
