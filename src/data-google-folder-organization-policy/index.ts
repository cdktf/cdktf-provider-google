...
// https://registry.terraform.io/providers/hashicorp/google/6.21.0/docs/data-sources/folder_organization_policy
...
export class DataGoogleFolderOrganizationPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleFolderOrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.21.0/docs/data-sources/folder_organization_policy#import import section} in the documentation of this resource for the id to use
