// https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/database_migration_service_migration_job
...
export class DatabaseMigrationServiceMigrationJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseMigrationServiceMigrationJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/database_migration_service_migration_job#import import section} in the documentation of this resource for the id to use
