...
export interface IapWebIamMemberConfig extends TerraformMetaArguments {
...
export class IapWebIamMember extends TerraformResource {
  ...
  public set condition(value: IapWebIamMemberCondition[] | undefined) {
