...
function iapWebIamMemberConditionToTerraform(struct?: IapWebIamMemberConditionOutputReference | IapWebIamMemberCondition): any {
...
export class IapWebIamMember extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "google_iap_web_iam_member";
  ...
  */
  ...
  private _condition?: IapWebIamMemberCondition | undefined; 
  private __conditionOutput = new IapWebIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapWebIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapWebIamMemberConditionToTerraform(this._condition),
    };
  }
}
