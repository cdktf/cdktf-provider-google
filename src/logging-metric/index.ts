// https://registry.terraform.io/providers/hashicorp/google/5.13.0/docs/resources/logging_metric
...
export class LoggingMetric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.13.0/docs/resources/logging_metric#import import section} in the documentation of this resource for the id to use
