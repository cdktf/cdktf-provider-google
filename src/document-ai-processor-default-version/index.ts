...
// https://registry.terraform.io/providers/hashicorp/google/5.39.0/docs/resources/document_ai_processor_default_version
...
export class DocumentAiProcessorDefaultVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DocumentAiProcessorDefaultVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.39.0/docs/resources/document_ai_processor_default_version#import import section} in the documentation of this resource for the id to use
