// https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/storage_bucket_acl
...
export class StorageBucketAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageBucketAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/storage_bucket_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/storage_bucket_acl google_storage_bucket_acl} Resource
  *
  * @param scope The scope in which to define this construct
