// https://registry.terraform.io/providers/hashicorp/google/5.6.0/docs/resources/endpoints_service_consumers_iam_binding
...
export class EndpointsServiceConsumersIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointsServiceConsumersIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.6.0/docs/resources/endpoints_service_consumers_iam_binding#import import section} in the documentation of this resource for the id to use
