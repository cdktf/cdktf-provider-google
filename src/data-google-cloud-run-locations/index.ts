...
// https://registry.terraform.io/providers/hashicorp/google/6.34.0/docs/data-sources/cloud_run_locations
...
export class DataGoogleCloudRunLocations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudRunLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.34.0/docs/data-sources/cloud_run_locations#import import section} in the documentation of this resource for the id to use
