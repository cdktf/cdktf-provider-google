...
// https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/data-sources/monitoring_mesh_istio_service
...
export class DataGoogleMonitoringMeshIstioService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleMonitoringMeshIstioService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/data-sources/monitoring_mesh_istio_service#import import section} in the documentation of this resource for the id to use
