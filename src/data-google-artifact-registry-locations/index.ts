// https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_locations
...
export interface DataGoogleArtifactRegistryLocationsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_locations#id DataGoogleArtifactRegistryLocations#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_locations#project DataGoogleArtifactRegistryLocations#project}
  */
  readonly project?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_locations google_artifact_registry_locations}
*/
export class DataGoogleArtifactRegistryLocations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleArtifactRegistryLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_locations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/data-sources/artifact_registry_locations google_artifact_registry_locations} Data Source
  *
  * @param scope The scope in which to define this construct
