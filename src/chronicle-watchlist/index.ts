...
// https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/chronicle_watchlist
...
export class ChronicleWatchlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChronicleWatchlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/chronicle_watchlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/chronicle_watchlist google_chronicle_watchlist} Resource
  *
  * @param scope The scope in which to define this construct
