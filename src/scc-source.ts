...
export function sccSourceTimeoutsToTerraform(struct?: SccSourceTimeoutsOutputReference | SccSourceTimeouts): any {
...
export class SccSourceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SccSourceTimeouts | undefined {
  ...
  public set internalValue(value: SccSourceTimeouts | undefined) {
    if (value === undefined) {
...
export class SccSource extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SccSourceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
