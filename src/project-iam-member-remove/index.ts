...
// https://registry.terraform.io/providers/hashicorp/google/5.33.0/docs/resources/project_iam_member_remove
...
export class ProjectIamMemberRemove extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIamMemberRemove that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.33.0/docs/resources/project_iam_member_remove#import import section} in the documentation of this resource for the id to use
