...
function privatecaCaPoolIamBindingConditionToTerraform(struct?: PrivatecaCaPoolIamBindingConditionOutputReference | PrivatecaCaPoolIamBindingCondition): any {
...
export class PrivatecaCaPoolIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: PrivatecaCaPoolIamBindingCondition | undefined; 
  private __conditionOutput = new PrivatecaCaPoolIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: PrivatecaCaPoolIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: privatecaCaPoolIamBindingConditionToTerraform(this._condition),
    };
  }
}
