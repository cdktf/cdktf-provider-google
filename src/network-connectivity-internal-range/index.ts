...
// https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/network_connectivity_internal_range
...
export class NetworkConnectivityInternalRange extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkConnectivityInternalRange that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/network_connectivity_internal_range#import import section} in the documentation of this resource for the id to use
