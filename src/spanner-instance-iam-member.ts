...
function spannerInstanceIamMemberConditionToTerraform(struct?: SpannerInstanceIamMemberConditionOutputReference | SpannerInstanceIamMemberCondition): any {
...
export class SpannerInstanceIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: SpannerInstanceIamMemberCondition | undefined; 
  private __conditionOutput = new SpannerInstanceIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: SpannerInstanceIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: spannerInstanceIamMemberConditionToTerraform(this._condition),
    };
  }
}
