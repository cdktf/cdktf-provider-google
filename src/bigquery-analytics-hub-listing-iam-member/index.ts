...
// https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/bigquery_analytics_hub_listing_iam_member
...
export class BigqueryAnalyticsHubListingIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryAnalyticsHubListingIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/bigquery_analytics_hub_listing_iam_member#import import section} in the documentation of this resource for the id to use
