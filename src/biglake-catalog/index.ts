...
// https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/biglake_catalog
...
export class BiglakeCatalog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BiglakeCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.7.0/docs/resources/biglake_catalog#import import section} in the documentation of this resource for the id to use
