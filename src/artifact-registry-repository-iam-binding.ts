// https://www.terraform.io/docs/providers/google/r/artifact_registry_repository_iam_binding
...
export function artifactRegistryRepositoryIamBindingConditionToTerraform(struct?: ArtifactRegistryRepositoryIamBindingConditionOutputReference | ArtifactRegistryRepositoryIamBindingCondition): any {
...
export class ArtifactRegistryRepositoryIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ArtifactRegistryRepositoryIamBindingCondition | undefined {
  ...
  public set internalValue(value: ArtifactRegistryRepositoryIamBindingCondition | undefined) {
    if (value === undefined) {
...
export class ArtifactRegistryRepositoryIamBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_artifact_registry_repository_iam_binding";
  ...
  */
  public constructor(scope: Construct, id: string, config: ArtifactRegistryRepositoryIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new ArtifactRegistryRepositoryIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: ArtifactRegistryRepositoryIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: artifactRegistryRepositoryIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
}
