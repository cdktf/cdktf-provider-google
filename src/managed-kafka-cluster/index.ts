// https://registry.terraform.io/providers/hashicorp/google/6.21.0/docs/resources/managed_kafka_cluster
...
export class ManagedKafkaCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedKafkaCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.21.0/docs/resources/managed_kafka_cluster#import import section} in the documentation of this resource for the id to use
