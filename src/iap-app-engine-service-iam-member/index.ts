...
// https://registry.terraform.io/providers/hashicorp/google/6.11.2/docs/resources/iap_app_engine_service_iam_member
...
export class IapAppEngineServiceIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapAppEngineServiceIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.11.2/docs/resources/iap_app_engine_service_iam_member#import import section} in the documentation of this resource for the id to use
