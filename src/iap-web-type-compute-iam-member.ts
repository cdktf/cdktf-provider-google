...
function iapWebTypeComputeIamMemberConditionToTerraform(struct?: IapWebTypeComputeIamMemberConditionOutputReference | IapWebTypeComputeIamMemberCondition): any {
...
export class IapWebTypeComputeIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: IapWebTypeComputeIamMemberCondition | undefined; 
  private __conditionOutput = new IapWebTypeComputeIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapWebTypeComputeIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapWebTypeComputeIamMemberConditionToTerraform(this._condition),
    };
  }
}
