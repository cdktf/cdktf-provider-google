...
function iapWebTypeComputeIamMemberConditionToTerraform(struct?: IapWebTypeComputeIamMemberCondition): any {
...
export class IapWebTypeComputeIamMember extends cdktf.TerraformResource {
  ...
  public set condition(value: IapWebTypeComputeIamMemberCondition[] ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: cdktf.listMapper(iapWebTypeComputeIamMemberConditionToTerraform)(this._condition),
    };
  }
}
