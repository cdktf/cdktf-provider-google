...
export function computeProjectMetadataItemTimeoutsToTerraform(struct?: ComputeProjectMetadataItemTimeoutsOutputReference | ComputeProjectMetadataItemTimeouts): any {
...
export class ComputeProjectMetadataItem extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ComputeProjectMetadataItemTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
