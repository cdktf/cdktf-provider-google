// https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/certificate_manager_trust_config
...
export class CertificateManagerTrustConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificateManagerTrustConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/certificate_manager_trust_config#import import section} in the documentation of this resource for the id to use
