// https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/data-sources/gke_hub_membership_binding
...
export class DataGoogleGkeHubMembershipBinding extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleGkeHubMembershipBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.40.0/docs/data-sources/gke_hub_membership_binding#import import section} in the documentation of this resource for the id to use
