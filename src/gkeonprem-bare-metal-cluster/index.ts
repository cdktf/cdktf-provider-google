...
// https://registry.terraform.io/providers/hashicorp/google/6.26.0/docs/resources/gkeonprem_bare_metal_cluster
...
export class GkeonpremBareMetalCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeonpremBareMetalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.26.0/docs/resources/gkeonprem_bare_metal_cluster#import import section} in the documentation of this resource for the id to use
