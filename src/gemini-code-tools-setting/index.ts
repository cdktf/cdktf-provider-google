// https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/gemini_code_tools_setting
...
export class GeminiCodeToolsSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GeminiCodeToolsSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/gemini_code_tools_setting#import import section} in the documentation of this resource for the id to use
