...
// https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/colab_runtime
...
export class ColabRuntime extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ColabRuntime that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/colab_runtime#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/colab_runtime google_colab_runtime} Resource
  *
  * @param scope The scope in which to define this construct
