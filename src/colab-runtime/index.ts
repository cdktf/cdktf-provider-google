...
// https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime
...
export interface ColabRuntimeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#auto_upgrade ColabRuntime#auto_upgrade}
  */
  readonly autoUpgrade?: boolean | cdktf.IResolvable;
  /**
  * The description of the Runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#description ColabRuntime#description}
  */
  readonly description?: string;
  /**
  * Desired state of the Colab Runtime. Set this field to 'RUNNING' to start the runtime, and 'STOPPED' to stop it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#desired_state ColabRuntime#desired_state}
  */
  readonly desiredState?: string;
  /**
  * Required. The display name of the Runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#display_name ColabRuntime#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#id ColabRuntime#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#location ColabRuntime#location}
  */
  readonly location: string;
  /**
  * The resource name of the Runtime
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#name ColabRuntime#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#project ColabRuntime#project}
  */
  readonly project?: string;
  /**
  * The user email of the NotebookRuntime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#runtime_user ColabRuntime#runtime_user}
  */
  readonly runtimeUser: string;
  /**
  * notebook_runtime_template_ref block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#notebook_runtime_template_ref ColabRuntime#notebook_runtime_template_ref}
  */
  readonly notebookRuntimeTemplateRef?: ColabRuntimeNotebookRuntimeTemplateRef;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#timeouts ColabRuntime#timeouts}
  */
...
export interface ColabRuntimeNotebookRuntimeTemplateRef {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#notebook_runtime_template ColabRuntime#notebook_runtime_template}
  */
...
export interface ColabRuntimeTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#create ColabRuntime#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#delete ColabRuntime#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#update ColabRuntime#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime google_colab_runtime}
*/
export class ColabRuntime extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ColabRuntime that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/colab_runtime google_colab_runtime} Resource
  *
  * @param scope The scope in which to define this construct
