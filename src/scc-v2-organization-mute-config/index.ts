...
// https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/scc_v2_organization_mute_config
...
export class SccV2OrganizationMuteConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccV2OrganizationMuteConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/scc_v2_organization_mute_config#import import section} in the documentation of this resource for the id to use
