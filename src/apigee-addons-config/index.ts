...
export class ApigeeAddonsConfig extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/apigee_addons_config google_apigee_addons_config} Resource
  *
