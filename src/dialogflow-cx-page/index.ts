...
// https://registry.terraform.io/providers/hashicorp/google/5.3.0/docs/resources/dialogflow_cx_page
...
export class DialogflowCxPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowCxPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.3.0/docs/resources/dialogflow_cx_page#import import section} in the documentation of this resource for the id to use
