// https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/monitoring_metric_descriptor
...
export class MonitoringMetricDescriptor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitoringMetricDescriptor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/monitoring_metric_descriptor#import import section} in the documentation of this resource for the id to use
