...
// https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/endpoints_service
...
export class EndpointsService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/endpoints_service#import import section} in the documentation of this resource for the id to use
