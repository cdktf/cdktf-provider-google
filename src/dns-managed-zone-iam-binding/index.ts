// https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/dns_managed_zone_iam_binding
...
export class DnsManagedZoneIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsManagedZoneIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/dns_managed_zone_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/dns_managed_zone_iam_binding google_dns_managed_zone_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
