// https://www.terraform.io/docs/providers/google/r/dns_managed_zone_iam_binding
...
export class DnsManagedZoneIamBinding extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google/r/dns_managed_zone_iam_binding google_dns_managed_zone_iam_binding} Resource
  *
