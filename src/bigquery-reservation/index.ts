...
// https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/bigquery_reservation
...
export class BigqueryReservationReplicationStatusErrorOutputReference extends cdktf.ComplexObject {
...
export class BigqueryReservationReplicationStatusErrorList extends cdktf.ComplexList {
...
export class BigqueryReservationReplicationStatusOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class BigqueryReservationReplicationStatusList extends cdktf.ComplexList {
...
export class BigqueryReservation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/bigquery_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/bigquery_reservation google_bigquery_reservation} Resource
  *
  * @param scope The scope in which to define this construct
