// https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/iap_web_iam_policy
...
export class IapWebIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapWebIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/iap_web_iam_policy#import import section} in the documentation of this resource for the id to use
