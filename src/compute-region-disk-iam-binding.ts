// https://www.terraform.io/docs/providers/google/r/compute_region_disk_iam_binding
...
export class ComputeRegionDiskIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new ComputeRegionDiskIamBindingConditionOutputReference(this as any, "condition", true);
