...
function bigqueryTableIamBindingConditionToTerraform(struct?: BigqueryTableIamBindingConditionOutputReference | BigqueryTableIamBindingCondition): any {
...
export class BigqueryTableIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: BigqueryTableIamBindingCondition | undefined; 
  private __conditionOutput = new BigqueryTableIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: BigqueryTableIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: bigqueryTableIamBindingConditionToTerraform(this._condition),
    };
  }
}
