...
// https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/data-sources/dns_keys
...
export class DataGoogleDnsKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDnsKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/data-sources/dns_keys#import import section} in the documentation of this resource for the id to use
