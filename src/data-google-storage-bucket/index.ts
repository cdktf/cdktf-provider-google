...
// https://registry.terraform.io/providers/hashicorp/google/5.13.0/docs/data-sources/storage_bucket
...
export class DataGoogleStorageBucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleStorageBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.13.0/docs/data-sources/storage_bucket#import import section} in the documentation of this resource for the id to use
