// https://www.terraform.io/docs/providers/google/r/dataplex_lake_iam_member
...
export class DataplexLakeIamMember extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google/r/dataplex_lake_iam_member google_dataplex_lake_iam_member} Resource
  *
