...
function computeFirewallPolicyAssociationTimeoutsToTerraform(struct?: ComputeFirewallPolicyAssociationTimeouts): any {
...
export class ComputeFirewallPolicyAssociation extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ComputeFirewallPolicyAssociationTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: ComputeFirewallPolicyAssociationTimeouts ) {
