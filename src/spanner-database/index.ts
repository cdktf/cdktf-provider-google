// https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/spanner_database
...
export class SpannerDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpannerDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/spanner_database#import import section} in the documentation of this resource for the id to use
