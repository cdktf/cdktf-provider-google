...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/cloud_tasks_queue_iam_member
...
export class CloudTasksQueueIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudTasksQueueIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/cloud_tasks_queue_iam_member#import import section} in the documentation of this resource for the id to use
