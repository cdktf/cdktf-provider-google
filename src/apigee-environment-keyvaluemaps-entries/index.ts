...
// https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/apigee_environment_keyvaluemaps_entries
...
export class ApigeeEnvironmentKeyvaluemapsEntries extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeEnvironmentKeyvaluemapsEntries that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/apigee_environment_keyvaluemaps_entries#import import section} in the documentation of this resource for the id to use
