// https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/compute_snapshot_iam_member
...
export class ComputeSnapshotIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeSnapshotIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/compute_snapshot_iam_member#import import section} in the documentation of this resource for the id to use
