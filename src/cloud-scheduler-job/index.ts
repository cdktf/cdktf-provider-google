// https://registry.terraform.io/providers/hashicorp/google/5.5.0/docs/resources/cloud_scheduler_job
...
export class CloudSchedulerJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudSchedulerJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.5.0/docs/resources/cloud_scheduler_job#import import section} in the documentation of this resource for the id to use
