...
// https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/resources/monitoring_custom_service
...
export class MonitoringCustomService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitoringCustomService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/resources/monitoring_custom_service#import import section} in the documentation of this resource for the id to use
