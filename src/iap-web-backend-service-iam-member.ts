...
function iapWebBackendServiceIamMemberConditionToTerraform(struct?: IapWebBackendServiceIamMemberConditionOutputReference | IapWebBackendServiceIamMemberCondition): any {
...
export class IapWebBackendServiceIamMember extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "google_iap_web_backend_service_iam_member";
  ...
  */
  ...
  private _condition?: IapWebBackendServiceIamMemberCondition | undefined; 
  private __conditionOutput = new IapWebBackendServiceIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: IapWebBackendServiceIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapWebBackendServiceIamMemberConditionToTerraform(this._condition),
    };
  }
}
