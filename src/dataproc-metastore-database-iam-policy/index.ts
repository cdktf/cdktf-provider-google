...
// https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/dataproc_metastore_database_iam_policy
...
export interface DataprocMetastoreDatabaseIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataprocMetastoreDatabaseIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the DataprocMetastoreDatabaseIamPolicy to import
  * @param importFromId The id of the existing DataprocMetastoreDatabaseIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/dataproc_metastore_database_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  * @param options DataprocMetastoreDatabaseIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: DataprocMetastoreDatabaseIamPolicyConfig) {
    super(scope, id, {
