...
export function folderTimeoutsToTerraform(struct?: FolderTimeoutsOutputReference | FolderTimeouts): any {
...
export class FolderTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FolderTimeouts | undefined {
  ...
  public set internalValue(value: FolderTimeouts | undefined) {
    if (value === undefined) {
...
export class Folder extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new FolderTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
