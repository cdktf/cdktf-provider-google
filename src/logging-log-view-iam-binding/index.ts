// https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/logging_log_view_iam_binding
...
export class LoggingLogViewIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingLogViewIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.31.0/docs/resources/logging_log_view_iam_binding#import import section} in the documentation of this resource for the id to use
