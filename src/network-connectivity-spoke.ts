...
export class NetworkConnectivitySpokeLinkedRouterApplianceInstancesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _instances?: NetworkConnectivitySpokeLinkedRouterApplianceInstancesInstances[] | cdktf.IResolvable; 
  public get instances() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('instances');
  }
  public set instances(value: NetworkConnectivitySpokeLinkedRouterApplianceInstancesInstances[] | cdktf.IResolvable) {
...
export class NetworkConnectivitySpokeTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkConnectivitySpokeTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: NetworkConnectivitySpokeTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
