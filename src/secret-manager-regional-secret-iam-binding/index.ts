...
// https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/resources/secret_manager_regional_secret_iam_binding
...
export class SecretManagerRegionalSecretIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretManagerRegionalSecretIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.34.1/docs/resources/secret_manager_regional_secret_iam_binding#import import section} in the documentation of this resource for the id to use
