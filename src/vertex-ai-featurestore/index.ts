...
// https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/vertex_ai_featurestore
...
export class VertexAiFeaturestore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiFeaturestore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/vertex_ai_featurestore#import import section} in the documentation of this resource for the id to use
