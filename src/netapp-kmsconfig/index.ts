...
// https://registry.terraform.io/providers/hashicorp/google/6.41.0/docs/resources/netapp_kmsconfig
...
export class NetappKmsconfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappKmsconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.41.0/docs/resources/netapp_kmsconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.41.0/docs/resources/netapp_kmsconfig google_netapp_kmsconfig} Resource
  *
  * @param scope The scope in which to define this construct
