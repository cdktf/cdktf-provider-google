...
export interface ProjectIamMemberConfig extends TerraformMetaArguments {
...
export class ProjectIamMember extends TerraformResource {
  ...
  public set condition(value: ProjectIamMemberCondition[] | undefined) {
