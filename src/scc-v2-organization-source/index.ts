...
// https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/scc_v2_organization_source
...
export class SccV2OrganizationSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccV2OrganizationSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/scc_v2_organization_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.42.0/docs/resources/scc_v2_organization_source google_scc_v2_organization_source} Resource
  *
  * @param scope The scope in which to define this construct
