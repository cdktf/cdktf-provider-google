...
// https://registry.terraform.io/providers/hashicorp/google/5.13.0/docs/data-sources/filestore_instance
...
export class DataGoogleFilestoreInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleFilestoreInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.13.0/docs/data-sources/filestore_instance#import import section} in the documentation of this resource for the id to use
