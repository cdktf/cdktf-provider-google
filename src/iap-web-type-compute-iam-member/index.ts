...
// https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/iap_web_type_compute_iam_member
...
export class IapWebTypeComputeIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapWebTypeComputeIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/resources/iap_web_type_compute_iam_member#import import section} in the documentation of this resource for the id to use
