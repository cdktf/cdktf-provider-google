...
// https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/apigee_environment_iam_policy
...
export class DataGoogleApigeeEnvironmentIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleApigeeEnvironmentIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/apigee_environment_iam_policy#import import section} in the documentation of this resource for the id to use
