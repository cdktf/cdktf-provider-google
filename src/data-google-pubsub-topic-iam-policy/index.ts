// https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/data-sources/pubsub_topic_iam_policy
...
export class DataGooglePubsubTopicIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGooglePubsubTopicIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/data-sources/pubsub_topic_iam_policy#import import section} in the documentation of this resource for the id to use
