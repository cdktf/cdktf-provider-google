// https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/cloud_run_v2_service_iam_binding
...
export class CloudRunV2ServiceIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudRunV2ServiceIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.12.0/docs/resources/cloud_run_v2_service_iam_binding#import import section} in the documentation of this resource for the id to use
