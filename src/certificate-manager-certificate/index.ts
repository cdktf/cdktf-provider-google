// https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/certificate_manager_certificate
...
export class CertificateManagerCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificateManagerCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/certificate_manager_certificate#import import section} in the documentation of this resource for the id to use
