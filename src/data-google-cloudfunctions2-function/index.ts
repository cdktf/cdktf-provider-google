...
// https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/cloudfunctions2_function
...
export class DataGoogleCloudfunctions2Function extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudfunctions2Function that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.9.0/docs/data-sources/cloudfunctions2_function#import import section} in the documentation of this resource for the id to use
