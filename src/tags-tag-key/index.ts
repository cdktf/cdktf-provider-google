...
// https://registry.terraform.io/providers/hashicorp/google/6.5.0/docs/resources/tags_tag_key
...
export class TagsTagKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagsTagKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.5.0/docs/resources/tags_tag_key#import import section} in the documentation of this resource for the id to use
