...
function bigqueryDatasetIamMemberConditionToTerraform(struct?: BigqueryDatasetIamMemberConditionOutputReference | BigqueryDatasetIamMemberCondition): any {
...
export class BigqueryDatasetIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: BigqueryDatasetIamMemberCondition | undefined; 
  private __conditionOutput = new BigqueryDatasetIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: BigqueryDatasetIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: bigqueryDatasetIamMemberConditionToTerraform(this._condition),
    };
  }
}
