...
export function bigqueryDatasetIamMemberConditionToTerraform(struct?: BigqueryDatasetIamMemberConditionOutputReference | BigqueryDatasetIamMemberCondition): any {
...
export class BigqueryDatasetIamMemberConditionOutputReference extends cdktf.ComplexObject {
  /**
  ...
  */
  ...
  public set internalValue(value: BigqueryDatasetIamMemberCondition | undefined) {
    if (value === undefined) {
...
export class BigqueryDatasetIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new BigqueryDatasetIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this._condition;
  }
  public putCondition(value: BigqueryDatasetIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: bigqueryDatasetIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
