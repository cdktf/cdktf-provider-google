// https://www.terraform.io/docs/providers/google/r/compute_http_health_check
...
export function computeHttpHealthCheckTimeoutsToTerraform(struct?: ComputeHttpHealthCheckTimeoutsOutputReference | ComputeHttpHealthCheckTimeouts | cdktf.IResolvable): any {
...
export class ComputeHttpHealthCheckTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeHttpHealthCheckTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ComputeHttpHealthCheckTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ComputeHttpHealthCheck extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_compute_http_health_check";
  ...
  */
  ...
  private _timeouts = new ComputeHttpHealthCheckTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
