...
// https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/data_catalog_tag_template
...
export class DataCatalogTagTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataCatalogTagTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/data_catalog_tag_template#import import section} in the documentation of this resource for the id to use
