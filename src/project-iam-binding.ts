...
export interface ProjectIamBindingConfig extends TerraformMetaArguments {
...
export class ProjectIamBinding extends TerraformResource {
  ...
  public set condition(value: ProjectIamBindingCondition[] | undefined) {
