...
function projectIamBindingConditionToTerraform(struct?: ProjectIamBindingCondition): any {
...
export class ProjectIamBinding extends cdktf.TerraformResource {
  ...
  private _condition?: ProjectIamBindingCondition[];
  public get condition() {
    return this.interpolationForAttribute('condition') as any;
  }
  public set condition(value: ProjectIamBindingCondition[] ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: cdktf.listMapper(projectIamBindingConditionToTerraform)(this._condition),
    };
  }
}
