// https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/data-sources/tpu_tensorflow_versions
...
export class DataGoogleTpuTensorflowVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleTpuTensorflowVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.2.0/docs/data-sources/tpu_tensorflow_versions#import import section} in the documentation of this resource for the id to use
