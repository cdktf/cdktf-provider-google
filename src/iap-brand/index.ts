...
// https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/iap_brand
...
export class IapBrand extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapBrand that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/iap_brand#import import section} in the documentation of this resource for the id to use
