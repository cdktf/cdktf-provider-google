...
export function gameServicesRealmTimeoutsToTerraform(struct?: GameServicesRealmTimeoutsOutputReference | GameServicesRealmTimeouts): any {
...
export class GameServicesRealmTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: GameServicesRealmTimeouts | undefined) {
    if (value === undefined) {
...
export class GameServicesRealm extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new GameServicesRealmTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
