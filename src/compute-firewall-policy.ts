...
export function computeFirewallPolicyTimeoutsToTerraform(struct?: ComputeFirewallPolicyTimeoutsOutputReference | ComputeFirewallPolicyTimeouts): any {
...
export class ComputeFirewallPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ComputeFirewallPolicyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
