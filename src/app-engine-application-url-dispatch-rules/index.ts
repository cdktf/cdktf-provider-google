// https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/app_engine_application_url_dispatch_rules
...
export class AppEngineApplicationUrlDispatchRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppEngineApplicationUrlDispatchRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/app_engine_application_url_dispatch_rules#import import section} in the documentation of this resource for the id to use
