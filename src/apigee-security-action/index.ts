...
// https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/apigee_security_action
...
export class ApigeeSecurityAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeSecurityAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/apigee_security_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/apigee_security_action google_apigee_security_action} Resource
  *
  * @param scope The scope in which to define this construct
