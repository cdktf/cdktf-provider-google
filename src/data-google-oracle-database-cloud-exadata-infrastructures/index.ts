...
// https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/data-sources/oracle_database_cloud_exadata_infrastructures
...
export class DataGoogleOracleDatabaseCloudExadataInfrastructures extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOracleDatabaseCloudExadataInfrastructures that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/data-sources/oracle_database_cloud_exadata_infrastructures#import import section} in the documentation of this resource for the id to use
