...
// https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/bigquery_default_service_account
...
export class DataGoogleBigqueryDefaultServiceAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBigqueryDefaultServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/data-sources/bigquery_default_service_account#import import section} in the documentation of this resource for the id to use
