...
// https://registry.terraform.io/providers/hashicorp/google/6.1.0/docs/data-sources/tags_tag_value
...
export class DataGoogleTagsTagValue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleTagsTagValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.1.0/docs/data-sources/tags_tag_value#import import section} in the documentation of this resource for the id to use
