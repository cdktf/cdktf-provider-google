...
// https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/storage_insights_report_config
...
export class StorageInsightsReportConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageInsightsReportConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/storage_insights_report_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/resources/storage_insights_report_config google_storage_insights_report_config} Resource
  *
  * @param scope The scope in which to define this construct
