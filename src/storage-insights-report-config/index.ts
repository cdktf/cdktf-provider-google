...
// https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/storage_insights_report_config
...
export interface StorageInsightsReportConfigParquetOptions {
}
...
export class StorageInsightsReportConfigParquetOptionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StorageInsightsReportConfigParquetOptions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: StorageInsightsReportConfigParquetOptions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class StorageInsightsReportConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageInsightsReportConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/storage_insights_report_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/storage_insights_report_config google_storage_insights_report_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _parquetOptions = new StorageInsightsReportConfigParquetOptionsOutputReference(this, "parquet_options");
  public get parquetOptions() {
    return this._parquetOptions;
  }
  public putParquetOptions(value: StorageInsightsReportConfigParquetOptions) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      parquet_options: {
        value: storageInsightsReportConfigParquetOptionsToHclTerraform(this._parquetOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "StorageInsightsReportConfigParquetOptionsList",
      },
      timeouts: {
