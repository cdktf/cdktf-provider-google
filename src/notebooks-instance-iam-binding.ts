...
function notebooksInstanceIamBindingConditionToTerraform(struct?: NotebooksInstanceIamBindingConditionOutputReference | NotebooksInstanceIamBindingCondition): any {
...
export class NotebooksInstanceIamBinding extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: NotebooksInstanceIamBindingCondition | undefined; 
  private __conditionOutput = new NotebooksInstanceIamBindingConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: NotebooksInstanceIamBindingCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: notebooksInstanceIamBindingConditionToTerraform(this._condition),
    };
  }
}
