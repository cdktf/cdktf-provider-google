// https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/org_policy_custom_constraint
...
export class OrgPolicyCustomConstraint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgPolicyCustomConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.34.0/docs/resources/org_policy_custom_constraint#import import section} in the documentation of this resource for the id to use
