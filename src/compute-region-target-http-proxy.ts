...
export function computeRegionTargetHttpProxyTimeoutsToTerraform(struct?: ComputeRegionTargetHttpProxyTimeoutsOutputReference | ComputeRegionTargetHttpProxyTimeouts): any {
...
export class ComputeRegionTargetHttpProxyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeRegionTargetHttpProxyTimeouts | undefined {
  ...
  public set internalValue(value: ComputeRegionTargetHttpProxyTimeouts | undefined) {
    if (value === undefined) {
...
export class ComputeRegionTargetHttpProxy extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ComputeRegionTargetHttpProxyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
