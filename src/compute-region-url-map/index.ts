...
export class ComputeRegionUrlMap extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.0.0/docs/resources/compute_region_url_map google_compute_region_url_map} Resource
  *
