// https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/vmwareengine_network_policy
...
export class VmwareengineNetworkPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmwareengineNetworkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/vmwareengine_network_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/vmwareengine_network_policy google_vmwareengine_network_policy} Resource
  *
  * @param scope The scope in which to define this construct
