...
// https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/recaptcha_enterprise_key
...
export class RecaptchaEnterpriseKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RecaptchaEnterpriseKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.2.0/docs/resources/recaptcha_enterprise_key#import import section} in the documentation of this resource for the id to use
