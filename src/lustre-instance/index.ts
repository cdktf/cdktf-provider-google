// https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/lustre_instance
...
export class LustreInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LustreInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.28.0/docs/resources/lustre_instance#import import section} in the documentation of this resource for the id to use
