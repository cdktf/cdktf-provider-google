...
// https://registry.terraform.io/providers/hashicorp/google/6.18.0/docs/resources/migration_center_preference_set
...
export class MigrationCenterPreferenceSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MigrationCenterPreferenceSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.18.0/docs/resources/migration_center_preference_set#import import section} in the documentation of this resource for the id to use
