...
// https://registry.terraform.io/providers/hashicorp/google/6.48.0/docs/data-sources/parameter_manager_regional_parameter_version
...
export class DataGoogleParameterManagerRegionalParameterVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleParameterManagerRegionalParameterVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.48.0/docs/data-sources/parameter_manager_regional_parameter_version#import import section} in the documentation of this resource for the id to use
