...
// https://registry.terraform.io/providers/hashicorp/google/5.41.0/docs/resources/os_config_patch_deployment
...
export class OsConfigPatchDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsConfigPatchDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.41.0/docs/resources/os_config_patch_deployment#import import section} in the documentation of this resource for the id to use
