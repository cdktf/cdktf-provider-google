...
// https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/resources/gke_backup_restore_plan
...
export class GkeBackupRestorePlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeBackupRestorePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.8.0/docs/resources/gke_backup_restore_plan#import import section} in the documentation of this resource for the id to use
