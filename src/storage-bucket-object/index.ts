...
// https://registry.terraform.io/providers/hashicorp/google/5.39.0/docs/resources/storage_bucket_object
...
export class StorageBucketObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageBucketObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.39.0/docs/resources/storage_bucket_object#import import section} in the documentation of this resource for the id to use
