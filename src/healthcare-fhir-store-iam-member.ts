...
function healthcareFhirStoreIamMemberConditionToTerraform(struct?: HealthcareFhirStoreIamMemberConditionOutputReference | HealthcareFhirStoreIamMemberCondition): any {
...
export class HealthcareFhirStoreIamMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition?: HealthcareFhirStoreIamMemberCondition | undefined; 
  private __conditionOutput = new HealthcareFhirStoreIamMemberConditionOutputReference(this as any, "condition", true);
  public get condition() {
    return this.__conditionOutput;
  }
  public putCondition(value: HealthcareFhirStoreIamMemberCondition | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: healthcareFhirStoreIamMemberConditionToTerraform(this._condition),
    };
  }
}
