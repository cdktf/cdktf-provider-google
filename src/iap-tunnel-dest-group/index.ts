...
// https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/iap_tunnel_dest_group
...
export class IapTunnelDestGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IapTunnelDestGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/iap_tunnel_dest_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.27.0/docs/resources/iap_tunnel_dest_group google_iap_tunnel_dest_group} Resource
  *
  * @param scope The scope in which to define this construct
