// https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/iam_deny_policy
...
export class IamDenyPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamDenyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/iam_deny_policy#import import section} in the documentation of this resource for the id to use
