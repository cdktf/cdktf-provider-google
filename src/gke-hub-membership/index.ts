// https://registry.terraform.io/providers/hashicorp/google/6.22.0/docs/resources/gke_hub_membership
...
export class GkeHubMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.22.0/docs/resources/gke_hub_membership#import import section} in the documentation of this resource for the id to use
