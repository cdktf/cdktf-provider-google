// https://registry.terraform.io/providers/hashicorp/google/6.25.0/docs/resources/scc_folder_notification_config
...
export class SccFolderNotificationConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SccFolderNotificationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.25.0/docs/resources/scc_folder_notification_config#import import section} in the documentation of this resource for the id to use
