...
// https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/cloudbuild_trigger
...
export class CloudbuildTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudbuildTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/cloudbuild_trigger#import import section} in the documentation of this resource for the id to use
