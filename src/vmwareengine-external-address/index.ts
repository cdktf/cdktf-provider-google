...
// https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/vmwareengine_external_address
...
export class VmwareengineExternalAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmwareengineExternalAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.35.0/docs/resources/vmwareengine_external_address#import import section} in the documentation of this resource for the id to use
