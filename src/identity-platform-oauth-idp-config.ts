...
export function identityPlatformOauthIdpConfigTimeoutsToTerraform(struct?: IdentityPlatformOauthIdpConfigTimeoutsOutputReference | IdentityPlatformOauthIdpConfigTimeouts): any {
...
export class IdentityPlatformOauthIdpConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: IdentityPlatformOauthIdpConfigTimeouts | undefined) {
    if (value === undefined) {
...
export class IdentityPlatformOauthIdpConfig extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IdentityPlatformOauthIdpConfigTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
