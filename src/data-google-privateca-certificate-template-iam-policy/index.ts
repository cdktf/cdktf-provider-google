// https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/data-sources/privateca_certificate_template_iam_policy
...
export class DataGooglePrivatecaCertificateTemplateIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGooglePrivatecaCertificateTemplateIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/data-sources/privateca_certificate_template_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.8.0/docs/data-sources/privateca_certificate_template_iam_policy google_privateca_certificate_template_iam_policy} Data Source
  *
  * @param scope The scope in which to define this construct
