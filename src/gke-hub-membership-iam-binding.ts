// https://www.terraform.io/docs/providers/google/r/gke_hub_membership_iam_binding
...
export function gkeHubMembershipIamBindingConditionToTerraform(struct?: GkeHubMembershipIamBindingConditionOutputReference | GkeHubMembershipIamBindingCondition): any {
...
export class GkeHubMembershipIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GkeHubMembershipIamBindingCondition | undefined {
  ...
  public set internalValue(value: GkeHubMembershipIamBindingCondition | undefined) {
    if (value === undefined) {
...
export class GkeHubMembershipIamBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_gke_hub_membership_iam_binding";
  ...
  */
  public constructor(scope: Construct, id: string, config: GkeHubMembershipIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new GkeHubMembershipIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GkeHubMembershipIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: gkeHubMembershipIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
}
