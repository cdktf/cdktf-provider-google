// https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/alloydb_user
...
export class AlloydbUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlloydbUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.6.0/docs/resources/alloydb_user#import import section} in the documentation of this resource for the id to use
