...
// https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/network_services_gateway
...
export class NetworkServicesGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkServicesGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/network_services_gateway#import import section} in the documentation of this resource for the id to use
