...
// https://registry.terraform.io/providers/hashicorp/google/6.11.0/docs/resources/privateca_certificate
...
export class PrivatecaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatecaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.11.0/docs/resources/privateca_certificate#import import section} in the documentation of this resource for the id to use
